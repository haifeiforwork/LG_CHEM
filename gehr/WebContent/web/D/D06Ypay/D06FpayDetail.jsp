    ...
    <div class="tableArea">
      <div class="table">
        <table class="mpayTable">
             ...
             <tr><!-- 부서명,사번,성명 -->
                  <th width="100" ><%=g.getMessage("LABEL.D.D05.0004")%> </th><td class="align_left"> &nbsp;<%= user.e_orgtx %></td>
                  <th width="100" ><%=g.getMessage("LABEL.D.D05.0005")%> </th><td class="align_left"> &nbsp;<%= user.empNo %></td>
                  <th width="100" ><%=g.getMessage("LABEL.D.D06.0006")%> </th><td class="lastCol align_left" > &nbsp;<%= user.ename %></td>
             </tr>
</table></div>  
        ...
        <table class="mpayTable">
               <tr>
                ...
                <tr>
                  ...
                  <th  width="90" class="divide"><spring:message code="LABEL.D.D05.0022" /></td>
...
<%
    for ( int i = 0 ; i < D06FpayDetailData_vt.size() ; i++ ) {
	    ...
	    data.BET01 = WebUtil.nvl(data.BET01,"0");
	    data.BET02 = WebUtil.nvl(data.BET02,"0");
	    data.BET03 = WebUtil.nvl(data.BET03,"0");
	    data.BET04 = WebUtil.nvl(data.BET04,"0");
	    data.BET05 = WebUtil.nvl(data.BET05,"0");
	    data.BET06 = WebUtil.nvl(data.BET06,"0");
	    data.BET07 = WebUtil.nvl(data.BET07,"0");
	    data.BET08 = WebUtil.nvl(data.BET08,"0");
	    data.BET09 = WebUtil.nvl(data.BET09,"0");
	    data.BET10 = WebUtil.nvl(data.BET10,"0");
	    data.BET11 = WebUtil.nvl(data.BET11,"0");
	    data.BET12 = WebUtil.nvl(data.BET12,"0");
	    data.BET13 = WebUtil.nvl(data.BET13,"0");
	    data.BET14 = WebUtil.nvl(data.BET14,"0");
	    data.BET15 = WebUtil.nvl(data.BET15,"0");
	    data.BET16 = WebUtil.nvl(data.BET16,"0");
	    data.BET17 = WebUtil.nvl(data.BET17,"0");
	
	    int j = 0;
	     String fyymm = data.FYYMM.substring(0,6);
	     double tol_kubyo = Double.parseDouble(WebUtil.nvl(data.BET01,"0"));
	     double tol_sanyo = Double.parseDouble((data.BET15==null || data.BET15.equals("")) ? "0" : data.BET15);
	...
	// 지급계 = 급여 + 상여 + 국내생계비 + 국내주택비
	     double jigb = Double.parseDouble(WebUtil.nvl(data.BET16,"0")) + Double.parseDouble(WebUtil.nvl(data.BET17,"0")) + 
	    		 Double.parseDouble(WebUtil.nvl(data.BET04,"0")) + Double.parseDouble(WebUtil.nvl(data.BET05,"0"));
	     String jigb_1 = Double.toString(jigb);

%>
<%  if(data.BET01 != null|| !data.BET01.equals("0")) {  %>
	
                <tr  >
                  <td class="align_center"><%= zyy+"."+zmm %></td>
                  <td ><%= data.BET16==null || data.BET16.equals("0") ? "" : WebUtil.printNumFormat(data.BET16) %>&nbsp;</td>
                  <td ><%= data.BET17==null || data.BET17.equals("") ? "" : WebUtil.printNumFormat(data.BET17) %>&nbsp;</td>
                  <td ><%= data.BET04==null || data.BET04.equals("") ? "" : WebUtil.printNumFormat(data.BET04) %>&nbsp;</td>
                  <td ><%= data.BET05==null || data.BET05.equals("0") ? "" : WebUtil.printNumFormat(data.BET05) %>&nbsp;</td>
                  <td class="divide"><%= jigb_1.equals("0") ? "" : WebUtil.printNumFormat(jigb_1) %>&nbsp;</td>
                  <td  ><%=  data.BET07==null || data.BET07.equals("0") ? "" : WebUtil.printNumFormat(data.BET07) %>&nbsp;</td>
                  <td class="lastCol" ><%= data.BET08==null||data.BET08.equals("0") ? "" : WebUtil.printNumFormat(data.BET08) %>&nbsp;</td>
                </tr>
<%  }  %>
...
%>
                ...
                <tr class="sumRow">
                  ...
                  <td class="divide"><%= total20.equals("0") ? "" : WebUtil.printNumFormat(total20) %>&nbsp;</td>
                  <td  ><%= kabgn_tot1.equals("0.0") ? "" : WebUtil.printNumFormat(kabgn_tot1) %>&nbsp;</td>
                  <td class="lastCol"><%= jumin_tot1.equals("0.0") ? "" : WebUtil.printNumFormat(jumin_tot1) %>&nbsp;</td>
                </tr>
<%     } else {     %>
                <tr class="sumRow">
                  <td class="align_center"><spring:message code="LABEL.D.D06.0011" /></td><!-- TOTAL -->
