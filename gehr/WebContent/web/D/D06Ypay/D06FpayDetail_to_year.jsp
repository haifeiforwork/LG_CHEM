...
/*   2Depth Name  : 연급여                                                      */
/*   Program Name : 연급여                                                      */
/*   Program ID   : D06FpayDetail_to_yeaer.jsp                                  */
/*   Description  : 개인의 해외근무자 국내급여 내역                             */
/*   Note         :                                                             */
          ...
          <tr> 
            <td align="center"> 
              <table width="624" border="0" cellspacing="0" cellpadding="0">
                <tr><!-- 부서명,사번,성명 -->
                  <td width="120" ><%=g.getMessage("LABEL.D.D05.0004")%> : &nbsp;<%= user.e_orgtx %></td>
                  <td width="264" ><%=g.getMessage("LABEL.D.D05.0005")%> : &nbsp;<%= user.empNo %></td>
                  <td width="120" ><%=g.getMessage("LABEL.D.D06.0006")%> : &nbsp;<%= user.ename %></td>
                  <td >&nbsp;</td>
                </tr>
                </tr>
              </table>
            ...
            <td> 
              ...
              <table width="630" border="0" cellspacing="1" cellpadding="3" class="table02">
                <tr> 
                  ...
                  <td  colspan="2" style="border-left:1.5pt solid windowtext; border-color: #B7A68A">
