...
/*   Program ID   : D02ConductListPl_m.jsp                                          */
...
%>
                         </select> <a href="javascript:showList();"><img src="<%= WebUtil.ImageURL %>sshr/ico_magnify.png" align="absmiddle"></a>
					</td>
				</tr>
			</table>
		</div>
	...
	<div class="listArea" style="margin-bottom:0;margin-top:-20px" >
		<div class="table" style="margin:0 17px 0 0;">
			<table class="listTable" id="tab_h" style="margin-bottom:0;">
				<colgroup>
					<col width="8.33%"/>
					<col width="8.33%"/>
					<col width="8.33%"/>
   ...
   <% if(!E_RETURN.trim().equals("S")) { %>
    ...
    <%}else{ %>
	            ...
	            <td class="lastCol align_right"><%=WebUtil.printNumFormat(monthlyData.AB_TAR,1) %> </td>
     <%} %>
...
%>
            ...
            <td <%= isWeekend ? "class=\"sunday\"" : "class=\"\""%> style="text-align:right"><%=detailData.LE_DMD.equals("0") ? "" : WebUtil.printNumFormat(detailData.LE_DMD,1) %> </td>
