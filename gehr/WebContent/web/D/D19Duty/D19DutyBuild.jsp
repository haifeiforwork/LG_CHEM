					...
					if(document.form1.BEGUZ1.value < document.form1.ENDUZ1.value){
						if(document.form1.BEGUZ.value != ''){
							if(document.form1.BEGUZ.value < document.form1.ENDUZ1.value && document.form1.BEGUZ.value > document.form1.BEGUZ1.value){
								alert("<spring:message code='MSG.G.G01.0001' />");// alert('Duty time overlaps with working time , please enter right time period.'); MSG.G.G01.0001
	...
	function DutyTypechange(){//change approval people
		...
		<c:if test="${E_BUKRS eq 'G280'}">
			if(document.form1.DUTY_REQ.value == "0006"){
				...
				//var html = "<img class='ui-datepicker-trigger' src='/web/images/icon_time.gif' alt='달력보기' title='달력보기'>";
				//$("#sBEGUZ").append(html);
			...
			<table class="tableGeneral">
            	...
            	<tr>
                    ...
                    <td colspan="3">
                        ...
                        <input type="text" name="DUTY_DATE" id="DUTY_DATE" size="7" value="${f:printDate(resultData.DUTY_DATE)}" class="date"  onchange="after_fn_openCal();" readonly />
               ...
               <tr>
					...
					<td colspan="3" id="timeFoc">
						<input type="text" name="BEGUZ" id="BEGUZ" size="7" class="time" value="${ f:printTime( resultData.BEGUZ ) }" onfocus='javascript:timeFocus(this);' onKeyPress = "javascript:EnterCheck2();" onblur="timeBlur(this);">
						...
						~
						<input type="text" name="ENDUZ" id="ENDUZ" size="7" class="time" value="${ f:printTime( resultData.ENDUZ ) }" onfocus='javascript:timeFocus(this);' onKeyPress = "javascript:EnterCheck2();" onblur="timeBlur(this);" />
						<!--20160518-->
						...
						<input type="text" name="ANZHL" id="ANZHL" size="3" class="noBorder"    readonly style="text-align:right;">
          	   ...
          	   <tr>
					...
					<td colspan="3">
					<input type="text" name="ZREASON" id="ZREASON" size="105" value="${ f:printDate( resultData.DUTY_DATE ) }" maxlength="100">
					</td>
               </tr>
               <tr>
					<th><!--Date Character--><spring:message code="LABEL.D.D19D.0006" /></th>
					<td>
						<span id="HOLIDAY" style="width:103px"></span>
					    <input type="hidden" name="HOLIDAY1" id="HOLIDAY1" value="">
					</td>
	                <th class="th02"><!--Level--><spring:message code="LABEL.D.D19D.0007" /></th>
	                <td >
	                 	 <input type="text" name="TTOUT" id="TTOUT" size="7" class="noBorder" value="${ f:printDate( resultData.DUTY_DATE ) }" onKeyPress="javascript:EnterCheck2();" readonly />
						 &nbsp;&nbsp;&nbsp;&nbsp;
               ...
               <tr>
					...
					<td>
						<input type="text" name="TPROG1" id="TPROG1" size="10" value="${ f:printDate( resultData.DUTY_DATE ) }" onKeyPress="javascript:EnterCheck2();" readonly>
						<span id="TTEXT1" style="width:80"></span>
					</td>
					<td colspan="2">
						<input type="text" name="BEGUZ1" id="BEGUZ1" size="7" value="" onKeyPress = "javascript:EnterCheck2();" readonly>
						~
						<input type="text" name="ENDUZ1" id="ENDUZ1" size="7" value="" onKeyPress = "javascript:EnterCheck2();" readonly>&nbsp;
					</td>
               </tr>
               ...
               <tr>
					...
					<td>
						<input type="text" name="TPROG2" id="TPROG2" size="10"  value="${ f:printDate( resultData.DUTY_DATE ) }" onKeyPress="javascript:EnterCheck2();" readonly>
						<span id="TTEXT2" style="width:80"></span>
					</td>
					<td colspan="2">
						<input type="text" name="BEGUZ2" id="BEGUZ2" size="7" value="" onKeyPress = "javascript:EnterCheck2();" readonly>
						~
						<input type="text" name="ENDUZ2" id="ENDUZ2" size="7" value="" onKeyPress = "javascript:EnterCheck2();" readonly>&nbsp;
					</td>
                </tr>
