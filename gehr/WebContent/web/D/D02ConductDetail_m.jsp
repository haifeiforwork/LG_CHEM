...
<frameset rows="<%=rowheight%>,*" frameborder="NO" border="0" framespacing="0">
  <frame name="topPage" scrolling="NO"   noresize src="<%= WebUtil.ServletURL %>hris.D.D02ConductHeaderSV_m?year=<%= year %>&month=<%= month %>" frameborder="NO" marginwidth="0" marginheight="0">
  <frame name="endPage" scrolling="AUTO"          src="<%= WebUtil.ServletURL %>hris.D.D02ConductListSV_m?year=<%= year %>&month=<%= month %>"   frameborder="NO" marginwidth="0" marginheight="0">
</frameset>
<noframes>
