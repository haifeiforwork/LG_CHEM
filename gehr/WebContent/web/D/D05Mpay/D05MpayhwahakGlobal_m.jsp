...
/*   Program ID         : D05MpayhwahakUsa_m.jsp                                                                                            */
/*   Description        : 급여명세표 조회 (USA,유럽)                                                                                                        */
/*   Note               :                                                                                                                                   */
...
<%
    ...
    for (int i = 0; i < d05ZocrsnTextData_vt.size(); i ++) {
        ...
        if ((user_m.area.equals(Area.DE) || user_m.area.equals(Area.PL)) && (ocrsn.equals(data4.ZOCRSN))){	        
    ...
    if (user_m.area.equals(Area.DE) || user_m.area.equals(Area.PL)){          
    	...
    	money2 = Double.parseDouble(d05MpayDetailData5.BET01);
    }
        ...
        <div class="table">
            <table class="mpayTable">
              ...
              <tr >
                ...
                <td><%= user_m.empNo %></td>
                <td class="lastCol"><%= user_m.ename %></td>
              </tr>
            </table>
        </div>
    </div>
...
<%-- Social Insurance START --%>

<%
    if(user_m.e_area.equals("28")){ // 선진특화
%>
