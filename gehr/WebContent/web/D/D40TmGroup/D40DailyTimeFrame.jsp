...
/*   System Name	:  MSS														*/
/*   1Depth Name		:   부서근태													*/
/*   2Depth Name		:   일일근태입력현황										*/
/*   Program Name	:   일일근태입력현황										*/
/*   Program ID		: D40DailyTimeFrame										*/
/*   Description		: 일일근태입력현황											*/
/*   Note				:             													*/
...
<jsp:include page="/include/body-header.jsp">
    <jsp:param name="title" value="TAB.D.D40.0018" />
</jsp:include>
...
<script language="JavaScript">
	...
	$(function() {
		tabMove(this, '<%= WebUtil.JspPath %>common/wait.jsp?url=<%= WebUtil.ServletURL %>hris.D.D40TmGroup.D40TmDailySV', 'C');
	});
...
<!-- 	<div class="tabArea"> -->
<!-- 		<ul class="tab"> -->
<%--            	<li><a href="javascript:;" onclick="tabMove(this, '<%= WebUtil.JspPath %>common/wait.jsp?url=<%= WebUtil.ServletURL %>hris.D.D40TmGroup.D40RemeInfoEachSV', 'B');"><!-- 사원지급 정보(개별) --><spring:message code='TAB.D.D40.0014'/></a></li> --%>
...
<%--            	<li><a href="javascript:;" onclick="tabMove(this, '<%= WebUtil.JspPath %>common/wait.jsp?url=<%= WebUtil.ServletURL %>hris.D.D40TmGroup.D40RemeInfoLumpSV', 'A');"><!-- 사원지급 정보(일괄) --><spring:message code='TAB.D.D40.0013'/></a></li> --%>
<!--         </ul> -->
<!--    	</div> -->
<!-- </div> -->
