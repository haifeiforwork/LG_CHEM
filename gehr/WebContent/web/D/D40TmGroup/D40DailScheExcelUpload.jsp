...
/*   1Depth Name		:   부서근태													*/
/*   2Depth Name		:   															*/
/*   Program Name	:   일일근무일정(일괄)	Excel upload popup			*/
/*   Program ID		: D40DailScheEachExcel.jsp							*/
/*   Description		: 일일근무일정 (일괄) Excel upload popup			*/
/*   Note				:             													*/
    ...
    <div class="tableArea">
        <div class="table">
            <table id="-search-table" class="tableGeneral tableApproval">
                <form name="form1" method="post" enctype="multipart/form-data" action="${g.servlet}hris.D.D40TmGroup.D40DailScheExcelUpload">
                <tr>
                    <td>
