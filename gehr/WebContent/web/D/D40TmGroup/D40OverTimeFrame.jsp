...
<jsp:include page="/include/body-header.jsp">
    <jsp:param name="title" value="LABEL.D.D40.0036" />
</jsp:include>
...
<!-- 탭 시작 -->
	<div class="tabArea">
		<ul class="tab">
           	<li><a href="javascript:;" onclick="tabMove(this, '<%= WebUtil.JspPath %>common/wait.jsp?url=<%= WebUtil.ServletURL %>hris.D.D40TmGroup.D40OverTimeEachSV', 'B');"><!-- 초과근무 조회/변경(개별) --><spring:message code='TAB.D.D40.0010'/></a></li>
<%--         	<li><a href="javascript:;" onclick="tabMove(this, '<%= WebUtil.JspPath %>common/wait.jsp?url=<%= WebUtil.ServletURL %>hris.D.D40TmGroup.D40TmDailySV', 'C');"><!-- 일일근태 입력 현황 --><spring:message code='TAB.D.D40.0018'/></a></li> --%>
           	<%-- 
           	<li><a href="javascript:;" onclick="tabMove(this, '<%= WebUtil.JspPath %>common/wait.jsp?url=<%= WebUtil.ServletURL %>hris.D.D40TmGroup.D40OverTimeLumpSV', 'A');"><!-- 초과근무입력(일괄) --><spring:message code='TAB.D.D40.0009'/></a></li>
           	 --%>
        </ul>
   	</div>
</div>
