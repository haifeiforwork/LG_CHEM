...
/*   2Depth Name		:   일일근무일정												*/
/*   Program Name	:  일일근무일정												*/
/*   Program ID		: D40DailSchkzFrame.jsp							*/
/*   Description		: 일일근무일정												*/
/*   Note				:             													*/
...
<jsp:include page="/include/body-header.jsp">
    <jsp:param name="title" value="LABEL.D.D40.0035" />
</jsp:include>
...
<!-- 탭 시작 -->
	<div class="tabArea">
		<ul class="tab">
           	<li><a href="javascript:;" onclick="tabMove(this, '<%= WebUtil.JspPath %>common/wait.jsp?url=<%= WebUtil.ServletURL %>hris.D.D40TmGroup.D40TmSchkzPlanningChartSV', 'C');"><!-- 일일근무일정 변경(달력) --><spring:message code='TAB.D.D40.0022'/></a></li>
           	<li><a href="javascript:;" onclick="tabMove(this, '<%= WebUtil.JspPath %>common/wait.jsp?url=<%= WebUtil.ServletURL %>hris.D.D40TmGroup.D40DailScheEachSV', 'B');"><!-- 일일근무일정 조회/변경(개별) --><spring:message code='TAB.D.D40.0008'/></a></li>
           	<li><a href="javascript:;" onclick="tabMove(this, '<%= WebUtil.JspPath %>common/wait.jsp?url=<%= WebUtil.ServletURL %>hris.D.D40TmGroup.D40DailScheLumpSV', 'A');"><!-- 일일근무일정 입력(일괄) --><spring:message code='TAB.D.D40.0007'/></a></li>
        </ul>
   	</div>
</div>
