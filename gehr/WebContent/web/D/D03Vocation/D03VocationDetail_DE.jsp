...
/*   Program Name 	: Leave                                               																			*/
/*   Program ID   		: D03VocationDetailDe.jsp[독일]                                       */
            ...
            <col />
				...
				<input type="hidden" name="BEGDA" value="${ data.BEGDA }" size="20"  readonly>    <!-- 상단 입력 테이블 시작-->
	                ...
	                <tr>
	                  ...
	                  <td colspan=3>
	                    <input type="text" name="APPL_REAS" value="${ data.APPL_REAS }"  size="80" readonly>
	                  </td>
	                </tr>
	                <tr> 
	                ...
	                <tr> 
	                   ...
	                   <td colspan=3> <input type="text" name="APPL_FROM" value="${  f:printDate(data.APPL_FROM) }" size="9"  readonly> 
	                     ~ 
	                   <input type="text" name="APPL_TO"   value="${  f:printDate(data.APPL_TO)   }" size="9"  readonly >  
	                    <input type="text" name="ABRTG" value="${f:printNumFormat(data.ABRTG ,2)}"  size="3"  style="text-align:right;" readonly>
	                       <spring:message code="LABEL.D.D03.0031"/>  
<!--	                      &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<span id="sp2">Maximum Available&nbsp;<input type="text" name="P_STDAZ2" value="${data.ABSN_DATE}"  size="2" maxlength="7" style="ime-mode:active;text-align:right;" readonly> 
	                       day  
	                      </span>-->
	                ...
	                <tr> 
	                   ...
	                   value="${  data.BEGUZ==("00:00:00") ? "" : f:printTime(data.BEGUZ) }" size="3"  readonly ${ data.AWART==("0111")   ? "" : "readonly" }> 
	                    ~ 
	                     <input type="text" name="ENDUZ" value="${  data.ENDUZ==("00:00:00") ? "" : f:printTime(data.ENDUZ) }" size="3"  readonly ${ data.AWART==("0111") ? "" : "readonly" }> 
	                     <input type="text" name="I_STDAZ" value=" ${data.STDAZ }"  size="3"  
	                     style="text-align:right;" readonly> <spring:message code="LABEL.D.D01.0008"/> 
