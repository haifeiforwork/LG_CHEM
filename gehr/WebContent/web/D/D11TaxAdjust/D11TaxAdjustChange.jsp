...
function check_data(){
    ...
    // 특별공제중 교육비일때, (자동공제 제외) 추가공제액이 있다면 학력도 선택되어야한다
    ...
    <tr>
      ...
      <!--타이틀 테이블 시작-->
        <table width="790" border="0" cellspacing="0" cellpadding="0">
          ...
          <tr>
            <td class="title01"><spring:message code="LABEL.D.D11.0109" /><!-- 연말정산공제신청 수정 --></td>
          </tr>
        </table>
      <!--타이틀 테이블 끝-->
      </td>
...
%>
            <td class="td04" style="text-align:right"><%= d11TaxAdjustData.ADD_AMT.trim() %>&nbsp;
      ...
      <td>
        <table width="790" border="0" cellspacing="0" cellpadding="0">
          <tr>
            ...
            <img src="<%= WebUtil.ImageURL %>btn_cancel.gif" width="49" height="20" border="0" align="absmiddle"></a>
            </td>
          </tr>
        </table>
      </td>
...
<!-- 숨겨진 필드 -->
    <input type="hidden" name="jobid"      value="change">
