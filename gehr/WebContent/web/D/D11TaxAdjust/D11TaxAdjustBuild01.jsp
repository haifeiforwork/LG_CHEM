...
function do_inform() {
    small_window=window.open("<%= WebUtil.JspURL %>D/D11TaxAdjust/D11Tax_Top.jsp","Eloffice_Tax","toolbar=no,location=no,directories=no,status=no,menubar=no,resizable=no,scrollbars=yes,width=710,height=420,left=100,top=100");
    small_window.focus();
}
//-->
</SCRIPT>
...
<form name="form1">
  <table width="100%" border="0" cellspacing="0" cellpadding="0">
    ...
    <tr>
      ...
      <!--타이틀 테이블 시작-->
        <table width="790" border="0" cellspacing="0" cellpadding="0">
          ...
          <tr>
            <td class="title01"><spring:message code="LABEL.D.D11.0001" /><!-- 연말정산공제신청 입력 --></td>
          </tr>
        </table>
      <!--타이틀 테이블 끝-->
      </td>
    ...
    <tr>
      <td width="15">&nbsp;</td>
      <td class="font01"><a href="javascript:do_inform();"><font color="#0000FF"><spring:message code="LABEL.D.D11.0023" /><!-- 연말정산 신청안내 --></font></a></td>
    </tr>
    <tr>
      <td width="15">&nbsp;</td>
    ...
    <tr>
      ...
      <td>
        <!--개인정보 테이블 시작-->
        <table width="288" border="0" cellspacing="0" cellpadding="0" height="23">
					<tr>
						<td width="72">
							<div align="center"><img src="<%= WebUtil.ImageURL %>btn_Tax01_on.gif" width="72" height="22"></div>
						</td>
						<td width="72">
							<div align="center"><a href="javascript:do_Tax02();"><img src="<%= WebUtil.ImageURL %>btn_Tax02_off.gif" width="72" height="22" border="0" onmouseover="this.src='<%= WebUtil.ImageURL %>btn_Tax02_on.gif'" onmouseout="this.src='<%= WebUtil.ImageURL %>btn_Tax02_off.gif'"></a></div>
						</td>
						<td width="72">
							<div align="center"><a href="javascript:do_Tax03();"><img src="<%= WebUtil.ImageURL %>btn_Tax03_off.gif" width="109" height="22" border="0" onmouseover="this.src='<%= WebUtil.ImageURL %>btn_Tax03_on.gif'" onmouseout="this.src='<%= WebUtil.ImageURL %>btn_Tax03_off.gif'"></a></div>
						</td>
						<td width="72">
							<div align="center"><a href="javascript:do_Tax04();"><img src="<%= WebUtil.ImageURL %>btn_Tax04_off.gif" width="102" height="22" border="0" onmouseover="this.src='<%= WebUtil.ImageURL %>btn_Tax04_on.gif'" onmouseout="this.src='<%= WebUtil.ImageURL %>btn_Tax04_off.gif'"></a></div>
						</td>
					</tr>
				</table>
        <!--개인정보 테이블 끝-->
