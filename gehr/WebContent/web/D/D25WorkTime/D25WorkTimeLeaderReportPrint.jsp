...
/*   Program ID   : D25WorkTimeLeaderReportPrint.jsp
...
<body bgcolor="#FFFFFF" text="#000000" leftmargin="0" topmargin="0" marginwidth="0" marginheight="0">
	...
	<form name="form1" method="post" onsubmit="return false">
		...
		<div class="subWrapper iframeWrap wideTable" style="height:550px; overflow:auto">
							...
							<tr>
								<c:if test="${not empty T_TWEEKS}">
									<c:forEach var="tweeks" items="${T_TWEEKS}" varStatus="status">
										...
										<th class="th02">
										<c:choose>
											<c:when test="${SEARCH_EMPGUBUN eq 'S'}">
											<spring:message code='LABEL.D.D25.0025' /><!-- 초과근무 -->
											</c:when>
											<c:otherwise>
											<spring:message code='LABEL.D.D25.0079' /><!-- 초과근무/교육 -->
											</c:otherwise>
										</c:choose>
										</th>
				...
				<div class="table">
					<c:choose>
						...
						<table class="listTable">
							...
							<thead>
								<tr>
									<th class="th02"><spring:message code='LABEL.D.D25.0016' /><!-- 사번 --></th>
									<th class="th02"><spring:message code='LABEL.D.D25.0040' /><!-- 이름 --></th>
									<th class="th02"><spring:message code='LABEL.D.D25.0038' /><!-- 정상근무 --></th>
									<th class="th02"><spring:message code='LABEL.D.D25.0025' /><!-- 초과근무 --></th>
									<th class="th02"><spring:message code='LABEL.D.D25.0052' /><!-- 휴게/비근무 --></th>
									<th class="th02"><spring:message code='LABEL.D.D25.0054' /><!-- 월 합계 실 근무시간 --></th>
						...
						<table class="listTable">
							...
							<thead>
								<tr>
									<th rowspan="2" class="th02"><spring:message code='LABEL.D.D25.0016' /><!-- 사번 --></th>
									<th rowspan="2" class="th02"><spring:message code='LABEL.D.D25.0040' /><!-- 이름 --></th>
									<th colspan="4" class="th02"><spring:message code='<c:out value="${headerMonth1}" />' /><!-- 월 --> <c:out value="${headerMonth1Range}" /></th>
									<th colspan="4" class="th02"><spring:message code='<c:out value="${headerMonth2}" />' /><!-- 월 --> <c:out value="${headerMonth2Range}" /></th>
									<th colspan="4" class="th02"><spring:message code='<c:out value="${headerMonth3}" />' /><!-- 월 --> <c:out value="${headerMonth3Range}" /></th>
									<th colspan="2" class="th02 lastCol"><spring:message code='LABEL.D.D25.0047' /><!-- 3개월 계 --></th>
								</tr>
								<tr>
									<th class="th02"><spring:message code='LABEL.D.D25.0038' /><!-- 정상근무 --></th>
									...
									<th class="th02"><spring:message code='LABEL.D.D25.0052' /><!-- 휴게/비근무 --></th>
									<th class="th02"><spring:message code='LABEL.D.D25.0053' /><!-- 실 근무시간 --></th>
									<th class="th02"><spring:message code='LABEL.D.D25.0019' /><!-- 실 근무시간 --></th>
									<th class="th02"><spring:message code='LABEL.D.D25.0048' /><!-- 주당 평균 --></th>
								</tr>
							</thead>
							<tbody id="reportContents">
								<c:if test="${not empty T_LIST}">
			...
			<c:if test="${SEARCH_EMPGUBUN eq 'H'}">
			<br/>
			<div class="commentOne">
