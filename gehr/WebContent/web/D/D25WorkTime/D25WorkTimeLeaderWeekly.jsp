...
/*   Program ID   : D25WorkTimeLeaderWeekly.jsp
...
<jsp:include page="/include/header.jsp">
    ...
    <jsp:param name="script" value="D/D25WorkTimeLeaderWeekly-var.jsp" />
    <jsp:param name="script" value="D/D25WorkTimeLeaderWeekly.js" />
</jsp:include>
...
<div class="listArea">
    ...
    <div class="table">
        <table class="listTable" style="margin-bottom:0">
            ...
            <tbody>
                <tr class="oddRow">
                    <td class="lastCol" colspan="4"><spring:message code="MSG.COMMON.0004"/></td><%-- 해당하는 데이타가 존재하지 않습니다. --%>
                </tr>
            </tbody>
        </table>
    </div>
...
<form name="excelDownload" method="POST" target="hidden" action="${g.servlet}hris.D.D25WorkTime.D25WorkTimeLeaderWeeklySV"></form>
