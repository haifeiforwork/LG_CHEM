...
/*   2Depth Name  : 휴가명세표                                                  		*/
/*   Program Name : 휴가명세표                                                  		*/
/*   Program ID   : D04VocationDetail_m_print.jsp                               */
/*   Description  : 부서 휴가명세표 팝업                                             	*/
/*   Note         :                                                             */
/*   Creation     : 2015.06.05 [CSR ID:2797167] 휴가실적 출력 용 화면 추가요청     	*/
...
<%
    ...
    String jobid = request.getParameter("jobid_m");
...
<div class="winPop">
	<div class="header">
		...
		<a href="javascript:top.close()"><img alt="팝업닫기" src="<%=WebUtil.ImageURL%>sshr/btn_popup_close.png"></a>
	</div>
	<div class="body">
					...
					<div class="listArea">
						<div class="table">
							<table class="listTable">
								<fmt:parseNumber var="colWidth" value="${85 / 13}" />
                				<colgroup>
						      		<col width="15%" />
						      		<col width="${colWidth}%" />
						      		<col width="${colWidth}%" />
								...
								<thead>
                            		<tr>
										<th class="divide"><!-- 구분 --><%=g.getMessage("LABEL.D.D15.0076")%></th>
										...
										<th class="lastCol sum_column" width="80"><!-- 계 --><%=g.getMessage("LABEL.D.D15.0070")%></th>
                            		</tr>
								</thead>
								<tbody>
									<tr>
									...
									<tr>
										<!-- @rdcamel -->
										<td class="divide">
											<!-- 사전부여휴가 --><%=g.getMessage("LABEL.D.D15.0050")%></td>
						...
						<div class="table">
							<table class="listTable">
								...
								<tbody>
									<tr>
										<td class="divide">
											<!-- 사용일수 --><%=g.getMessage("LABEL.D.D15.0048")%></td>
...
%>
										...
										<td>&nbsp;</td>
										<td>&nbsp;</td>
										<td class="lastCol sum_column" name="E_ABRTG">0</td>
<%
		}
	}
%>
		...
		<table class="tableGeneral">
			<tr>
				<td>
					<b><!-- 용어설명 --><%=g.getMessage("LABEL.D.D15.0079")%></b><br>
...
%>
		<font color="#006699"><!-- ※ 2002년 휴가발생 내역은 2002년 6월 20일까지 사용한 사용일수를 차감한 잔여휴가일수 --><%=g.getMessage("LABEL.D.D15.0169")%></font>
<%
        }
    }
%>
