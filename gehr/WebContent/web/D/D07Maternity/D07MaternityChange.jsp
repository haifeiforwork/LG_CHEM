...
<div class="subWrapper">
    ...
    <div class="title"><h1>산전후 휴가신청 수정</h1></div>
        ...
        <div class="table">
            <table class="tableGeneral">
                ...
                <tr>
                    ...
                    <td>
                        <input type="text" name="APPL_FROM" value="<%= data.APPL_FROM.equals("0000-00-00") ? "" : WebUtil.printDate(data.APPL_FROM) %>" size="20" onBlur="javascript:APPL_TO_Setting(this);">
                ...
                <tr>
                    ...
                    <td>
                        <input type="text" name="RMDDA" value="<%= data.RMDDA.equals("0000-00-00") ? "" : WebUtil.printDate(data.RMDDA) %>" size="20" onBlur="javascript:dateFormat(this);">
                ...
                <tr>
                    ...
                    <td>
                        <input type="radio" name="PBEZ4" value="90" <%= WebUtil.printNumFormat(data.PBEZ4).equals("90") ? "checked" : "" %> onClick="javascript:after_APPL_TO_Setting();">90일
                        &nbsp;
                        <input type="radio" name="PBEZ4" value="45" <%= WebUtil.printNumFormat(data.PBEZ4).equals("45") ? "checked" : "" %> onClick="javascript:after_APPL_TO_Setting();">45일
                    </td>
                </tr>
            </table>
    ...
    <!-- 결재자 입력 테이블 시작-->
    <%= hris.common.util.AppUtil.getAppChange(AppLineData_vt,,user.empNo) %>
    <!-- 결재자 입력 테이블 시작-->
