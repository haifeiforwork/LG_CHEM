...
/*   2Depth Name  : 채권가압류                                                  */
/*   Program Name : 채권가압류                                                  */
/*   Program ID   : D09BondProvision_m.jsp                                      */
...
<%
    ...
    Vector D09BondProvision_tot = (Vector) request.getAttribute("D09BondProvision_tot");
      ...
      <table class="listTable">
           <thead>
                <tr>
                  ...
                  <th><!--  지급계좌 --><%=g.getMessage("LABEL.D.D15.0108")%></th>
                </tr>
             </thead>
<%
    for ( int i = 0 ; i < D09BondProvision_tot.size() ; i++ ) {
        D09BondProvisionData data = ( D09BondProvisionData ) D09BondProvision_tot.get( i ) ;
%>
						...
						<div align="right">
						     <table class="amount">
						     	<colgroup>
			                      ...
			                      <tr>
			                        <th style=""><!--지급총액  --><%=g.getMessage("LABEL.D.D15.0110")%></th>
