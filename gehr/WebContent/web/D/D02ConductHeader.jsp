...
/*   2Depth Name  : 근태                                                        */
/*   Program Name : 근태실적정보                                                */
/*   Program ID   : D02ConductHeader.jsp                                        */
...
<!--
function showList() {
    document.form1.action = "<%= WebUtil.JspURL %>D/D02ConductDetail.jsp" ;
...
%>
          ...
          <div class="tableBtnSearch tableBtnSearch2">
            <a href="javascript:showList();" class="search"><span><!-- 조회 --><%=g.getMessage("LABEL.D.D15.0120")%></span></a>
          </div>
        </td>
      </tr>
    </table>
      ...
      <table class="listTable">
        ...
        <thead>
          <tr>
            ...
            <th colspan="3" class="lastCol"><!-- 기 타(일수) --><%=g.getMessage("LABEL.D.D15.0126")%> </th>
          </tr>
          <tr>
