...
<%
    ...
    for( int i = 1 ; i < E15StmcData_opt.size()+1 ; i++ ) {
        E15StmcCodeData data = (E15StmcCodeData)E15StmcData_opt.get(i-1);
...
<% 
    ...
    E15SeltData_opt  = SortUtil.sort_num(E15SeltData_opt,"GRUP_NUMB,HOSP_CODE", "asc");  

    if (E15SeltData_opt.size() > 0) {     
%>
...
<%  
    ...
    for( int i = 1 ; i < E15SeltData_opt.size()+1 ; i++ ) {
        E15StmcCodeData data = (E15StmcCodeData)E15SeltData_opt.get(i-1);
        inx++;
%>        
