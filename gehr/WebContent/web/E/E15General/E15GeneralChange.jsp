...
/*   Program ID   : E15GeneralChange.jsp                                        */
/*   Description  : 종합검진 신청내역을 수정                                    */
/*   Note         :                                                             */
...
<tags-approval:request-layout  titlePrefix="COMMON.MENU.ESS_BE_GENE_CHECK">
	<tags:script>
		...
		function fn_openCal(Objectname){
			...
			// alert("     STMCCHECK:"+STMCCHECK+"     HOSP_CODE:"+HOSP_CODE+"     STMC_CODE:"+STMC_CODE   );
			  var lastDate;
			  ...
			  small_window  = window.open("<c:out value='${g.jsp}'/>E/E15General/Hospitalcalendar.jsp?formname=form1&fieldname="+ Objectname + "&curDate=" + lastDate + "&iflag=0&PERNR=${PERNR}"+STMCCHECK+"&HOSP_CODE="+document.form1.HOSP_CODE.value,"essCal", "toolbar=0,location=0,directories=0,status=0,menubar=0,resizable=0,width="+sWidth+",height="+sHeight+",left="+ml+",top="+mt);//[CSR ID:3000327]width 변경
			  small_window.focus();
			}
			...
			<table class="tableGeneral">
            	...
            	<tr>
	                ...
	                <td>
	                    ...
	                    ${f:printCodeOption(getGuenCodeVt, resultData.GUEN_CODE)}
	                    </select>
                    </td>
                </tr>
