...
/*   2Depth Name  : 종합검진                                                    */
/*   Program Name : 종합검진                                                    */
/*   Program ID   : E15GeneralDetail.jsp                                        */
/*   Description  : 종합검진 신청내역을 조회                                    */
/*   Note         :                                                             */
...
<tags-approval:detail-layout titlePrefix="COMMON.MENU.ESS_BE_GENE_CHECK" updateUrl="${g.servlet}hris.E.E15General.E15GeneralChangeSV" disable="${reqDisable}">
              ...
              <table class="tableGeneral">
               <colgroup>
	           	...
	           	<tr>
	                ...
	                <th><!--구분--><spring:message code="LABEL.E.E28.0002" /></th>
	                <td>
               ...
               <tr>
                   ...
                   <th><!--소화기검사선택--><spring:message code="LABEL.E.E28.0010" /></th>
                   <td>
                ...
                <tr>
                    ...
                    <th><!--선택검사--><spring:message code="LABEL.E.E28.0012" /></th>
                    <td>
                ...
                <tr>
	                ...
	                <th><!--검진희망일--><spring:message code="LABEL.E.E28.0003" /></th>
	                <td>
                ...
                <tr>
                 ...
                 <tr>
	                 ...
	                 <td colspan="3">
	                 	  <input type="text" name="BIGO" size="60" class="noBorder" value="<c:out value='${resultData.BIGO}'/>" readonly />
	                 </td>
                 </tr>
                 </c:if>

				 <!-- 대산  -->
              	 <c:if test="${resultData.AREA_CODE eq '09' || resultData.AREA_CODE eq '05' }" >
                 <tr>
