...
/*   2Depth Name  : 주택지원                                                    */
/*   Program Name : 주택자금 융자 상세조회                                      */
/*   Program ID   : E09HouseDetail_m.jsp                                        */
/*   Description  : 개인의 주택자금 융자 상세조회                               */
/*   Note         :                                                             */
...
<%
    ...
    data.E_ZZRPAY_MNTH = (data.E_ZZRPAY_MNTH).substring(0,4) + "." + (data.E_ZZRPAY_MNTH).substring(4,6);
        ...
        <div class="table">
            <table class="tableGeneral">
                ...
                <tr>
                    ...
                    <td><%= WebUtil.printNumFormat( data.E_DARBT ).equals("0") ? "" : WebUtil.printNumFormat( data.E_DARBT ) %></td>
                    <th class="th02"><!--월 상환원금--><%=g.getMessage("LABEL.E.E09.0017")%></th>
                    <td><%= WebUtil.printNumFormat( data.E_TILBT ).equals("0") ? "" : WebUtil.printNumFormat( data.E_TILBT ) %></td>
                </tr>
                <tr>
                    ...
                    <td><%= WebUtil.printNumFormat( data.E_BETRG ).equals("0") ? "" : WebUtil.printNumFormat( data.E_BETRG ) %></td>
                </tr>
                <tr>
                    ...
                    <td><%= WebUtil.printNumFormat( data.E_TILBT_BETRG ).equals("0") ? "" : WebUtil.printNumFormat( data.E_TILBT_BETRG ) %></td>
                </tr>
                <tr>
