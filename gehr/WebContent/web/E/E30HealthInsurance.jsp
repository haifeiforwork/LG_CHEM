...
/*   2Depth Name  : 건강보험                                                    */
/*   Program Name : 건강보험 조회                                               */
/*   Program ID   : E30HealthInsurance.jsp                                      */
/*   Description  : 건강보험 조회                                               */
/*   Note         : 없음                                                        */
/*   Creation     :                                                             */
...
%>
        <tr class="oddRow">
          ...
          <td ><%= DataUtil.addSeparate(e30Health01.REGNO) %></td>
          <td ><%= WebUtil.printNum(e30Health01.GRADE) %>등급</td>
  ...
  <div class="listArea">
    <div class="table">
      ...
      <thead>
        <tr>
          <th width="50%"><!--  사업장 기호 --><%=g.getMessage("LABEL.E.E30.0002")%></th>
