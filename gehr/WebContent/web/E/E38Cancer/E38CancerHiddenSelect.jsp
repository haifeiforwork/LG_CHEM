...
/*   Program ID   : E38CancerHiddenSelect.jsp                                    */
...
<% 
    ...
    Vector E15StmcData_opt  = (new E38CancerStmcCodeRFC()).getStmcCode(PERNR,HOSP_CODE);
...
<%
    ...
    for( int i = 1 ; i < E15StmcData_opt.size()+1 ; i++ ) {
        E38CancerStmcCodeData data = (E38CancerStmcCodeData)E15StmcData_opt.get(i-1);
...
<% 
    int inx = 1;
// out.println("PERNR:"+PERNR+"HOSP_CODE:"+HOSP_CODE);


    Vector E38CancerSeltData_opt  = (new E38CancerSeltCodeRFC()).getSeltCode(PERNR,HOSP_CODE); 
 //out.println( "E38CancerSeltData_opt:"+E38CancerSeltData_opt.toSring());
   // E38CancerSeltData_opt  = SortUtil.sort_num(E38CancerSeltData_opt,"GRUP_NUMB,HOSP_CODE", "asc");  

    if (E38CancerSeltData_opt.size() > 0) {     
%>
...
<%  
    ...
    for( int i = 1 ; i < E38CancerSeltData_opt.size()+1 ; i++ ) {
        E38CancerStmcCodeData data = (E38CancerStmcCodeData)E38CancerSeltData_opt.get(i-1);
        inx++;
%>        
