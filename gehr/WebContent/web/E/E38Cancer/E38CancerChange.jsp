...
/*   Program Name : 추가암검진(7대암검진) 수정                                               */
/*   Program ID   : E38CancerChange.jsp                                        */
/*   Description  : 추가암검진(7대암검진) 신청내역을 수정                                    */
/*   Note         :                                                             */
...
<tags-approval:request-layout  titlePrefix="COMMON.MENU.ESS_BE_ADDI_CHECK">
	<tags:script>
		...
		function fn_openCal(Objectname){
			  ...
			  small_window = window.open("<c:out value='${g.jsp}'/>E/E38Cancer/E38CancerHospitalcalendar.jsp?formname=form1&fieldname="+ Objectname + "&curDate=" + lastDate + "&iflag=0&PERNR=${PERNR}"+STMCCHECK+"&HOSP_CODE="+document.form1.HOSP_CODE.value,"essCal", "toolbar=0,location=0,status=0,menubar=0,resizable=0,width="+sWidth+",height="+sHeight+",left="+ml+",top="+mt);//[CSR ID:3000327]width 변경
			  small_window.focus();
			}
			...
			<table class="tableGeneral">
                ...
                <tr>
                 ...
                 <tr>
	                 ...
	                 <td colspan="3"><input type="text" name="BIGO" size="105" value="<c:out value='${resultData.BIGO}'/>" />
	                 </td>
                 </tr>
                 </c:if>
                 ...
                 <tr>
                     ...
                     <td colspan="3">
                     	  <input type="text" name="textfield92" size="105" class="noBorder" value="<c:out value='${appstat}'/>" readonly />
                     </td>
                 </tr>
	...
	<!-- Hidden Field -->
	<input type="hidden" name = "ZCONFIRM" value="<c:out value='${resultData.ZCONFIRM}'/>">
    ...
    <input type="hidden" name="F_FLAG" value="<c:out value='${E38CancerData.f_FLAG }'/>">
