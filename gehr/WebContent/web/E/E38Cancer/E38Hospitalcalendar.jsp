...
/*   Program ID   : E38Hospitalcalendar.jsp                                     */
...
<!--
  ...
  function Submitit(){
    ...
    url = '<%=WebUtil.JspURL%>E/E38Cancer/Hospitalcalendar.jsp?PERNR=<%=PERNR%>&moreScriptFunction=<%=moreScriptFunction%>&optionvalue=selectvalue';
  ...
  function PrevNext(val){
    url = '<%=WebUtil.JspURL%>E/E38Cancer/Hospitalcalendar.jsp?PERNR=<%=PERNR%>&moreScriptFunction=<%=moreScriptFunction%>';
	url +='&optionvalue='+val;
	url +='&formname=<%=request.getParameter("formname")%>';
	url +='&fieldname=<%=request.getParameter("fieldname")%>&curDate=<%=curDate %>&iflag=2';
  ...
  <table width="350" border="0" cellspacing="0" cellpadding="0" height="300">
    ...
    <tr aliggn=center>
     ...
     <table width="350" border="0">
        <tr>
          <td class="td09" width="30"></td>
          <td class="td01" width="80">&nbsp;&nbsp;&nbsp;&nbsp;검진병원</td>
