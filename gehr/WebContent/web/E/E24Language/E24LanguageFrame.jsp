...
<form name="form1" method="post" method="post">
    ...
    <div class="subWrapper">
		<div class="subHead">
			<h2><!--어학지원비 --><%=g.getMessage("COMMON.MENU.ESS_BE_LANG_EXPA")%></h2>
		</div>
	    <div class="contentBody">
	        <!-- 탭 시작 -->
	        <div class="tabArea">
	            <ul class="tab">
	            	<li><a href="javascript:;" onclick="tabMove(this,'<%= WebUtil.JspPath %>common/wait.jsp?url=<%= WebUtil.ServletURL %>hris.E.Global.E23Language.E23LanguageBuildSV');" class="selected"><!--신청--><%=g.getMessage("TAB.COMMON.0041")%></a></li>
	                <li><a href="javascript:;" onclick="tabMove(this,'<%= WebUtil.ServletURL %>hris.E.Global.E24Language.E24LanguageListSV');" ><!--조회--><%=g.getMessage("TAB.COMMON.0042")%></a></li>
	            </ul>
	        </div>
	    </div>
