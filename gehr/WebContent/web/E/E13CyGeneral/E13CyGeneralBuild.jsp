...
/*   Program ID   : E13CyGeneralBuild.jsp                                         */
/*   Description  : 이월종합검진을 신청할 수 있는 화면                              */
/*   Note         :                                                             */
...
<tags-approval:request-layout  titlePrefix="TAB.COMMON.0053" >
	...
	function sel_hidden(gubun) {
	    ...
	    document.form2.action = "<c:out value='${g.jsp}'/>E/E13CyGeneral/E13HiddenSelect.jsp";
	...
	function fn_openCal(Objectname){
		...
		//CSR ID:3393141] HR종합검진 ERP시스템 에러개선 요청 end
		  ...
		  small_window  = window.open("<c:out value='${g.jsp}'/>E/E13CyGeneral/E13CyHospitalcalendar.jsp?formname=form1&fieldname="+ Objectname + "&curDate=" + lastDate + "&iflag=0&PERNR=<c:out value='${PERNR}'/>"+STMCCHECK+"&HOSP_CODE="+document.form1.HOSP_CODE.value,"essCal", "toolbar=0,location=0,status=0,menubar=0,resizable=0,width="+sWidth+",height="+sHeight+",left="+ml+",top="+mt);//[CSR ID:3000327]width 변경
		  small_window.focus();
	}
			...
			<table class="tableGeneral">
               ...
               <tr>
                   ...
                   <td>
                       ...
                       <c:choose>
                       		<c:when test="${ fn:length(E13CyStmcData_opt) eq 0 }">
                ...
                <tr>
                    ...
                    <td>
                    	...
                    	<c:choose>
                       		<c:when test="${ fn:length(E13CySeltData_opt) eq 0 }">
								<option value=""><!--해당사항없음--><spring:message code="LABEL.E.E28.0013" /></option>
                       		</c:when>
                       		<c:otherwise>
								<option value="">-------------</option>
	...
	<input type="hidden" name = "ZDEFER" value="X"><!--이월검진신청여부-->
