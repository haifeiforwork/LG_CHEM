...
/*   2Depth Name  : 이월종합검진                                                    */
/*   Program Name : 이월종합검진                                                    */
/*   Program ID   : E13CyGeneralDetail.jsp                                        */
/*   Description  : 이월종합검진 신청내역을 조회                                    */
/*   Note         :                                                             */
...
<tags-approval:detail-layout titlePrefix="TAB.COMMON.0053" updateUrl="${g.servlet}hris.E.E13CyGeneral.E13CyGeneralChangeSV" disable="<c:out value='${reqDisable}'/>">
              ...
              <table class="tableGeneral">
	               <colgroup>
		           	...
		           	<tr>
		                ...
		                <th><spring:message code="LABEL.E.E28.0002" /></th>
		                <td>
