...
function do_delete(){
    if( chk_APPR_STAT(1) && confirm("정말 삭제하시겠습니까?") ) {
        ...
        document.form1.action = "<%= WebUtil.ServletURL %>hris.E.E12Stock.E12StockDetailSV";
        document.form1.method = "post";
        document.form1.submit();
    }
}
...
<div class="subWrapper">
    ...
    <div class="title"><h1>증권계좌 조회</h1></div>
    ...
    <div class="tableArea">
        <div class="table">
            <table class="tableGeneral">
                ...
                <tr>
                    <th>증권회사</th>
                    <td> <input type="text" name="SECU_NAME" value="<%= data.SECU_NAME %>" size="20" readonly></td>
                </tr>
                <tr>
                    <th>계좌번호</th>
                    <td><input type="text" name="GAPP_CONT" value="<%= data.GAPP_CONT %>" size="20" maxlength="18" readonly></td>
                </tr>
            </table>
        </div>
    </div>
...
<%
    if ( ThisJspName.equals("A03AccountDetail.jsp")  ) {
