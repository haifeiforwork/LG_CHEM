...
<%
    E17BillData X_e17BillData = (E17BillData)E17BillData_vt.get(select_index);
%>
    document.form1.TOTL_WONX.value = '<%= X_e17BillData.TOTL_WONX.equals("") ? "" : WebUtil.printNumFormat(X_e17BillData.TOTL_WONX).equals("0") ? "" : WebUtil.printNumFormat(X_e17BillData.TOTL_WONX, currencyValue) %>';
    document.form1.ASSO_WONX.value = '<%= X_e17BillData.ASSO_WONX.equals("") ? "" : WebUtil.printNumFormat(X_e17BillData.ASSO_WONX).equals("0") ? "" : WebUtil.printNumFormat(X_e17BillData.ASSO_WONX, currencyValue) %>';
    document.form1.MEAL_WONX.value = '<%= X_e17BillData.MEAL_WONX.equals("") ? "" : WebUtil.printNumFormat(X_e17BillData.MEAL_WONX).equals("0") ? "" : WebUtil.printNumFormat(X_e17BillData.MEAL_WONX, currencyValue) %>';
    document.form1.APNT_WONX.value = '<%= X_e17BillData.APNT_WONX.equals("") ? "" : WebUtil.printNumFormat(X_e17BillData.APNT_WONX).equals("0") ? "" : WebUtil.printNumFormat(X_e17BillData.APNT_WONX, currencyValue) %>';
    document.form1.ROOM_WONX.value = '<%= X_e17BillData.ROOM_WONX.equals("") ? "" : WebUtil.printNumFormat(X_e17BillData.ROOM_WONX).equals("0") ? "" : WebUtil.printNumFormat(X_e17BillData.ROOM_WONX, currencyValue) %>';
    document.form1.CTXX_WONX.value = '<%= X_e17BillData.CTXX_WONX.equals("") ? "" : WebUtil.printNumFormat(X_e17BillData.CTXX_WONX).equals("0") ? "" : WebUtil.printNumFormat(X_e17BillData.CTXX_WONX, currencyValue) %>';
    document.form1.MRIX_WONX.value = '<%= X_e17BillData.MRIX_WONX.equals("") ? "" : WebUtil.printNumFormat(X_e17BillData.MRIX_WONX).equals("0") ? "" : WebUtil.printNumFormat(X_e17BillData.MRIX_WONX, currencyValue) %>';
    document.form1.SWAV_WONX.value = '<%= X_e17BillData.SWAV_WONX.equals("") ? "" : WebUtil.printNumFormat(X_e17BillData.SWAV_WONX).equals("0") ? "" : WebUtil.printNumFormat(X_e17BillData.SWAV_WONX, currencyValue) %>';
    document.form1.DISC_WONX.value = '<%= X_e17BillData.DISC_WONX.equals("") ? "" : WebUtil.printNumFormat(X_e17BillData.DISC_WONX).equals("0") ? "" : WebUtil.printNumFormat(X_e17BillData.DISC_WONX, currencyValue) %>';
    document.form1.ETC1_WONX.value = '<%= X_e17BillData.ETC1_WONX.equals("") ? "" : WebUtil.printNumFormat(X_e17BillData.ETC1_WONX).equals("0") ? "" : WebUtil.printNumFormat(X_e17BillData.ETC1_WONX, currencyValue) %>';
    document.form1.ETC2_WONX.value = '<%= X_e17BillData.ETC2_WONX.equals("") ? "" : WebUtil.printNumFormat(X_e17BillData.ETC2_WONX).equals("0") ? "" : WebUtil.printNumFormat(X_e17BillData.ETC2_WONX, currencyValue) %>';
    document.form1.ETC3_WONX.value = '<%= X_e17BillData.ETC3_WONX.equals("") ? "" : WebUtil.printNumFormat(X_e17BillData.ETC3_WONX).equals("0") ? "" : WebUtil.printNumFormat(X_e17BillData.ETC3_WONX, currencyValue) %>';
    document.form1.ETC4_WONX.value = '<%= X_e17BillData.ETC4_WONX.equals("") ? "" : WebUtil.printNumFormat(X_e17BillData.ETC4_WONX).equals("0") ? "" : WebUtil.printNumFormat(X_e17BillData.ETC4_WONX, currencyValue) %>';
    document.form1.ETC5_WONX.value = '<%= X_e17BillData.ETC5_WONX.equals("") ? "" : WebUtil.printNumFormat(X_e17BillData.ETC5_WONX).equals("0") ? "" : WebUtil.printNumFormat(X_e17BillData.ETC5_WONX, currencyValue) %>';
    document.form1.ETC1_TEXT.value = '<%= X_e17BillData.ETC1_TEXT.trim() %>';
    document.form1.ETC2_TEXT.value = '<%= X_e17BillData.ETC2_TEXT.trim() %>';
    document.form1.ETC3_TEXT.value = '<%= X_e17BillData.ETC3_TEXT.trim() %>';
    document.form1.ETC4_TEXT.value = '<%= X_e17BillData.ETC4_TEXT.trim() %>';
    document.form1.ETC5_TEXT.value = '<%= X_e17BillData.ETC5_TEXT.trim() %>';
    multiple_won();
}
    ...
    <tr> 
      ...
      <!--타이틀 테이블 시작-->
        <table width="790" border="0" cellspacing="0" cellpadding="0">
          ...
          <tr> 
            <td class="title01">진료비 계산서 수정</td>
          </tr>
        </table>
      <!--타이틀 테이블 끝-->
      </td>
...
%>
    ...
    <input type="hidden" name="TOTL_WONX<%=i%>"   value="<%= e17BillData.TOTL_WONX.equals("0.0") ? "" : e17BillData.TOTL_WONX %>"> <!-- 총 진료비         -->
    <input type="hidden" name="ASSO_WONX<%=i%>"   value="<%= e17BillData.ASSO_WONX.equals("0.0") ? "" : e17BillData.ASSO_WONX %>"> <!-- 조합 부담금       -->
    <input type="hidden" name="x_EMPL_WONX<%=i%>" value="<%= e17BillData.EMPL_WONX.equals("0.0") ? "" : e17BillData.EMPL_WONX %>">  <!--본인 부담금       -->
    <input type="hidden" name="MEAL_WONX<%=i%>"   value="<%= e17BillData.MEAL_WONX.equals("0.0") ? "" : e17BillData.MEAL_WONX %>"> <!-- 식대              -->
    <input type="hidden" name="APNT_WONX<%=i%>"   value="<%= e17BillData.APNT_WONX.equals("0.0") ? "" : e17BillData.APNT_WONX %>"> <!-- 지정 진료비       -->
    <input type="hidden" name="ROOM_WONX<%=i%>"   value="<%= e17BillData.ROOM_WONX.equals("0.0") ? "" : e17BillData.ROOM_WONX %>"> <!-- 상급 병실료 차액  -->
    <input type="hidden" name="CTXX_WONX<%=i%>"   value="<%= e17BillData.CTXX_WONX.equals("0.0") ? "" : e17BillData.CTXX_WONX %>"> <!-- C T 검사비        -->
    <input type="hidden" name="MRIX_WONX<%=i%>"   value="<%= e17BillData.MRIX_WONX.equals("0.0") ? "" : e17BillData.MRIX_WONX %>"> <!-- M R I 검사비      -->
    <input type="hidden" name="SWAV_WONX<%=i%>"   value="<%= e17BillData.SWAV_WONX.equals("0.0") ? "" : e17BillData.SWAV_WONX %>"> <!-- 초음파 검사비     -->
    <input type="hidden" name="DISC_WONX<%=i%>"   value="<%= e17BillData.DISC_WONX.equals("0.0") ? "" : e17BillData.DISC_WONX %>"> <!-- 할인금액          -->
    <input type="hidden" name="ETC1_WONX<%=i%>"   value="<%= e17BillData.ETC1_WONX.equals("0.0") ? "" : e17BillData.ETC1_WONX %>"> <!-- 기타1 의 금액     -->
    <input type="hidden" name="ETC2_WONX<%=i%>"   value="<%= e17BillData.ETC2_WONX.equals("0.0") ? "" : e17BillData.ETC2_WONX %>"> <!-- 기타2 의 금액     -->
    <input type="hidden" name="ETC3_WONX<%=i%>"   value="<%= e17BillData.ETC3_WONX.equals("0.0") ? "" : e17BillData.ETC3_WONX %>"> <!-- 기타3 의 금액     -->
    <input type="hidden" name="ETC4_WONX<%=i%>"   value="<%= e17BillData.ETC4_WONX.equals("0.0") ? "" : e17BillData.ETC4_WONX %>"> <!-- 기타4 의 금액     --> 
    <input type="hidden" name="ETC5_WONX<%=i%>"   value="<%= e17BillData.ETC5_WONX.equals("0.0") ? "" : e17BillData.ETC5_WONX %>"> <!-- 기타5 의 금액     --> 
