...
<form name="form1" method="post" method="post">
    ...
    <div class="subWrapper">
		<div class="subHead">
			<h2><!--Medical Fee--><%=g.getMessage("LABEL.E.E18.0001")%></h2>
		</div>
	    <div class="contentBody">
	        <!-- 탭 시작 -->
	        <div class="tabArea">
	            <ul class="tab">
	            	<li><a  id="tab_1" href="javascript:;" onclick="tabMove(this,'<%= WebUtil.JspPath %>common/wait.jsp?url=<%= WebUtil.ServletURL %>hris.E.E17Hospital.E17HospitalBuildSV');"><!--신청--><%=g.getMessage("TAB.COMMON.0041")%></a></li>
	                <li><a  id="tab_2" href="javascript:;" onclick="tabMove(this,'<%= WebUtil.ServletURL %>hris.E.E18Hospital.E18HospitalListSV');" ><!--조회--><%=g.getMessage("TAB.COMMON.0042")%></a></li>
	            </ul>
	        </div>
	    </div>
	    ...
	    <div class="frameWrapper">
	        <!-- TAB 프레임  -->
	        <iframe id="listFrame" name="listFrame" onload="autoResize(this);" width="100%" height="" marginwidth="0" marginheight="0" scrolling="no" frameborder="0" src="" ></iframe>
	    </div>
