...
<%@ page import="hris.E.Global.E18Hospital.*" %>
...
function  doSearchDetail() {
    document.form1.action = "<%= WebUtil.ServletURL %>hris.E.Global.E18Hospital.E18HospitalListSV_m";
...
//PageUtil 관련 script - page처리시 반드시 써준다...
function get_Page2(){
    document.form3.action = '<%= WebUtil.ServletURL %>hris.E.Global.E18Hospital.E18HospitalListSV_m';
