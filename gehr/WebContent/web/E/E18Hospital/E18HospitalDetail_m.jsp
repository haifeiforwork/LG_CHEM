...
/*   Program ID   : E18HospitalDetail_m.jsp                                     */
/*   Description  : 사원의 의료비 상세 내역을 조회                              */
/*   Note         :                                                             */
...
function goBill() {
    ...
    document.form2.action = '<%= WebUtil.ServletURL %>hris.E.E18Hospital.E18BillDetailSV_m' ;
...
%>
                    &nbsp;&nbsp;&nbsp;<input type="checkbox" name="PROOF" value="X" size="20" <%= PROOF.equals("X") ? "checked" : "" %> disabled>&nbsp;<!--연말정산반영여부--><%=g.getMessage("LABEL.E.E18.0021")%>
<%
    }
%>
                    </td>
                ...
                <tr>
                    ...
                    <td colspan="3"><input type="text" size="35" value="<%= TREA_TEXT %>" readonly></td>
                </tr>
                <tr>
                    <th><!--상병명--><%=g.getMessage("LABEL.E.E18.0006")%></th>
                    <td colspan="3"><input type="text" size="103" value="<%= SICK_NAME %>" readonly></td>
                </tr>
                <tr>
                ...
                <tr>
                    <td colspan="3"><input type="text" name="BIGO_TEXT2" value="<%= BIGO_TEXT2 %>" style="text-align:left" size="103" readonly></td>
                </tr>
                <tr>
                    <th><!--반납일자--><%=g.getMessage("LABEL.E.E18.0024")%></th>
                    <td>
                        <input type="text" name="RFUN_DATE" value="<%= RFUN_DATE.equals("0000-00-00") ? "" : WebUtil.printDate(RFUN_DATE) %>" style="text-align:left" size="20" readonly>
                    </td>
...
%>
    ...
    <div class="buttonArea">
        <ul class="btn_crud">
            <li><a href="javascript:history.back();"><span><!--목록--><%=g.getMessage("BUTTON.COMMON.LIST")%></span></span></a></li>
        </ul>
    </div>
