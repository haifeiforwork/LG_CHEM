...
<%
    ...
    String E_PRINT = (String)request.getAttribute("E_PRINT");
...
<style>
.guide {
  font-size:9pt;padding:3px;text-align:center
}
.lguide {
  font-size:9pt;padding:3px;text-align:left
}
</style>
<script language="javascript">
function  doSearchDetail() {
    document.form1.action = "<%= WebUtil.ServletURL %>hris.E.E16Health.E16HealthCardSV";
...
function go_print(){
    ...
    window.open('', 'essPrintWindow', "toolbar=no,location=no, directories=no,status=no,menubar=yes,resizable=no,width=660,height=662,left=0,top=2");
    ...
    <jsp:include page="/include/body-header.jsp">
        ...
        <jsp:param name="title" value="LABEL.E.E16.0001"/>
    </jsp:include>
    ...
    <div class="table">
      <table class="tableGeneral">
        ...
        <tr>
          ...
          <td>
            <select name="YEAR"  onChange="javascript:reload();">
    <%= WebUtil.printOption(CodeEntity_vt, String.valueOf(YEAR) )%>
            </select>
          </td>
          <td class="align_right" style="padding-bottom:5px">
<%
    if ("Y".equals(E_PRINT) ) {
...
%>
        ...
        <ul class="btn_mdl">
            <li><a href="javascript:go_print();"><span><!-- 인쇄하기--><%=g.getMessage("LABEL.D.D12.0040")%></span></a></li>
        </ul>
      ...
      <div class="table">
        <table class="tableGeneral">
			...
			<tr>
			  ...
			  <th class="th02"><!--직위 --><%=g.getMessage("MSG.APPROVAL.0024")%></th>
...
%>
  ...
  <h2 class="subtitle"><!--건강관리 --><%=g.getMessage("LABEL.E.E16.0024")%></h2></td>
...
%>
  ...
  <h2 class="subtitle"> <!--상담내용 --><%=g.getMessage("LABEL.E.E16.0043")%></h2>
