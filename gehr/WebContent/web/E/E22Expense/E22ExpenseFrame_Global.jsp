...
<form name="form1" method="post" method="post">
    ...
    <div class="subWrapper">
		<div class="subHead">
			<h2><!--Tuition Fee--><%=g.getMessage("COMMON.MENU.ESS_BE_TUTI_EXPA")%></h2>
		</div>
	    <div class="contentBody">
	        <!-- 탭 시작 -->
	        <div class="tabArea">
	            <ul class="tab">
	            	<li><a href="javascript:;" onclick="tabMove(this,'<%= WebUtil.JspPath %>common/wait.jsp?url=<%= WebUtil.ServletURL %>hris.E.Global.E21Expense.E21ExpenseBuildSV');" class="selected"><!--신청--><%=g.getMessage("TAB.COMMON.0041")%></a></li>
	                <li><a href="javascript:;" onclick="tabMove(this,'<%= WebUtil.ServletURL %>hris.E.Global.E22Expense.E22ExpenseListSV');" ><!--조회--><%=g.getMessage("TAB.COMMON.0042")%></a></li>
	            </ul>
	        </div>
	    </div>
