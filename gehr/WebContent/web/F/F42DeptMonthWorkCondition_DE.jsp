...
/*   Program ID   		: F42DeptMonthWorkConditionDe.jsp                               												*/
/*   Description  		: 부서별 월간 근태 집계표 조회를 위한 jsp 파일[독일]       														*/
/*   Note         		: 없음                                                        																		*/
/*   Creation     		: 2010-07-31  yji                                           															*/
/***********************************************************************************/%>
...
//-->
     ...
     <jsp:include page="/include/body-header.jsp">
        <jsp:param name="help" value="F42DeptMonthWorkConditionDe.html"/>
    </jsp:include>
...
%>
				...
				&nbsp;&nbsp;
					<ul class="btn_mdl displayInline align:right">
      	...
      	<col width="7%"/>
              ...
              <thead>
			        <tr>
			          ...
			          <th  colspan="3"><!-- Leave(Days)--><%=g.getMessage("LABEL.F.F42.0061")%></th>
