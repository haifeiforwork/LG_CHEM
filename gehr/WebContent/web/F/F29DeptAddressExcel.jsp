...
*   Program ID   : F29DeptAddressExcel.jsp
*   Description  : 부서별 현주소 Excel 저장을 위한 jsp 파일
*   Note         : 없음
*   Creation     :
...
<%
    ...
    /*----- Excel 파일 저장하기 --------------------------------------------------- */
    response.setHeader("Content-Disposition","attachment;filename=DeptAddress.xls");
  ...
  <tr>
    ...
    <td >
      <table width="100%" border="0" cellspacing="0" cellpadding="0" align="center">
        <tr>
          <td colspan="5" class="title02">* <spring:message code="LABEL.F.F29.0004"/><!-- 부서별 현주소 --></td>
        </tr>
        <tr><td height="10"></td></tr>
        <tr>
	      <td colspan="11" class="td09">&nbsp;<spring:message code='LABEL.F.FCOMMON.0001'/> : <%=WebUtil.nvl(deptNm, user.e_obtxt)%></td>
          <td colspan="1"  class="td08">(<spring:message code="LABEL.F.FCOMMON.0006"/><!--  총 --><%=DeptAddress_vt.size()%><spring:message code="LABEL.F.FCOMMON.0007"/><!-- 건  -->)&nbsp;</td>
	    </tr>
	    <tr><td height="10"></td></tr>
      </table>
    </td>
    ...
    <td >
        ...
        <table  border="1" cellspacing="1" cellpadding="4" class="table02">
          <tr>
				...
				<td><spring:message code="LABEL.F.F29.0001"/><!-- 우편번호 --></td>
				<td><spring:message code="LABEL.F.F29.0002"/><!-- 주소 --></td>
				<td><spring:message code="LABEL.F.F29.0003"/><!-- 주거형태 --></td>
          </tr>
<%
