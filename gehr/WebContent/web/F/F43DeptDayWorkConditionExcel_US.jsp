...
/*   Description  		: 부서별 일간 근태 집계표 Excel 저장을 위한 jsp (USA)                											*/
/*   Note         		: 없음                                                        																		*/
	...
	<tr>
  	...
  	<tr>
    	...
    	<td colspan="15">
      		<table width="100%" border="0" cellspacing="0" cellpadding="0" align="center">
        		<tr>
          			<td colspan="15" class="td09">&nbsp;<!-- Date--><%=g.getMessage("LABEL.F.F43.0082")%> : <%= searchDay.substring(0,6) %></td>
					<%
           			...
           			<table width="100%" border="1" cellpadding="0" cellspacing="1" class="table01_1" align="left">
			            ...
			            <tr>
			                ...
			                <td class="td09">
                				<table>
                       				<tr>
					                           <td width="160">A&nbsp;:&nbsp;<!--Absence--><%=g.getMessage("LABEL.F.F43.0017")%></td>
					                           <td width="160">O&nbsp;:&nbsp;<!--Others--><%=g.getMessage("LABEL.F.F43.0072")%></td>
					                           <td width="160">S&nbsp;:&nbsp;<!--Sick--><%=g.getMessage("LABEL.F.F43.0079")%></td>
					                           <td width="160">P&nbsp;:&nbsp;<!--Personal Time--><%=g.getMessage("LABEL.F.F43.0080")%></td>
			                        </tr>
			                        <tr>
				                       <td>V&nbsp;:&nbsp;<!--Vacation--><%=g.getMessage("LABEL.F.F43.0081")%></td>
			                           <td></td>
			                           <td></td>
			                           <td></td>
			                        </tr>
              			...
              			<tr>
			                <td class="td03"><!--Overtime--><%=g.getMessage("LABEL.F.F43.0039")%></td>
			                <td class="td09_1">
                    			<table>
			                       <tr>
			                           <td width="120">OT&nbsp;:&nbsp;<!--Overtime--><%=g.getMessage("LABEL.F.F43.0039")%></td>
			                       </tr>
			                    </table>
                			</td>
              			</tr>
