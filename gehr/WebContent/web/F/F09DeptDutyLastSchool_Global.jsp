...
*   Program Name   : Org.Unit/Education(Recent)
*                            (Org.Unit/Final Scholarship)
...
function goDetail(paramA, paramB, paramC, paramD, paramE, value){
    ...
    if( value!= "" && value!= "0"){
        ...
        frm.hdn_gubun.value  = "14";             //직무별/최종학력별
        ...
        <div class="wideTable" style="border-top: 2px solid #c8294b;">
          <table class="listTable">
            ...
            <tr>
              ...
              <th width="100" nowrap class="lastCol"><spring:message code='LABEL.F.F01.0006'/><!-- TOTAL --></th>
            </tr>
            </thead>
<%
    String temp = "";
    ...
    for(int i = 0 ; i < DeptDutySchoolTitle_vt.size() ; i ++){
    	F09DeptDutyLastSchoolTitleGlobalData entity = (F09DeptDutyLastSchoolTitleGlobalData) DeptDutySchoolTitle_vt.get(i);
%>
    <tr class="borderRow">
        <%
...
%>
    ...
    <div class="listArea">
        ...
        <div class="table">
          <table class="listTable">
            <tr>
              <th colspan="2" width="80px;"><spring:message code='LABEL.F.FCOMMON.0001'/><!-- Org.Unit --></th>
              <th><spring:message code='LABEL.F.F08.0019'/><!-- Doctor`s Course --></th>
              <th><spring:message code='LABEL.F.F08.0021'/><!-- Master`s Course --></th>
              <th><spring:message code='LABEL.F.F08.0022'/><!-- University --></th>
              <th><spring:message code='LABEL.F.F08.0023'/><!-- College --></th>
              <th><spring:message code='LABEL.F.F08.0024'/><!-- High School --></th>
              <th><spring:message code='LABEL.F.F08.0026'/><!-- Middle School --></th>
              <th><spring:message code='LABEL.F.F08.0027'/><!-- Primary School --></th>
