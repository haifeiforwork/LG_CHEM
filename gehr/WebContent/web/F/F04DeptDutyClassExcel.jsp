...
*   Program ID   : F04DeptDutyClassExcel.jsp
...
<%
    ...
    /*----- Excel 파일 저장하기 --------------------------------------------------- */
    response.setHeader("Content-Disposition","attachment;filename=DeptDutyClass.xls");
  ...
  <tr>
    ...
    <td >
      <table width="100%" border="0" cellspacing="0" cellpadding="0" align="center">
        <tr>
          <td colspan="2" class="title02">* <spring:message code='TAB.COMMON.0074'/> <spring:message code='COMMON.MENU.MSS_HEAD_COUNT'/></td>
        </tr>
