...
/*   2Depth Name  	:                                                     																		*/
/*   Program Name 	:                           																								*/
/*   Program ID   		: F00DeptDetailEmpListUsa.jsp                                       												*/
/*   Description  		: 개인별 근태 각각의 상세화면 팝업 조회 화면           																*/
/*   Note         		: 없음                                                        																		*/
...
<div class="winPop">
<div class="header">
    	<span>Time Attendance Detail</span>
...
<input type="hidden" name="chck_yeno" value="<%= checkYN %>">
  	<div class="listArea">
	    ...
	    <div class="table">
	    	...
	    	<thead>
              <tr align="center">
		          <th  width="220" nowrap><%=g.getMessage("LABEL.F.F51.0009") %><%--Description --%></th>
		          <th  width="220" nowrap><%=g.getMessage("LABEL.F.F43.0082") %><%--Date --%></th>
		          <th  width="200" nowrap class="lastCol"><%=g.getMessage("LABEL.D.D07.0005") %><%--Hours --%></th>
              </tr>
              </thead>
				<%
				   if (!isFirst) {
              ...
              <tr align="center" class=<%=WebUtil.printOddRow(i) %>>
		          ...
		          <td  nowrap class="lastCol">&nbsp;&nbsp;<%= data.STDAZ %>&nbsp;&nbsp;</td>
              </tr>
            	<%
            				}
				%>
		...
		%>
        <tr align="center">
          <td  align="center" colspan="4"><%=g.getMessage("LABEL.F.F51.0029") %><%--No Data --%></td>
        </tr>
