...
*   Program ID     : F01DeptPositionClass.jsp
...
function goDetail(paramA, paramB, paramC, paramD, value){
    ...
    if( value!= "" && value!= "0"){
        ...
        frm.hdn_gubun.value  = "01";             //소속별/직급별
...
%>
    ...
    <div class="listArea">
        <div class="listTop">
            <h2 class="subtitle withButtons"><spring:message code='LABEL.F.FCOMMON.0001'/><!-- 부서 --> : <strong><%=WebUtil.nvl(deptNm, user.e_obtxt)%></h2>
        ...
        <div class="wideTable" style="border-top: 2px solid #c8294b;">
            <table class="listTable" >
            	<thead>
                <tr>
                    <th rowspan="2" ><spring:message code='LABEL.F.F04.0001'/><!-- 구분 --></th>
<%
...
%>
                    <th class="lastCol" rowspan="2" nowrap style="min-width:50px;"><spring:message code='LABEL.F.F04.0002'/><!-- 합계 --></td>
                </tr>
                <tr>
<%
            //하위 타이틀.
...
%>
          <th style="min-width:50px;"><%=titleData.TRFGR%></th>
<%
            }//end for
