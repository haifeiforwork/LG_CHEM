...
*   Program ID   : F05DeptGradeClassExcel_Global.jsp
...
<%
    ...
    /*----- Excel 파일 저장하기 --------------------------------------------------- */
    response.setHeader("Content-Disposition","attachment;filename=Responsibility_of_Office_Level.xls");
  ...
  <tr>
    ...
    <td >
      <table width="100%" border="0" cellspacing="0" cellpadding="0" align="center">
        <tr>
          <td colsapn="2" class="title02">* <spring:message code='LABEL.F.F04.0007'/><!-- Responsibility of Office -->/<spring:message code='LABEL.F.F04.0005'/><!-- Level --></td>
        </tr>
    ...
    <td valign="top" width="">
      <table border="1" cellpadding="0" cellspacing="1" class="table02" align="left">
        <tr>
          ...
          <td rowspan="2" style="text-align:center" width="80"><spring:message code='LABEL.F.F03.0002'/><!-- Pers. Area --></td>
          <td rowspan="2" style="text-align:center" width="80"><spring:message code ='LABEL.F.F04.0006'/><!-- Res. Of Office --></td>
          ...
          %>
          <td style="text-align:center" rowspan="2" width="50"  nowrap><spring:message code='LABEL.F.F01.0006'/><!-- TOTAL --></td>
        ...
        <tr>
          ...
          <%
          	...
          	if(Integer.parseInt(total.P03) > 0){
          %>
          <td width="50" style="text-align:center" nowrap><spring:message code='LABEL.F.F01.0010'/><!-- I --></td>
          <%
          	}
          	if(Integer.parseInt(total.P04) > 0){
          %>
          <td width="50" style="text-align:center" nowrap><spring:message code='LABEL.F.F01.0011'/><!-- II-1 --></td>
          <%
          	}
          	if(Integer.parseInt(total.P05) > 0){
          %>
          <td width="50" style="text-align:center" nowrap><spring:message code='LABEL.F.F01.0012'/><!-- II-2 --></td>
		  <%
		  	}
		  	if(Integer.parseInt(total.P06) > 0){
		  %>
          <td width="50" style="text-align:center" nowrap><spring:message code='LABEL.F.F01.0013'/><!-- III --></td>
           <%
		  	}
		  	if(Integer.parseInt(total.P24) > 0){
		  %>
          <td width="50" style="text-align:center" nowrap><spring:message code='LABEL.F.F01.0014'/><!-- III-1 --></td>
           <%
		  	}
		  	if(Integer.parseInt(total.P25) > 0){
		  %>
          <td width="50" style="text-align:center" nowrap><spring:message code='LABEL.F.F01.0015'/><!-- III-2 --></td>
          <%
          	}
          	if(Integer.parseInt(total.P07) > 0){
          %>
          <td width="50" style="text-align:center" nowrap><spring:message code='LABEL.F.F01.0016'/><!-- IV-1 --></td>
          <%
          	}
          	if(Integer.parseInt(total.P26) > 0){
          %>
          <td width="50" style="text-align:center" nowrap><spring:message code='LABEL.F.F01.0017'/><!-- IV-1.A --></td>
          <%
          	}
          	if(Integer.parseInt(total.P27) > 0){
          %>
          <td width="50" style="text-align:center" nowrap><spring:message code='LABEL.F.F01.0018'/><!-- IV-1.B --></td>
          <%
          	}
          	if(Integer.parseInt(total.P08) > 0){
          %>
          <td width="50" style="text-align:center" nowrap><spring:message code='LABEL.F.F01.0019'/><!-- IV-2 --></td>
          <%
          	}
          	if(Integer.parseInt(total.P09) > 0){
          %>
          <td width="50" style="text-align:center" nowrap><spring:message code='LABEL.F.F01.0020'/><!-- IV-3 --></td>
          <!-- [CSR ID:3637301] 해외 ERP 사무직 직급(L!/L2/L3) 추가 요청 start -->
          <%
            }
            if (Integer.parseInt(total.P30) > 0) {
          %>
          <th width="50" style="text-align:center" nowrap><spring:message code='LABEL.F.F01.0044'/><!-- L1 --></th>
          <%
            }
            if (Integer.parseInt(total.P29) > 0) {
          %>
          <th width="50" style="text-align:center" nowrap><spring:message code='LABEL.F.F01.0045'/><!-- L2 --></th>
          <%
            }
            if (Integer.parseInt(total.P28) > 0) {
          %>
          <th width="50" style="text-align:center" nowrap><spring:message code='LABEL.F.F01.0046'/><!-- L3 --></th>
          <%
            }
            if (Integer.parseInt(total.P31) > 0) {
          %>
          <th width="50" style="text-align:center" nowrap><spring:message code='LABEL.F.F01.0047'/><!-- OTHERS --></th>
          <!-- [CSR ID:3637301] 해외 ERP 사무직 직급(L!/L2/L3) 추가 요청 end -->
          <%
          	}
          	if(Integer.parseInt(total.P10) > 0){
          %>
          <td width="50" style="text-align:center" nowrap><spring:message code='LABEL.F.F04.0002'/><!-- SUM --></td>
          <%
          	}
          	if(Integer.parseInt(total.P11) > 0){
          %>
          <td width="50" style="text-align:center" nowrap><spring:message code='LABEL.F.F01.0021'/><!-- J1 --></td>
          <%
          	}
          	if(Integer.parseInt(total.P14) > 0){
          %>
          <td width="50" style="text-align:center" nowrap><spring:message code='LABEL.F.F01.0022'/><!-- J2 --></td>
          <%
          	}
          	if(Integer.parseInt(total.P12) > 0){
          %>
          <td width="50" style="text-align:center" nowrap><spring:message code='LABEL.F.F01.0023'/><!-- J1-1 --></td>
          <%
          	}
          	if(Integer.parseInt(total.P13) > 0){
          %>
          <td width="50" style="text-align:center" nowrap><spring:message code='LABEL.F.F01.0024'/><!-- J1-2 --></td>
          <%
          	}
          	if(Integer.parseInt(total.P15) > 0){
          %>
          <td width="50" style="text-align:center" nowrap><spring:message code='LABEL.F.F01.0025'/><!-- J2-1 --></td>
          <%
          	}
          	if(Integer.parseInt(total.P16) > 0){
          %>
          <td width="50" style="text-align:center" nowrap><spring:message code='LABEL.F.F01.0026'/><!-- J2-2 --></td>
          <%
          	}
          	if(Integer.parseInt(total.P17) > 0){
          %>
          ...
          <%
          	...
          	if(Integer.parseInt(total.P18) > 0){
          %>
          <td width="50" style="text-align:center" nowrap><spring:message code='LABEL.F.F01.0027'/><!-- O/W --></td>
          <%
          	}
          	if(Integer.parseInt(total.P19) > 0){
          %>
          <td width="50" style="text-align:center" nowrap><spring:message code='LABEL.F.F01.0028'/><!-- P/O --></td>
          <%
          	}
          	if(Integer.parseInt(total.P20) > 0){
          %>
        ...
        <tr>
        	...
        	%>
        	<td class="<%=entity.PBTXT.equals("TOTAL")?"td11":"td05"%>" rowspan="<%=meta.get(entity.PBTXT)%>" <%=entity.PBTXT.equals("TOTAL")?"colspan='2'":""%> nowrap style="text-align: <%=entity.PBTXT.equals("TOTAL")?"center":"left"%>">&nbsp;&nbsp;&nbsp;&nbsp;<%=entity.PBTXT %></td>
        	<%
        		}if(!entity.PBTXT.equals("TOTAL")){
        	%>
        	<td class="<%=entity.PBTXT.equals("TOTAL")?"td11":entity.JIKKT.equals("SUBTOTAL")?"td11_2":"td05"%>" nowrap><%=entity.JIKKT %></td>
        	<%}
        	if(Integer.parseInt(total.P01) > 0){
        	%>
        	<td class="<%=entity.PBTXT.equals("TOTAL")?"td11":entity.JIKKT.equals("SUBTOTAL")?"td11_2":"td05"%>" >
