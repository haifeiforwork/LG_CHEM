...
/*   Program ID   		: F42DeptMonthWorkConditionExcelDe.jsp                          											*/
/*   Description  		: 부서별 월간 근태 집계표 Excel 저장을 위한 jsp 파일[독일]          											*/
/*   Note         		: 없음                                                        																		*/
...
<table width="1380" border="0" cellspacing="0" cellpadding="0" align="center">
  ...
  <td width="16">&nbsp;</td>
      ...
      <colgroup>
        ...
        <tr>
          <td  class="td03" colspan="2"><!--Overtime(Hours)--><%=g.getMessage("LABEL.F.F42.0074")%></td>
          <td  class="td03" colspan="3"><!-- Leave(Days)--><%=g.getMessage("LABEL.F.F42.0061")%></td>
