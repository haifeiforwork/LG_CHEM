...
*   Program ID   : F07DeptPositionClassAge.jsp
*   Description  : 소속별/직급별 평균연령 조회를 위한 jsp 파일
*   Note         : 없음
*   Creation     :
...
function goDetail(paramA, paramB, paramC, paramD, value){
    ...
    if( value!= "" && value!= "0"){
        ...
        frm.hdn_gubun.value  = "07";             //소속별/직급별 평균연령
...
%>
                    <th rowspan="2"><spring:message code='LABEL.F.F04.0008'/></th>
                </tr>
                <tr>
<%
            //하위 타이틀.
