...
*   Program ID   : F07DeptPositionClassAgeExcel.jsp
...
<%
    ...
    Vector F07DeptAgeNote_vt  = (Vector)request.getAttribute("F07DeptAgeNote_vt");          //내용

    /*----- Excel 파일 저장하기 --------------------------------------------------- */
    response.setHeader("Content-Disposition","attachment;filename=DeptPositionClassAge.xls");
...
<%
    if ( F07DeptAgeTitle_vt != null && F07DeptAgeTitle_vt.size() > 0 ) {
        ...
        //전체 테이블 크기 조절.
        int tableSize = 0;
        tableSize = F07DeptAgeTitle_vt.size()*50 + 250;
%>
  ...
  <tr>
    ...
    <td >
      <table width="100%" border="0" cellspacing="0" cellpadding="0" align="center">
        <tr>
          <td colsapn="2" class="title02">* <spring:message code='LABEL.F.F43.0010'/><!-- 소속 -->/<spring:message code='TAB.COMMON.0071'/><!-- 직급별 --> <spring:message code='TAB.COMMON.0077'/><!-- 평균연령 --></td>
        </tr>
...
<%
            ...
            //상위 타이틀.
            for( int h = 0; h < F07DeptAgeTitle_vt.size(); h++ ){
                F07DeptPositionClassAgeTitleData titleData = (F07DeptPositionClassAgeTitleData)F07DeptAgeTitle_vt.get(h);
...
<%                          tempCnt = 1;
                ...
                tempTitleCode = (String)titleData.PERSK;
                tempTitleName = (String)titleData.PTEXT;
            }//end for
%>
          <td width="50" class="td03" rowspan="2"><spring:message code='LABEL.F.F04.0008'/></td>
        </tr>
        <tr>
<%
            //하위 타이틀.
            for( int k = 0; k < F07DeptAgeTitle_vt.size()-1; k++ ){
                F07DeptPositionClassAgeTitleData titleData = (F07DeptPositionClassAgeTitleData)F07DeptAgeTitle_vt.get(k);
%>
...
<%
            ...
            int noteSize = F07DeptAgeTitle_vt.size();
            //내용.
            for( int i = 0; i < F07DeptAgeNote_vt.size(); i++ ){
                F07DeptPositionClassAgeNoteData data = (F07DeptPositionClassAgeNoteData)F07DeptAgeNote_vt.get(i);
%>
