  ...
  <tr>
    ...
    <td colspan="15">
      <table width="100%" border="0" cellspacing="0" cellpadding="0" align="center">
        <tr >
          <td colspan="15" class="title02">* <!-- 월간 근태 집계표 --><%=g.getMessage("LABEL.F.F42.0051")%></td>
        </tr>
  ...
  <tr>
    ...
    <td colspan="2" valign="top">
      <table border="1" cellpadding="0" cellspacing="1" class="table02">
        <tr>
          <td width="60" rowspan="3" class="td03"><!-- 성명--><%=g.getMessage("LABEL.F.F42.0003")%></td>
          ...
          <td width="60" rowspan="3" class="td03"><!-- 잔여보상--><%=g.getMessage("LABEL.F.F42.0087")%><br/><!-- 휴가--><%=g.getMessage("LABEL.F.F42.0011")%></td>
        ...
        <tr>
          <td width="50" class="td03"><!-- 연차--><%=g.getMessage("LABEL.F.F41.0011")%></td>
          <td width="50" class="td03"><!-- 보상--><%=g.getMessage("LABEL.F.F42.0088")%><br/><!-- 휴가--><%=g.getMessage("LABEL.F.F42.0011")%></td>
          ...
          <td colspan="35">
            <table border="1" cellspacing="1" cellpadding="0" class="table01">
              ...
              <tr>
                ...
                <td colspan="7" class="td09"><!-- 휴일특근, 토요특근, 명절특근, 명절특근(토), <br>
              ...
              <tr>
                ...
                <td colspan="7" class="td09"><!-- 반일휴가(전반/후반), 토요휴가, 전일휴가, 보상휴가,<br>
