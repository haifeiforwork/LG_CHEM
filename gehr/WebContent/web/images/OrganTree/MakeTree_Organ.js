...
{ //constructor
  ...
  //dynamic data
  this.isOpen = true;
  this.openIconSrc = "/web/images/OrganTree/ftv2folderOpen.gif";
  this.openClickedIconSrc = "/web/images/OrganTree/ftv2folderClickedOpen.gif";

  this.closeIconSrc = "/web/images/OrganTree/ftv2folderClosed.gif";
  this.closeClickedIconSrc = "/web/images/OrganTree/ftv2folderClickedOpen.gif";
  
  this.docIconSrc = "/web/images/OrganTree/ftv2document.gif";
  this.docClickedIconSrc = "/web/images/OrganTree/ftv2documentClicked.gif";
	...
	if (folder.isOpen) {
		if (folder.nodeImg){
			if (folder.isLastNode) {
				folder.nodeImg.src = "/web/images/OrganTree/ftv2mlastnode.gif";
			} else {
				folder.nodeImg.src = "/web/images/OrganTree/ftv2mnode.gif";
			}// end if
		} // end if
		...
		if (folder.nodeImg) {
			if (folder.isLastNode) {
				if(folder.nChildren == 0) {
					folder.nodeImg.src = "/web/images/OrganTree/ftv2lastnode.gif";
				} else {
					folder.nodeImg.src = "/web/images/OrganTree/ftv2plastnode.gif";
				} // end if
			} else {
				if(folder.nChildren == 0) {
					folder.nodeImg.src = "/web/images/OrganTree/ftv2node.gif";
				} else {
					folder.nodeImg.src = "/web/images/OrganTree/ftv2pnode.gif";
				} // end if
			} // end if
		} // end if
...
//alert(lastNode);
	...
	if (level>0) {
		if (lastNode) { //the last 'brother' in the children array
			this.renderOb(leftSide + auxEv + "<img name='nodeIcon" + this.id + "' src='/web/images/OrganTree/ftv2mlastnode.gif' width=16 height=22 border=0></a>")
			leftSide = leftSide + "<img src='/web/images/OrganTree/ftv2blank.gif' width=16 height=22>"
			this.isLastNode = 1
		} else {
			this.renderOb(leftSide + auxEv + "<img name='nodeIcon" + this.id + "' src='/web/images/OrganTree/ftv2mnode.gif' width=16 height=22 border=0></a>")
			leftSide = leftSide + "<img src='/web/images/OrganTree/ftv2vertline.gif' width=16 height=22>"
			this.isLastNode = 0
		} // end if
	} else {
		this.renderOb("")
...
function setLink( id , folderId ) {
	var pre = document.formHidden.inputFolder.value
 	if ( pre != -1 ) {
 		...
 		preFolder.iconImg.src = "/web/images/OrganTree/ftv2folderopen.gif"
 		preFolder.clicked = 0
 	}
    clickedFolder = indexOfEntries[folderId]
    clickedFolder.iconImg.src = "/web/images/OrganTree/ftv2folderopen1.gif"
