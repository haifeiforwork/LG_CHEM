    ...
    Monthpicker.prototype = {
        ...
        init: function(options) {
            ...
            this.$dialog = $([
                '<div class="mp-dialog">',
                    '<div class="mp-title">',
                        '<i class="mp-year-prev mPrev"></i>',
                        ' <span><b></b></span> ',
                        '<i class="mp-year-next mNext"></i>',
                    '</div>',
        ...
        updateViews: function(e) {
            ...
            if (e) {
                if (this.year === e.year) {
                	this.$content.find('li:eq(' + e.month + ')').addClass('mp-now');
        ...
        hide: function(event) {
            if(!$(event.target).closest('.mp-monthpicker').length && !$(event.target).is('.mp-monthpicker')&& !$(event.target).is('IMG')) {
