...
/*   Program Name : 식권/영업사원 식대 결재 진행중/취소                         */
/*   Program ID   : G044ApprovalIngMealCharge.jsp                               */
/*   Description  : 식권/영업사원 식대 결재 진행중/취소                         */
/*   Note         : 없음                                                        */
            ...
            <td><table width="780" border="0" cellpadding="0" cellspacing="0">
                ...
                <tr> 
                  <td width="624" class="title02">
                    <img src="<%= WebUtil.ImageURL %>ehr/title01.gif"> 식권/영업 사원식대 결재진행 중 문서 
                  </td>
                        ...
                        <td> 
                          ...
                          <table width="100%" border="0" cellpadding="0" cellspacing="1">
                            ...
                            <tr> 
                              ...
                              <td class="td09"><%="X".equals(mealChargeData.APLY_FLAG)  ? "정기" : "수시"%></td>
                            </tr>
                            <tr> 
