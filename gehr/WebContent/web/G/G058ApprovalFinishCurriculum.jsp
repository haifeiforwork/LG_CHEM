...
/*   Program Name : 교육 결재 완료                                              */
/*   Program ID   : G058ApprovalFinishCurriculum.jsp                            */
/*   Description  : 교육 결재 완료                                              */
/*   Note         : 없음                                                        */
...
<%
    ...
    if (appLineData.APPL_APPU_TYPE.equals(docinfo.getAPPU_TYPE()) && 
            ...
            "A".equals(appLineData.APPL_APPR_STAT) && !"X".equals(c02CurriApplData.EDU_CANC)) {
        isCanCancel = true;
    } else {
        isCanCancel = false;
    } // end if
            ...
            <td><table width="780" border="0" cellpadding="0" cellspacing="0">
                ...
                <tr> 
                  <td width="624" class="title02">
                    <img src="<%= WebUtil.ImageURL %>ehr/title01.gif"> 교육 신청 결재완료 문서 
                  </td>
                ...
                <tr> 
                  ...
                  <td class="td02">
                    <a href="javascript:detail('<%=c02CurriApplData.GWAID%>' ,'<%=c02CurriApplData.CHAID%>','<%=c02CurriInfoData.LERN_CODE%>' )">
                        <img src="<%= WebUtil.ImageURL %>btn_course.gif" border="0" alt="<%=c02CurriApplData.GWAID%>" ></a> 
                    </a>
                  </td>
                  <!--과정정보 버튼 끝-->
              </table>
