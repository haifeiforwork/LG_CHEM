...
/*   Program Name : 입학 축하금 결재 진행중/취소                                */
/*   Program ID   : G013ApprovalIngEntrance.jsp                                 */
/*   Description  : 입학 축하금 결재 진행중/취소                                */
/*   Note         : 없음                                                        */
...
//  통화키에 따른 소수자리수를 가져온다
    ...
    // 현재 결재자 구분
    DocumentInfo docinfo = new DocumentInfo(e21EntranceData.AINF_SEQN ,user.empNo);
