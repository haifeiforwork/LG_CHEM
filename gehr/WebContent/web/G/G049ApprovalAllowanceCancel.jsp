...
/*   Program Name : 가족수당 상실 결재                                          */
/*   Program ID   : G049ApprovalAllowanceCancel.jsp                             */
/*   Description  : 가족수당 상실 결재                                          */
/*   Note         : 없음                                                        */
            ...
            <td><table width="780" border="0" cellpadding="0" cellspacing="0">
                ...
                <tr> 
                  <td width="624" class="title02">
                    <img src="<%= WebUtil.ImageURL %>ehr/title01.gif"> 가족수당 상실 결재해야 할 문서 
                  </td>
                        ...
                        <td>
			              ...
			              <table width="780" border="0" cellpadding="0" cellspacing="" class="table03">
			                <tr> 
			                  ...
			                  <td class="td09">
			                  <% if (approvalStep == DocumentInfo.DUTY_CHARGER) { %>
                                <input type="text" name="APPL_DATE" size="10" maxlength="10" class="input03" value = "<%=WebUtil.printDate(a12FamilyBuyangData.LOSS_DATE)%>"onBlur="dateFormat(this);">
