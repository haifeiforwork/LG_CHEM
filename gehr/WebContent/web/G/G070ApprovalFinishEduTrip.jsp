...
/*   Program Name : 교육/출장 결재 완료                                         */
/*   Program ID   : G070ApprovalFinishEduTrip.jsp                               */
/*   Description  : 교육/출장 결재 완료                                         */
/*   Note         : 없음                                                        */
            ...
            <td><table width="780" border="0" cellpadding="0" cellspacing="0">
                ...
                <tr> 
                  <td width="624" class="title02">
                    <img src="<%= WebUtil.ImageURL %>ehr/title01.gif"> 교육/출장 결재완료  문서 
                  </td>
          ...
          <tr> 
            <td> 
              ...
              <table width="780" border="0" cellspacing="1" cellpadding="5" class="table02">
                <tr> 
                  <td class="tr01">                  <table width="730" border="0" cellspacing="1" cellpadding="2">
                    <tr>
