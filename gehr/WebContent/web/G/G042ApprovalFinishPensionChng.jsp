...
/*   Program Name : 국민연금 자격 변경 결재 완료                                */
/*   Program ID   : G042ApprovalFinishPensionChng.jsp                           */
/*   Description  : 국민연금 자격 변경 결재 완료                                */
/*   Note         : 없음                                                        */
            ...
            <td><table width="780" border="0" cellpadding="0" cellspacing="0">
                ...
                <tr> 
                  <td width="624" class="title02">
                    <img src="<%= WebUtil.ImageURL %>ehr/title01.gif"> 국민연금 자격변경 결재완료
                  </td>
                  ...
                  <td class="tr01"><table width="100%" border="0" cellspacing="0" cellpadding="0">
                      ...
                      <tr> 
                        <td><table width="100%" border="0" cellpadding="0" cellspacing="1">
                            ...
                            <tr> 
                              <td class="td01" width="100">변경전 Data <font color="#006699">*</font></td>
