...
/*   Program Name : 가족수당 상실 결재 진행중/취소                              */
/*   Program ID   : G050ApprovalIngAllowanceCancel.jsp                          */
/*   Description  : 가족수당 상실 결재 진행중/취소                              */
/*   Note         : 없음                                                        */
            ...
            <td><table width="780" border="0" cellpadding="0" cellspacing="0">
                ...
                <tr> 
                  <td width="624" class="title02">
                    <img src="<%= WebUtil.ImageURL %>ehr/title01.gif"> 가족수당 상실 결재잰행 중 문서 
                  </td>
