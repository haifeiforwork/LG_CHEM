...
/*   Program Name : 건강보험 피 부양자 결재 완료                                */
/*   Program ID   : G038ApprovalFinishMedicare.jsp                              */
/*   Description  : 건강보험 피 부양자 결재 완료                                */
/*   Note         : 없음                                                        */
            ...
            <td><table width="780" border="0" cellpadding="0" cellspacing="0">
                ...
                <tr> 
                  <td width="624" class="title02">
                    <img src="<%= WebUtil.ImageURL %>ehr/title01.gif"> 건강보험 피부양자  결재완료 문서 
                  </td>
                      ...
                      <tr> 
                        <td><table width="100%" border="0" cellspacing="1" cellpadding="0" class="table02">
                            <tr> 
                              ...
                              <td width="70" class="td03" >대상자<br>성명</td>
                              <td width="50" class="td03" >관계</td>
