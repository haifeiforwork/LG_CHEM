...
/*   2Depth Name  :                                                             */
/*   Program Name : 초과근무 결재 취소 결재                                                   */
/*   Program ID   : G084ApprovalOTCancel.jsp                              */
/*   Description  : 초과근무 결재 취소 결재                          */
/*   Note         : 없음                                                        */
      ...
      <td>
      	<table width="780" border="0" cellspacing="0" cellpadding="0">
      		<tr> 
         		...
         		<tr> 
           		<td class="title02"><img src="<%= WebUtil.ImageURL %>ehr/title01.gif"> 초과근무 결재취소 결재해야 할 문서</td>
		  	</tr>
