...
/*   Description  : 휴가 결재완료 조회를 위한 jsp 파일                          */
/*   Note         : 없음                                                        */
/*   Creation     : 2005-03-10 유용원                                           */
/*   Update       :                                                             */
/*                  2008-03-14  CSR ID:1225704 경조선택시 경조내역조회팝업추가  */
/*                : 2013-09-10 결재취소버튼   @v1.0                             */
/*                : 2013-11-22 대산사업장 원근무자(대근시)추가 @v2.0            */
/*                                                                              */
/********************************************************************************/%>
...
<%
    ...
    vt = chkRfc.get(data.PERNR, data.AINF_SEQN);
...
<!--
    ...
    function appCancel(){
    	//팝업띄우기
    	window.open("<%= WebUtil.ServletURL %>hris.D.D03Vocation.D03VocationCancelBuildSV?AINF_SEQN=<%=data.AINF_SEQN%>",
    			"결재취소요청","toolbar=no,location=no,directories=no,status=no,menubar=no,resizable=no,scrollbars=yes,width=1124,height=675,left=100,top=10");
    }
            ...
            <td><table width="780" border="0" cellpadding="0" cellspacing="0">
                ...
                <tr> 
                  <td width="624" class="title02">
                    <img src="<%= WebUtil.ImageURL %>ehr/title01.gif"> 휴가 신청 결재완료 문서 
                  </td>
