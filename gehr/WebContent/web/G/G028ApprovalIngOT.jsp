...
/*   Program Name : 초과 근무 신청 결재 진행중/취소                             */
/*   Program ID   : G028ApprovalIngOT.jsp                                       */
/*   Description  : 초과 근무 신청 결재 진행중/취소                             */
/*   Note         :                                                             */
/*   Creation     : 2005-03-28  윤정현                                          */
/*   Update       :                                                             */
...
<%
    ...
    // 현재 결재자 구분
    DocumentInfo docinfo = new DocumentInfo(d01OTData.AINF_SEQN ,user.empNo);
...
<input type="hidden" name="approvalStep" value="<%=approvalStep%>">
            ...
            <td><table width="780" border="0" cellpadding="0" cellspacing="0">
                ...
                <tr>
                  <td width="624" class="title02">
                    <img src="<%= WebUtil.ImageURL %>ehr/title01.gif"> 초과근무 결재진행 중 문서
                  </td>
 ...
 <!-- [CSR ID:2803878] 초과근무 신청 화면 수정 -->
                        ...
                        <table border="0" cellspacing="1" cellpadding="5" class="table01">
                            ...
                            <tr>
                              <td class="td01" width="95">초과근무일&nbsp;</td>
                              <td class="td09">
