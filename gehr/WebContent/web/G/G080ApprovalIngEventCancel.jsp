...
/*   Program Name : 교육취소신청 결재 진행중/취소                                */
/*   Program ID   : G080ApprovalIngEventCancel.jsp                               */
/*   Description  : 교육취소신청 결재 진행중/취소                               */
/*   Note         : 없음                                                        */
...
<!--
    ...
    function f_detail_view_in(hrdobjid, objid ) {
        ...
        vObj.action="<%=WebUtil.JspURL%>G/G080Encrypt.jsp";
            ...
            <td><table width="780" border="0" cellpadding="0" cellspacing="0">
                ...
                <tr> 
                  <td width="624" class="title02">
                    <img src="<%= WebUtil.ImageURL %>ehr/title01.gif"> 교육 취소 신청 결재진행 중 문서 
                  </td>
