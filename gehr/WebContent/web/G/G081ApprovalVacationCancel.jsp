      ...
      <td>
      	<table width="780" border="0" cellspacing="0" cellpadding="0">
      		<tr> 
         		...
         		<tr> 
           		<td class="title02"><img src="<%= WebUtil.ImageURL %>ehr/title01.gif"> 휴가 결재취소 결재해야 할 문서</td>
         		</tr>
	        <tr>
	        	<td>
...
<% } %> 
       ...
       <% 
		...
		<% } // end if %>
		 ...
		 <tr><td class="font01" style="padding-bottom:2px"> <img src="<%= WebUtil.ImageURL %>ehr/icon_o.gif"> 결재정보</td></tr>
		 <tr> 
             <td>
               <!--결재정보 테이블 시작-->
