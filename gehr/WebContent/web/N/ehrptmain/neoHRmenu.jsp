...
<h2><a href="" target = "menuContentIframe"><span>hr</span></a></h2>
<table width="<%=Menu.masterTableWidth%>"  border="0" cellspacing="0" cellpadding="0">
  <tr>
    <td>
        <table width="<%=Menu.masterTableWidth%>" border="0" cellspacing="0" cellpadding="0">
            <tr><td class="lMenu_1st" colspan="2" background="/web/images/leftMenu/LMT01.GIF" clickedimg="/web/images/NULL"><b><font color="#585858">개발 테스트</font></b></td></tr>
            <tr><td width="0"></td>
                <td>
                    <table width="215" cellspacing="0" cellpadding="0">
                        <tbody>
                            ...
                            <tr>
                                <td background="/web/images/leftMenu/lb03.gif" clickedimg="/web/images/lb04.gif">
                                    <a href="<%= WebUtil.JspURL %>D07TimeSheet/D07TimeSheetFrame.jsp" target="menuContentIframe"><span class="lMenu_4th" id="menu4">TimeSheet</span></a>
                                </td>
                            </tr>
                        </tbody>
                    </table>
...
<%} %>
            ...
            <!-- eunha 임시수정 start-->
            <tr><td colspan="2" id="" class="lmSitemap"><a href="<%= WebUtil.JspURL%>D/D00ConductFrame.jsp" target="menuContentIframe" >근태실적조회및신청(ESS)</a></td></tr>
             <!-- eunha 임시수정 end-->
        </table>
    </td>
  </tr>
