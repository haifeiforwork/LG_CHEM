...
<%
 	...
 	/*----- Excel 파일 저장하기 --------------------------------------------------- */
	response.setHeader("Content-Disposition","attachment;filename=LocalForeign.xls");
	...
	<tr>
		...
		<td>
				<table width="880">
					...
					<tr>
						<td height="30" colspan="15" align="center"  class="excelTitle"><h3>■ <%=g.getMessage("COMMON.MENU.MSS_TALE_FORE")%>  </h3></td>
					</tr>
					<tr>
						<td height="20" colspan="15" style="text-align: left" ><b><spring:message code="LABEL.N.N02.0014" /><!-- 지역 -->: <font color="#4169E1"><%=selectRegTxt %></font> <spring:message code="LABEL.N.N02.0015" /><!-- 국가 --> : <font color="#4169E1"><%=searchNation %></font></b></td>
					</tr>
						<tr>
						<td height="10" colspan="15" class=""><h5><spring:message code="LABEL.N.N02.0004" /><!-- 부서명 -->: <%=deptNm %></h5></td>
					</tr>
