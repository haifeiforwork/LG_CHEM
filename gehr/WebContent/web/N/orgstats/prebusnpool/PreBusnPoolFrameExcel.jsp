...
<%
	...
	String hName= g.getMessage("MSG.N.N02.0012"); //- 사업가 후보
	String tTab ="";
	String command = request.getParameter("command");
	if(command.equals("0011")){
		hName= g.getMessage("MSG.N.N02.0010"); //- 차세대
		tTab = "2";
	}else if(command.equals("0001")){
		hName= g.getMessage("MSG.N.N02.0011"); //- HPI
		tTab = "3";
	}
	...
	Vector VT1 = (Vector)qlHM.get("T_EXPORT"+tTab);
	...
	<tr>
		...
		<td>
				<table width="880">
					...
					<tr>
						<td height="25" colspan="10" align="center" class="excelTitle"><h3>■ <%=sMenuText %><%=hName %></h3></td>
					</tr>

				</table>
				<table width="880">
					<tr>
						<td height="20" colspan="10" style="text-align: left" ><b><spring:message code="LABEL.N.N02.0053" /><!-- 조회년도 -->: <font color="#4169E1"><%=searchYear %></font></b></td>
					</tr>
					<tr>
				...
				<table class="tb_def" summary="" width="880">
