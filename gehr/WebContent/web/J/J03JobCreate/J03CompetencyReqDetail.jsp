  ...
  <tr>
    ...
    <td width=746 valign=top>
      <table cellpadding=0 cellspacing=0 border=0 width=746>    
        <tr>
          <td colspan=11 class=subt01><img src="<%= WebUtil.ImageURL %>jms/bullet_Dround.gif" align=absmiddle>Competency Requirement 조회</td>
        </tr>
...
%>
        <tr height=30 valign=bottom>
          <td colspan=11 align=center>
            <a href="javascript:goChange('<%= i_sobid %>','2');"><img src="<%= WebUtil.ImageURL %>jms/btn_modify.gif" border=0 hspace=5 alt="수 정"></a>
          </td>
        </tr>
