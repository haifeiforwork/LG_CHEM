  ...
  <tr>
    ...
    <td width=746 valign=top align=center>
      <table cellpadding=0 cellspacing=0 border=0 width=746>
        <tr height=26>
          <td colspan=3 class=subt01><img src="<%= WebUtil.ImageURL %>jms/bullet_Dround.gif" align=absmiddle>Job Leveling Sheet 조회</td>
        </tr>
...
%>
        ...
        <tr height=30 valign=bottom>
          <td colspan=13 align=center>
            <a href="javascript:goChange('<%= i_sobid %>','5');"><img src="<%= WebUtil.ImageURL %>jms/btn_modify.gif" border=0 hspace=5 alt="수 정"></a>
<%
    if( backFromJSP != null && backFromJSP.equals("JobProfile") ) {
%>
            <a href="javascript:goChange('<%= i_sobid %>', '1');"><img src="<%= WebUtil.ImageURL %>jms/btn_goback.gif" border=0 hspace=5 alt="이동"></a>
<%
    }
%>
          </td>
