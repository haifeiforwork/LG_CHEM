...
function doSearch(gubun,find1,find2) {
    ...
    if ( gubun == "1" ) {
      document.form1.action      = "<%= WebUtil.ServletURL %>hris.J.J02CompetencyList.J02CompetencyListSV";
    } else if ( gubun == "2" ) {    
...
<body bgcolor="#FFFFFF" text="#000000" leftmargin="18" topmargin="5" rightmargin="0" bottommargin="0" marginwidth="0" marginheight="0">
  ...
  <tr>
    <td bgcolor=#ffffff>
      <table cellspacing=0 cellpadding=0 border=0 width=100%>
        <tr>
          <td class="title01"><img src="<%= WebUtil.ImageURL %>ehr/title01.gif">&nbsp;Competency List</td>
          <td class="titleRight"><a href="javascript:open_help('J02CompetencyList.html');" onMouseOut="MM_swapImgRestore()" onMouseOver="MM_swapImage('Image6','','<%= WebUtil.ImageURL %>btn_help_on.gif',1)"></a></td>
          <td align=right></td>
        </tr>
      </table>
    </td>
...
<map name="Map">
  ...
  <area shape="circle" coords="371,29,10" href="javascript:doSearch('1','하','힝');" alt="ㅎ">
  ...
  <area shape="rect" coords="450,47,464,65" href="javascript:doSearch('1','Z','가');" alt="Z">
</map>
