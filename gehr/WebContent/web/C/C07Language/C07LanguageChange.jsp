...
function set_CMPY_WONX(obj){
  ...
  var stud_type = document.form1.STUD_TYPE.value;
...
<div class="subWrapper">
    ...
    <div class="title"><h1>어학지원 신청 수정</h1></div>
        ...
        <div class="table">
            <table class='tableGeneral'>
                ...
                <tr>
                    ...
                    <td>
                        <input type="text" name="SBEG_DATE" value="<%= WebUtil.printDate(data.SBEG_DATE,".") %>" size="20" onBlur="dateFormat(this);">
                    ...
                    <td>
                        <input type="text" name="SEND_DATE" value="<%= WebUtil.printDate(data.SEND_DATE,".") %>" size="20" onBlur="dateFormat(this);">
                ...
                <tr>
                    ...
                    <td>
                        <select name="STUD_TYPE">
                            <option value="">-----------------</option>
    <%= WebUtil.printOption((new C07StudTypeRFC()).getDetail(), data.STUD_TYPE) %>
                        </select>
                    </td>
                    <th class="th02">수강시간</th>
                    <td>
                        <input type="text" name="LECT_TIME" value="<%= WebUtil.printNumFormat(data.LECT_TIME).equals("0") ? "" : WebUtil.printNumFormat(data.LECT_TIME) %>" size="20" maxlength="6" onKeyUp="javascript:moneyChkEventForWon(this);" style="text-align:right">
                    </td>
                </tr>
                <tr>
                    <th><span class="textPink">*</span>학습기관</th>
                    <td colspan="3">
                        <input type="text" name="STUD_INST" value="<%= data.STUD_INST %>" size="50" maxlength="40">
                    </td>
                </tr>
                <tr>
                    <th><span class="textPink">*</span>수강과목</th>
                    <td colspan="3">
                        <input type="text" name="LECT_SBJT" value="<%= data.LECT_SBJT %>" size="50" maxlength="50">
                    </td>
                </tr>
                <tr>
                    <th><span class="textPink">*</span>결제금액</th>
                    <td>
                        <input type="text" name="SETL_WONX" value="<%= WebUtil.printNumFormat(data.SETL_WONX) %>" size="20" onKeyUp="javascript:moneyChkEventForWon(this);" onBlur="javascript:set_CMPY_WONX(this);" style="text-align:right">
                    </td>
                    <th class="th02"><span class="textPink">*</span>결제일</th>
                    <td>
                        <input type="text" name="SELT_DATE" value="<%= WebUtil.printDate(data.SELT_DATE,".") %>" size="20" onBlur="dateFormat(this);">
                ...
                <tr>
                    <th>카드번호</th>
                    <td colspan="3">
                        <input type="text" name="CARD_NUMB" value="<%= data.CARD_NUMB %>" size="20" maxlength="16" onKeyUp="javascript:isNum(this);">
                    </td>
                </tr>
                <tr>
                    <th>카드회사</th>
                    <td colspan="3">
                        <input type="text" name="CARD_CMPY" value="<%= data.CARD_CMPY %>" size="50" maxlength="30">
                    </td>
                </tr>
                <tr>
                    <th>회사지원금액</th>
