...
/*String ename = "이지은";
    ...
    ret = ( new A10AnnualOathAgreementRFC() ).getAnnualAgreeYn( user.empNo ,"1",data.ZYEAR ,user.companyCode );
        ...
        <tr>
          <td>
            <table width="550" border="0" cellspacing="0" cellpadding="2" align="center">
              ...
              <tr  >
                <td colspan="2" class="style01">본인은 재직 기간 중 본 서약서 내용을 준수하며, 위반 시 집행임원 인사관리 규정에 의한 징계 및 민/형사상 책임을 감수한다. 
				</td>
              </tr>
            </table>
          </td>
              ...
              <tr>
                ...
                <td align="center" > 
                  <table width="350" border="0" cellspacing="5" cellpadding="5" align="right">
                    <tr>
                      <td align="right" width="350" class="style01" colspan="3">2016년 4월 1일</td>
                    </tr>
                    <tr>
