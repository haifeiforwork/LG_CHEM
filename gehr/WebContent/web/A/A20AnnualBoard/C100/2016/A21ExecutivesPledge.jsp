...
<title>ESS</title>
<link rel="stylesheet" href="/web/A/A20AnnualBoard/C100/2016/ess.css" type="text/css">
...
<%
 if (empNo.equals("00037916")||empNo.equals("00037466")||empNo.equals("00116534")
...
<%if(empNo.equals("00219561")){//하드코딩 해당 인원만 년월일 금액 고정으로 감. %>
                      <td align="right" width="350" class="style01" colspan="3"><%=ZYEAR %>년 3월 1일</td>
<%}else if(empNo.equals("00218574")){%>
						<td align="right" width="350" class="style01" colspan="3"><%=ZYEAR %>년 1월 1일</td>
<%}else{ %>
...
<%} %>
                    ...
                    <tr>
                      ...
                      <td align="left" width="150" class="style01">&nbsp;<%= ename %>&nbsp;&nbsp;&nbsp;(서명)</td>
                     <%       if ( AGRE_FLAG.equals("Y") ) {  %>
                      <td align="center" rowspan="2"><img src="<%= WebUtil.ImageURL %>btn_pledgeYes.gif" border="0">
                      </td>
<%       }  %>
                    </tr>
                        <!-- @< %= data.ORGTX %><br> -->
                      ...
                      <tr>
                          <td align="center">
                              <div class="buttonArea">
                                  <ul class="btn_crud">
                                      <li><a href="javascript:;" onclick="f_agree();"><span><spring:message code="BUTTON.COMMON.CONFIRM" /><%--확인--%></span></a></li>
                                  </ul>
                              </div>
                          </td>
                      </tr>
