...
<%
    ...
    double BETRG=0.0;//기본급
    double BET01=0.0;//역할급
    double ANSAL=0.0;//합계
    
    if ( AGRE_FLAG.equals("Y") ) { ////@@@@@ 개발 필요!!!  
...
<body onLoad=" if ('<%=msg%>' != '' &&  '<%=msg%>' != 'null' ) alert('<%=msg%>');" bgcolor="#FFFFFF" text="#000000" leftmargin="0" topmargin="0" marginwidth="0" marginheight="0" oncontextmenu="return false" ondragstart="return false" onselectstart="return false" onKeyUp="ClipBoardClear()"><!-- 20151110 담당님 지시사항 보안조치 강화 -->
          ...
          <td>
            <table width="560" border="0" cellspacing="0" cellpadding="2" align="center">
              ...
              <tr>
                ...
                <td class="style01">	고정연봉(기본연봉+역할급)은 <font style="background-color: #CCCCCC"><i><b>\<%=WebUtil.printNumFormat(ANSAL) %>원(\<%=WebUtil.printNumFormat((Math.ceil(ANSAL/12)/1000)*1000) %>원/月)</b></i></font>으로 한다.</td>
              </tr>                                                             
              <tr>
                <td class="style01" valign=top>②</td>
...
<%} %> 
                <td align="left" > 
                  <table width="300" border="0" cellspacing="5" cellpadding="5" align="right">
                    ...
                    <tr>
                    <td colspan="2" class="style01">&nbsp;직책 : <%= data.TITL2 %></td>
