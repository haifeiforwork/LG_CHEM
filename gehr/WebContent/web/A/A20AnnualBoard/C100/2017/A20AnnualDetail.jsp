...
<%
    ...
    if (empNo.equals("00217646")||empNo.equals("00080644")||empNo.equals("00221313")){
    ...
    if (data.TITL3.equals("중앙연구소.미래기술연구센터 수석연구위원")) data.TITL3 = "중앙연구소.미래기술연구센터<br> 수석연구위원";
    else if (data.TITL3.equals("자동차전지.개발센터장 겸 Cell개발담당")) data.TITL3 = "자동차전지.개발센터장 겸<br>Cell개발담당";
    else if (data.TITL3.equals("중앙연구소장 겸 미래기술연구센터장")) data.TITL3 = "중앙연구소장 겸<br> 미래기술연구센터장";
