        ...
        <div class="table">
            <table class="tableGeneral">
                ...
                <tr>
                    ...
                    <td > <input type="text" name="ENAME"  value="" size="20" readonly>
                    </td>
                ...
                <tr>
                    ...
                    <td > <input type="text" name="CNNAM"  value="" size="20" readonly>
                    </td>
            ...
            <c:choose>
                <c:when test="${PersonData.e_PERSG == 'A'}">
                    ...
                    <td> <input type="text" name="IDNUM"  value="" size="20" readonly></td>
                    <th><spring:message code="LABEL.A.A12.0041" /><!-- Entry Date --></th>
                    <td> <input type="text" name="ENTDT"  value="" size="20" readonly></td>
                </c:when>
                <c:otherwise>
                    <th><spring:message code="LABEL.A.A04.0010" /><!-- ID number --></th>
                    <td  colspan="3"> <input type="text" name="IDNUM"  value="" size="20" readonly></td>
                </c:otherwise>
            </c:choose>
            </table>
        </div>
