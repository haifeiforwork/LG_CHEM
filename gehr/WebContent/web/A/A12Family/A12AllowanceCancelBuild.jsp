...
/*   Program ID   : A12AllowanceCancelBuild.jsp                                 */
/*   Description  : 가족수당상실을 신청할 수 있도록 하는 화면                   */
/*   Note         :                                                             */
...
function doSubmit() {
  if( check_data() ) {
    ...
    document.form1.action = "<%= WebUtil.ServletURL %>hris.A.A12Family.A12AllowanceCancelBuildSV";
        ...
        <table width="780" border="0" cellspacing="0" cellpadding="0">
          <tr> 
            <td width="780"> <table width="780" border="0" cellpadding="0" cellspacing="0">
                ...
                <tr> 
                  <td class="font01" style="padding-bottom:2px"><img src="<%= WebUtil.ImageURL %>ehr/icon_o.gif">가족수당상실 
                    신청</td>
...
%>
                ...
                <tr> 
                  <td class="font01"> <table width="780" border="0" cellspacing="1" cellpadding="3" class="table02">
                      <tr> 
                        ...
                        <td class="td09" colspan="3"> <input type="text" name="LOSS_DATE" class="input03" size="20" onBlur="dateFormat(this);"> 
                          <a href="javascript:fn_openCal('LOSS_DATE')"> <img src="<%= WebUtil.ImageURL %>btn_serch.gif" align="absmiddle" border="0" alt="날짜검색"></a> 
                        </td>
                      </tr>
                    </table></td>
                </tr>
          ...
          <tr> 
            <td class="td09"> <font color="#006699"><b>&nbsp;&nbsp;*</b> 는 필수 
              입력사항입니다.</font> </td>
          </tr>
          <tr> 
            <td class="font01">&nbsp;</td>
