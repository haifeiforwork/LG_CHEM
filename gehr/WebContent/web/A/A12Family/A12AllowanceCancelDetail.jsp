...
/*   Program ID   : A12AllowanceCancelDetail.jsp                                */
/*   Description  : 가족수당상실 신청을 조회할 수 있도록 하는 화면              */
/*   Note         :                                                             */
...
function do_delete(){
	if( chk_APPR_STAT(1) && confirm("정말 삭제하시겠습니까?") ) {
		...
		document.form1.action = "<%= WebUtil.ServletURL %>hris.A.A12Family.A12AllowanceCancelDetailSV";
		document.form1.method = "post";
		document.form1.submit();
	}
}
        ...
        <table width="780" border="0" cellspacing="0" cellpadding="0">
          <tr>
            <td width="780"> <table width="780" border="0" cellpadding="0" cellspacing="0">
                ...
                <tr>
                  <td class="font01" style="padding-bottom:2px"><img src="<%= WebUtil.ImageURL %>ehr/icon_o.gif">가족수당상실 신청 조회</td>
              ...
              <table width="780" border="0" cellspacing="0" cellpadding="0">
                ...
                <tr>
                  <td class="font01"> <table width="780" border="0" cellspacing="1" cellpadding="3" class="table02">
                      <tr>
                        <td class="td01" width="100">상실일자</td>
                        <td class="td09" colspan="3">
                          <input type="text" name="LOSS_DATE" value="<%= data.LOSS_DATE.equals("0000-00-00") ? "" : WebUtil.printDate(data.LOSS_DATE) %>" class="input04" size="20" readonly>
                        </td>
                      </tr>
                    </table>
                  </td>
                ...
                <tr>
                  <td class="font01">위 가족에 대해 가족수당상실을 신청하였습니다.</td>
                </tr>
                <tr>
                  <td class="font01">&nbsp;</td>
                </tr>
              ...
              <table width="780" border="0" cellspacing="0" cellpadding="0">
                <tr>
                  <td align="center">
                    ...
                    <%  } // end if %>
                    <%  if (docinfo.isModefy()) { %>
                    <a href="javascript:do_change();"><img src="<%= WebUtil.ImageURL %>btn_change.gif" name="image" align="absmiddle" border="0"></a>
                    <a href="javascript:do_delete();"><img src="<%= WebUtil.ImageURL %>btn_delete.gif" name="image2" align="absmiddle" border="0"></a>
                    <%  } // end if %>
