...
/*   Program ID   : A12SupportCancelChange.jsp                                  */
        ...
        <table width="780" border="0" cellspacing="0" cellpadding="0">
          <tr>
            <td width="780"> <table width="780" border="0" cellpadding="0" cellspacing="0">
                ...
                <tr>
                  <td class="font01" style="padding-bottom:2px"><img src="<%= WebUtil.ImageURL %>ehr/icon_o.gif">부양가족 변경(해지) 신청 수정</td>
...
%>
                     &nbsp;<span style="visibility:show"><input type="text" name="CANC_ETCD" value="<%= data.CANC_ETCD %>" size="50" class="input03" onKeyUp="check_length(this,60)"></span>
<%
    }
%>
                   </td>
                 ...
                 <td class="td09">
                   <input type="text" name="CANC_DATE" value="<%= WebUtil.printDate(data.CANC_DATE, ".") %>" class="input03" size="20" onBlur="dateFormat(this);">
