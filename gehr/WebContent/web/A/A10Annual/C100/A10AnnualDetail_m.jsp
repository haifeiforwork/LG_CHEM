  ...
  <tr> 
    <td> 
      <table width="100%" border="0" cellspacing="0" cellpadding="0">
        <tr> 
          <td><img src="<%= imgURL %>img_logo_hwahak.gif" width="281" height="100"></td>
          <td align="right"><img src="<%= imgURL %>img_addr_hwahak.gif" width="295" height="100"></td>
        </tr>
      </table>
    </td>
  </tr>
      ...
      <table width="450" border="0" cellspacing="2" cellpadding="0">
            ...
            <table width="360" border="0" cellspacing="0" cellpadding="0" align="center">
              <tr> 
                <td class="style01">(주)LG화학과 <%= ename %>은(는) 信義와 誠實을 바탕으로<br>
                  <%= StringUtils.substring(data.BEGDA, 0, 4) %>年 <%= Integer.parseInt(data.BEGDA.substring(5,7)) %>月 <%= Integer.parseInt(StringUtils.substring(data.BEGDA, 8, 10)) %>日부터 
          ...
          <td>
            <table width="397" border="0" cellspacing="0" cellpadding="2" align="center">
              <tr> 
                ...
                <td class="style01">상기 基本年俸은 <%= StringUtils.substring(data.BEGDA, 0, 4) %>年 <%= Integer.parseInt(data.BEGDA.substring(5,7)) %>月 <%= Integer.parseInt(StringUtils.substring(data.BEGDA, 8, 10)) %>日부터 <%= StringUtils.substring(data.ENDDA, 0, 4) %>年 <%= Integer.parseInt(StringUtils.substring(data.ENDDA, 5, 7)) %>月 <%= Integer.parseInt(StringUtils.substring(data.ENDDA, 8, 10)) %>日까지</td>
              </tr>
              <tr> 
                <td class="style01">&nbsp;</td>
        ...
        <tr>
          <td>
            <table width="100%" border="0" cellspacing="0" cellpadding="0">
              <tr>
                <td width="249"><img src="<%= imgURL %>img_sign_hwahak.gif" width="249" height="82"></td>
                <td> 
                  <table width="100" border="0" cellspacing="0" cellpadding="0" align="right">
                    <tr> 
                      <td align="center" width="197" class="style01">(주)LG화학<br>
                        <%= data.ORGTX %><br>
                        <%= ename %> (印)</td>
                    </tr>
                  </table>
