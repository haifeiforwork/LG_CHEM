...
/*                  2017-01-07 이지은D [CSR ID:3268071] 사내표준 내 진급제도 파일 변경 요청의 件   */
...
/* 				 2018-03-29 cykim    [CSR ID:3645932] HR Portal > 진급자격요건 시뮬레이션 화면 內 사무기술직 진급제도 안내 링크 수정요청  */
/********************************************************************************/
%>
...
<form name="form1" method="post">
    ...
    /*user.e_trfar = "02";
    user.e_trfgr = "Ⅱ-1급";
    if (result.isSuccetss() && (user.e_trfar).equals("02") && ((user.e_trfgr).equals("Ⅱ-1급") || (user.e_trfgr).equals("Ⅱ-2급")
    ...
    */
    ...
    <div class="textDiv">
        ...
        <!-- [CSR ID:3268071]<a href="http://bssprod.lgchem.com/lightpack/lgccom/lgcComFileViewerView.do?fileIdParam=XT3FOOpnPWD4b0ToOpe1A" -->
        ...
        <!-- [CSR ID:3645932] HR Portal > 진급자격요건 시뮬레이션 화면 內 사무기술직 진급제도 안내 링크 수정요청 start -->
			<a href="http://165.244.240.220/ezpdf/customLayout.jsp?encdata=A93E52F12A02628A37981FD61D55CEC2AE08B3D4C22D3A73C59BD8EA38771606CCA1417290C0A679A3196A404ACB98C26900ABD09EFA4C8296842A8470A3EFA8654C2437FFBB1DCF8BD518173EC0099690ECE0CB5AE64A3C1E6392D2F618A2D6DD3DC35097250BFB34F087F3F9EDC0F95B00F5FD41B0997C" target="_new">
        <!-- [CSR ID:3645932] HR Portal > 진급자격요건 시뮬레이션 화면 內 사무기술직 진급제도 안내 링크 수정요청 end -->
    ...
    <div class="commentImportant textDiv">
        ...
        <table width="100%" border="0" cellspacing="0" cellpadding="0">
            ...
            <tr>
                <td nowrap="nowrap">
                    <input type="text" name="lang_name" style="text-align:right" value="<%= gijundata.LANG_NAME %>" readonly>
                    <input type="text" name="text001" size="1" value=":" readonly>
                </td>
                <td >
                    <input type="text" name="lang_amnt" size="13"
