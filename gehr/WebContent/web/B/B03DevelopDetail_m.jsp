...
/*   Program ID   : B03DevelopDetail_m.jsp                                      */
/*   Description  : 인재개발 협의결과 상세조회                                  */
/*   Note         : 없음                                                        */
...
function goDetail(){
    document.form2.jobid2.value = "detailD";
...
%>
                <tr>
                    <th>우수한점</th>
                    <td colspan="3"><%= developDetailData.EXL1_PONT %> <% if (developDetailData.EXL2_PONT != null) { %> <br> <%= developDetailData.EXL2_PONT %> <% } %> </td>
                </tr>
                <%
    }
%>
...
%>
                <tr>
                    <th>육성POST</th>
                    <td colspan="3"><%= developDetailData.UPBR_POST %></td>
                </tr>
                <%
    }
%>
                <tr>
                    <th>육성방향</th>
                    <td colspan="3"><%= developDetailData.UPB1_CRSE %> <% if (developDetailData.UPB2_CRSE != null) { %> <br> <%= developDetailData.UPB2_CRSE %> <% } %> </td>
                </tr>
                <tr>
                    <th>종합의견</th>
                    <td colspan="3"><%= developDetailData.CMT1_TEXT %> <% if (developDetailData.CMT2_TEXT != null){ %> <br> <%= developDetailData.CMT2_TEXT %> <%}%> <% if (developDetailData.CMT3_TEXT != null){ %> <br> <%= developDetailData.CMT3_TEXT %> <%}%> <% if (developDetailData.CMT4_TEXT != null){ %> <br> <%= developDetailData.CMT4_TEXT %> <%}%> <% if (developDetailData.CMT5_TEXT != null){ %> <br> <%= developDetailData.CMT5_TEXT %> <%}%> <% if (developDetailData.CMT6_TEXT != null){ %> <br> <%= developDetailData.CMT6_TEXT %> <%}%> </td>
                </tr>
                <tr>
                    <th>기타사항</th>
                    <td colspan="3"><%= developDetailData.ETC1_TEXT %> <% if (developDetailData.ETC2_TEXT != null) { %> <br> <%= developDetailData.ETC2_TEXT %> <% } %> </td>
                </tr>
                <tr>
                    <th>육성책 협의결과F/U</th>
                    <td colspan="3"><%= developDetailData.FUP1_TEXT %> <% if (developDetailData.FUP2_TEXT != null) { %> <br> <%= developDetailData.FUP2_TEXT %> <% } %> </td>
                </tr>
                <%-- if (user_m.companyCode.equals("N100")) { --%>
                <tr>
                    <th>위 원</th>
