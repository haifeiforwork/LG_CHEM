...
/**
 * B05JobProfileRFC.java
 * Job Profile 상세내역 등을 조회하는 RFC를 호출하는 Class
 *
 * @author 김도신
 * @version 1.0, 2003/02/12
 */
public class B05JobProfileRFC extends SAPWrap {
    ...
    private Vector getOutput(JCO.Function function) throws GeneralException {
        ...
        String entityName1 = "hris.B.B05JobProfile.B05JobProfileData";
        Vector P_RESULT    = getTable(entityName1, function, "P_RESULT");
        
        String entityName2 = "hris.B.B05JobProfile.B05JobProfileData";
        Vector P_RESULT_P  = getTable(entityName2, function, "P_RESULT_P");
        
        String entityName3 = "hris.B.B05JobProfile.B05JobProfileData";
