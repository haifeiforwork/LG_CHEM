...
/**
 * Created by manyjung on 2016-10-06.
 */
public class D15EmpPayData extends EntityData {

    public String 	YYYYMM	;//	O	NUMC	6	Month
    public String 	ENAME	;//		CHAR	40	Name
    public String 	LGTXT	;//		CHAR	25	Wage type name
    ...
    public String 	ZGUBUN	;//		CHAR	1	Payment/Deduction/dues Type
    ...
    public String 	ZQUIT	;//		CHAR	1	Single-Character Indicator
