 ...
 * 연말정산 - 기타/세액공제 신청/수정/조회 RFC를 호출하는 Class
 *
 * @author 김도신
...
public class D11TaxAdjustTaxRFC extends SAPWrap {
    ...
    /**
     * 연말정산 - 기타/세액공제 조회 RFC 호출하는 Method
    ...
    /**
     * 연말정산 - 기타/세액공제 조회, 신청 구분 FLAG를 조회
     *  @exception com.sns.jdf.GeneralException
     */
    ...
    /**
     * 연말정산 - 기타/세액공제 신청 RFC 호출하는 Method
     * @return java.util.Vector
     * @exception com.sns.jdf.GeneralException
     */ 
    ...
    /**
     * 연말정산 - 기타/세액공제 수정 RFC 호출하는 Method
     * @return java.util.Vector
     * @exception com.sns.jdf.GeneralException
     */
