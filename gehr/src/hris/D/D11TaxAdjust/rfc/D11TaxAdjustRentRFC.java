...
/**
 * D11TaxAdjustRentRFC.java
 * 연말정산 - 월세   조회 RFC를 호출하는 Class
 *
 * @author l sa
 * @version 1.0, 1.0, 2010/12/08
 */
public class D11TaxAdjustRentRFC extends SAPWrap {

    private String functionName = "ZSOLYR_RFC_YEAR_MONTHLY_RENT" ;
     ...
     */
    public Vector getRent( String empNo, String targetYear  ) throws GeneralException {
        ...
        try{
            ...
            for( int i = 0 ; i < ret.size() ; i++ ){
            	D11TaxAdjustRentData data = (D11TaxAdjustRentData)ret.get(i);
    ...
    public void build( String empNo, String targetYear, Vector person_vt ) throws GeneralException {
        ...
        try{
            ...
            for( int i = 0 ; i < person_vt.size() ; i++ ){
            	D11TaxAdjustRentData data = (D11TaxAdjustRentData)person_vt.get(i);
    ...
    private Vector getOutput(JCO.Function function) throws GeneralException {
        String entityName = "hris.D.D11TaxAdjust.D11TaxAdjustRentData";
