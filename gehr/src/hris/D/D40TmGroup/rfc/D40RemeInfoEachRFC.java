...
/**
 * D40RemeInfoEachRFC.java
 * 사원지급 정보(개별)
 *
 * @author  정준현
 * @version 1.0, 2017/12/08
 */
public class D40RemeInfoEachRFC extends SAPWrap {
	...
	private Vector getOutput(JCO.Function function) throws GeneralException {
    	...
    	Vector OBJPS_OUT1  = getTable(D40RemeInfoFrameData.class, function, "T_SCHKZ");		//계획근무 코드-텍스트
    	Vector OBJPS_OUT2  = getTable(D40RemeInfoFrameData.class, function, "T_EXLIST");	//조회된 정보
    	Vector OBJPS_OUT3  = getTable(D40RemeInfoFrameData.class, function, "T_REASON");	//근태사유 코드-텍스트
    	Vector OBJPS_OUT4  = getTable(D40RemeInfoFrameData.class, function, "T_WTMCODE");	//유형 코드-텍스트
    	...
    	ret.addElement(OBJPS_OUT5);	//유형 코드-텍스트
...
//            setTable(function, "T_IMPORTA", OBJID);
	...
	private Vector getOutput2(JCO.Function function) throws GeneralException {
    	...
    	Vector OBJPS_OUT1  = getTable(D40RemeInfoFrameData.class, function, "T_SCHKZ");	//계획근무
    	Vector OBJPS_OUT2  = getTable(D40RemeInfoFrameData.class, function, "T_EXLIST");	//조회된 정보
    	Vector OBJPS_OUT3  = getTable(D40RemeInfoFrameData.class, function, "T_REASON");	//근태사유
    	Vector OBJPS_OUT4  = getTable(D40RemeInfoFrameData.class, function, "T_WTMCODE");	//유형
    	Vector OBJPS_OUT5  = getTable(D40RemeInfoFrameData.class, function, "T_EXCEP");	//기타
    	Vector OBJPS_OUT6  = getTable(D40OverTime50OverWeekData.class, function, "T_50HOVER");	//[NTM] 주 50시간 초과자
    	...
    	ret.addElement(OBJPS_OUT6);	//[NTM] 주 50시간 초과자
