...
/**
 * D40RemeInfoLumpFrameRFC.java
 * 현장직근태-사원지급정보
 *
 * @author  정준현
 * @version 1.0, 2017/12/08
 */
public class D40RemeInfoLumpFrameRFC extends SAPWrap {

	private String functionName = "ZGHR_RFC_TM_PA2010";
	 /**
     * 사원지급정보(일괄) 조회
     * @return java.util.Vector
     * @exception com.sns.jdf.GeneralException
     */
	public Vector getRemeInfoLump(String empNo, String I_ACTTY, String I_SCHKZ, Vector T_IMPERS, String I_SELTAB, Vector OBJID) throws GeneralException {
	...
	private Vector getOutput(JCO.Function function) throws GeneralException {
        ...
        String entityName = "hris.D.D40TmGroup.D40RemeInfoFrameData";
        ...
        Vector OBJPS_OUT5	 = getTable(entityName, function, "T_EXCEP");	//기타
     ...
     * @exception com.sns.jdf.GeneralException
     */
	public Vector getRemeInfoLumpExcelDown(String empNo, String I_ACTTY,	String I_SELTAB, Vector OBJID) throws GeneralException {
		JCO.Client mConnection = null;
        try{
...
//            setTable(function, "T_IMPORTA", OBJID);
     ...
     * @exception com.sns.jdf.GeneralException
     */
	public Vector saveRow(String empNo, String I_ACTTY,	Vector<D40RemeInfoFrameData> excelResultList) throws GeneralException {
		JCO.Client mConnection = null;
        try {
            mConnection = getClient();
            JCO.Function function = createFunction(functionName) ;
            ...
            Vector T_EXLIST = getTable(D40RemeInfoFrameData.class, function, "T_EXLIST");
     ...
     * @exception com.sns.jdf.GeneralException
     */
	public Vector saveTable(String empNo, String I_ACTTY,	Vector<D40RemeInfoFrameData> excelResultList) throws GeneralException {
		JCO.Client mConnection = null;
        try {
            mConnection = getClient();
            JCO.Function function = createFunction(functionName) ;
	...
	private Vector getOutput2(JCO.Function function) throws GeneralException {
    	...
    	Vector OBJPS_OUT1  = getTable(D40RemeInfoFrameData.class, function, "T_EXLIST");		//조회된정보
//        Vector OBJPS_OUT2	 = getTable(D40RemeInfoFrameData.class, function, "T_SCHKZ");		//계획근무	코드-텍스트
        Vector OBJPS_OUT3	 = getTable(D40RemeInfoFrameData.class, function, "T_WTMCODE");	//임금유형	코드-텍스트
        Vector OBJPS_OUT4	 = getTable(D40RemeInfoFrameData.class, function, "T_REASON");		//근태사유	코드-텍스트
        Vector OBJPS_OUT5	 = getTable(D40RemeInfoFrameData.class, function, "T_EXCEP");	//기타
    	...
    	ret.addElement(E_SAVE_CNT);
    	ret.addElement(OBJPS_OUT1);	//조회된정보
    	ret.addElement(OBJPS_OUT3);	//임금유형	코드-텍스트
    	ret.addElement(OBJPS_OUT4);	//근태사유	코드-텍스트
    	ret.addElement(OBJPS_OUT5);	//기타
        return ret;
    }
	...
	private Vector getOutput3(JCO.Function function) throws GeneralException {
    	...
    	Vector OBJPS_OUT1  = getTable(D40RemeInfoFrameData.class, function, "T_EXLIST");	//조회된 정보
