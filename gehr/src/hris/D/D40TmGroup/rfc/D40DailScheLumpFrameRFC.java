...
/*   Program ID		: D40DailScheLumpFrameRFC.java									*/
 ...
 */
public class D40DailScheLumpFrameRFC extends SAPWrap {
...
//	private String functionName = "ZGHR_RFC_TM_TPROG";
     ...
     */
	public Vector getDailScheLump(String empNo, String I_ACTTY, String I_DATUM, String I_SCHKZ, Vector T_IMPERS, String I_SELTAB, Vector OBJID) throws GeneralException {
	...
	private Vector getOutput(JCO.Function function) throws GeneralException {
        ...
        String entityName = "hris.D.D40TmGroup.D40DailScheFrameData";
//        D40TmSchkzFrameData
        String tableName  = "T_TPROG_TM";
	...
	public Vector saveRow(String empNo, String I_ACTTY,	Vector<D40TmSchkzFrameData> excelResultList) throws GeneralException {
        ...
        try {
            ...
            excute(mConnection, function);
            Vector ret = new Vector();
            Vector T_EXLIST = getTable(D40DailScheFrameData.class, function, "T_EXLIST");
            String E_RETURN   = getReturn().MSGTY;
        	String E_MESSAGE   = getReturn().MSGTX;
     ...
     * @exception com.sns.jdf.GeneralException
     */
	public Vector saveTable(String empNo, String I_ACTTY,	Vector<D40DailScheFrameData> excelResultList) throws GeneralException {
		JCO.Client mConnection = null;
        try {
            mConnection = getClient();
            JCO.Function function = createFunction(functionName) ;
	...
	private Vector getOutput2(JCO.Function function) throws GeneralException {
    	...
    	Vector T_SCHKZ  = getTable(D40DailScheFrameData.class, function, "T_TPROG_TM");
    	Vector T_EXLIST = getTable(D40DailScheFrameData.class, function, "T_EXLIST");
     ...
     * @exception com.sns.jdf.GeneralException
     */
	public Vector getDailScheLumpExcelDown(String empNo, String I_ACTTY,	String I_SELTAB, Vector OBJID) throws GeneralException {
		JCO.Client mConnection = null;
        try{
