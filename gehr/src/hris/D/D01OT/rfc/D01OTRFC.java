...
/**
 * D01OTRFC.java
 * 초과근무 조회/신청/수정/삭제 RFC 를 호출하는 Class                        
 *
 * @author 박영락
 * @version 1.0, 2002/01/24
 */
@SuppressWarnings("rawtypes")
public class D01OTRFC extends ApprovalSAPWrap {

    private String functionName = "ZGHR_RFC_OVERTIME_WORK"; // ZHRP_RFC_OVERTIME_WORK

    public D01OTRFC() {}

    public D01OTRFC(String empNo, String I_APGUB, String AINF_SEQN) throws GeneralException {
