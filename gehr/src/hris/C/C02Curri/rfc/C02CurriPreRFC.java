...
/**
 * C02CurriPreRFC.java
 * 선이수 과정내용을 가져오는 RFC를 호출하는 Class
 *
 * @author 박영락   
 * @version 1.0, 2002/01/16
 */
public class C02CurriPreRFC extends SAPWrap {

    private String functionName = "ZHRE_RFC_PREVIOUS_EVENT";

    /**
     * 세부 교육과정 내용를 가져오는 RFC를 호출하는 Method
     * @param java.lang.String 사원번호
     * @return java.util.Vector 선이수과정
     * @exception com.sns.jdf.GeneralException
     */
    public Vector getCurriPreviouse( String PERNR, Vector PLAN ) throws GeneralException {
