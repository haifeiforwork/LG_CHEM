...
/**
 * A12FamilyAlloCancelRFC.java
 * 가족수당상실을 신청하는 RFC를 호출하는 Class
 *
 * @author 김도신
 * @version 1.0, 2002/01/30
 */
public class A12FamilyAlloCancelRFC extends SAPWrap {

    private String functionName = "ZHRH_RFC_FAMILY_ALLO_CANCEL";
     ...
     */
    public Vector getFamilyAlloCancel( String seqn ) throws GeneralException {
