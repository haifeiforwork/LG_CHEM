...
/*   Description  : 퇴직연금  제도전환 신청/조회/변경/삭제                       */
...
public class E03RetireTransRFC extends SAPWrap {
    ...
    /**
     * 제도전환 신청정보를 가져오는 RFC를 호출하는 Method
    ...
    /**
     * 제도전환 정보를 변경 신청하는 RFC를 호출하는 Method
     * @return java.util.Vector
     * @exception com.sns.jdf.GeneralException
     */
...
//            Logger.sap.println(this, "TransData_vt%%%%%%%%%%%%%%%%%%%%%%%%%%%%"+TransData_vt.toString());
    ...
    /**
     * 제도전환 정보를 변경 신청 후 수정하는 RFC를 호출하는 Method
     * @return java.util.Vector
     * @exception com.sns.jdf.GeneralException
     */
...
//            Logger.sap.println(this, "TransData_vt%%%%%%%%%%%%%%%%%%%%%%%%%%%%"+TransData_vt.toString());
    ...
    /**
     * 제도전환 변경 신청정보를 삭제하는 RFC를 호출하는 Method
     * @return java.util.Vector
     * @exception com.sns.jdf.GeneralException
     */
