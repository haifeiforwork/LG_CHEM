...
/*   Program ID   : E03RetireRegistRFC                                         */
/*   Description  : 퇴직연금  신청/조회/변경/삭제                       */
...
public class E03RetireRegistRFC extends SAPWrap {

    private String functionName = "ZSOLRP_RFC_PENSION_REQ";   

    /**
     * 퇴직연금 신청정보를 가져오는 RFC를 호출하는 Method
    ...
    /**
     * 퇴직연금 정보를 신청하는 RFC를 호출하는 Method
     * @return java.util.Vector
     * @exception com.sns.jdf.GeneralException
     */
    public void build(String empNo, String ainf_seqn, Vector Data_vt) throws GeneralException {
...
//            Logger.sap.println(this, "%%%%%%%%%%%%%%%%%%%%%%setRetire%%%%%%%%%%%%%%%%%%%%%%");
//            Logger.sap.println(this, "ainf_seqn%%%%%%%%%%%%%%%%%%%%%%%%%%%%"+ainf_seqn);
//            Logger.sap.println(this, "empNo%%%%%%%%%%%%%%%%%%%%%%%%%%%%"+empNo);
//            Logger.sap.println(this, "Data_vt%%%%%%%%%%%%%%%%%%%%%%%%%%%%"+Data_vt.toString());
            
            setInput(function, ainf_seqn, empNo, "2");
            setInput(function, Data_vt, "E_RESULT");
            excute(mConnection, function);
            E03RetireRegistInfoData data = (E03RetireRegistInfoData)getOutput(function, new E03RetireRegistInfoData());
    ...
    /**
     * 퇴직연금 정보를 신청 후 수정하는 RFC를 호출하는 Method
     * @return java.util.Vector
     * @exception com.sns.jdf.GeneralException
     */
    public void change(String empNo, String ainf_seqn, Vector Data_vt) throws GeneralException {
...
//            Logger.sap.println(this, "Data_vt%%%%%%%%%%%%%%%%%%%%%%%%%%%%"+Data_vt.toString());
    ...
    /**
     * 퇴직연금 신청정보를 삭제하는 RFC를 호출하는 Method
     * @return java.util.Vector
     * @exception com.sns.jdf.GeneralException
     */
...
//        Logger.sap.println(this, "cont_type===================="+cont_type);
    ...
    private Vector getOutput(JCO.Function function) throws GeneralException {
        String entityName = "hris.E.E03Retire.E03RetireRegistInfoData";
    ...
    private Object getOutput(JCO.Function function, E03RetireRegistInfoData data) throws GeneralException {
