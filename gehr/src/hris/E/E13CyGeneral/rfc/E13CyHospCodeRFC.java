...
/**
 * HospCodeRFC.java
 * 여수 이월 검진병원에 대한 데이터를 가져오는 RFC를 호출하는 Class
 *
 * @author 이형석
 * @version 1.0, 2013/02/25
 */
public class E13CyHospCodeRFC extends SAPWrap {

    //private static String functionName = "ZHRH_RFC_P_HOSP_CODE_DF";
    private static String functionName = "ZGHR_RFC_P_HOSP_CODE_DF";
