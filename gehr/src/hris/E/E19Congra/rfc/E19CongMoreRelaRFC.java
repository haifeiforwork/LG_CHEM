...
public class E19CongMoreRelaRFC extends SAPWrap {
     ...
     */
    public Vector getCongMoreRela( String empNo, String beginDate, String gubun  ) throws GeneralException {
        ...
        try{
            ...
            setInput(function, empNo, beginDate, gubun);
            excute(mConnection, function);

            Vector ret = getTable(E19CongcondData.class, function, "T_RESULT");// getOutput(function);
     ...
     * @exception com.sns.jdf.GeneralException
     */
    private void setInput(JCO.Function function, String empNo, String beginDate, String gubun ) throws GeneralException {
        String fieldName = "I_PERNR";
        setField( function, fieldName, empNo );
        fieldName = "I_BEGDA";
        setField( function, fieldName, beginDate );
        fieldName = "I_GUBUN";
        setField( function, fieldName, gubun );
