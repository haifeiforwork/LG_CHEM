...
/*   2Depth Name  : 인포멀 가입                                                 */
/*   Program Name : 인포멀 가입신청                                             */
/*   Program ID   : E25InfoJoinData                                             */
/*   Description  : 인포멀신청에 대한 데이터                                    */
...
public class E25InfoJoinData extends com.sns.jdf.EntityData {

    public String AINF_SEQN;  // 결재정보 일련번호
    public String BEGDA    ;  // 시작일
    public String ENDDA    ;  // 종료일
    public String APPL_DATE;  // 승인일
    ...
    public String ENAME    ;  // 사원 또는 지원자의 이름
    public String TITEL    ;  // 직위
    public String USRID    ;  // 통신 ID/번호
    public String ENTR_DATE;  // DATS 유형 필드
