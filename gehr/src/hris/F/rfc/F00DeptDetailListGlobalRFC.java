...
*   Program ID   : F00DeptDetailListGlobalRFC
...
import hris.F.F00DeptDetailListGlobalData;
 ...
 * @version 1.0
 */
public class F00DeptDetailListGlobalRFC extends SAPWrap {
    ...
    public Vector getDeptDetailList(String I_STAGB,  String I_ORGEH, String I_LOWERYN, String I_MOLGA,
									 ...
									 String I_PARM4, String I_PARM5, String I_PARM6) throws GeneralException {
        ...
        try{
            ...
            setField(function, "I_PARM6"  , I_PARM6);

            excute(mConnection, function);

            resultList.addElement(getTable(F00DeptDetailListGlobalData.class,  function, "T_EXPORTA"));
        } catch(Exception ex){
