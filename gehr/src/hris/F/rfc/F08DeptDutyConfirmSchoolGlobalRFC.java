...
/**
 * F08DeptDutyConfirmSchoolRFC 부서에 따른 직무별/인정학력별 정보를 가져오는 RFC를 호출하는 Class
 * @author
 * @version 1.0
 */
public class F08DeptDutyConfirmSchoolGlobalRFC extends SAPWrap {

	private String functionName = "ZGHR_RFC_GET_OPRS_STATE";
	...
	public Vector getDeptDutyConfirmSchool(String I_ORGEH, String I_LOWERYN, String I_MOLGA) throws GeneralException {
		...
		try {
        	...
        	// Table 결과 조회
        	resultList.addElement(getTable(F08DeptDutySchoolTitleGlobalData.class,  function, "T_EXPORTA"));
