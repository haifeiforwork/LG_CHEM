...
import hris.F.F09DeptDutyLastSchoolNoteData;
import hris.F.F09DeptDutyLastSchoolTitleData;
...
/**
 * F09DeptDutyLastSchoolRFC
 * 부서에 따른 직무별/최종학력별 정보를 가져오는 RFC를 호출하는 Class
 * @author
 * @version 1.0
 */
public class F09DeptDutyLastSchoolRFC extends SAPWrap {

    private String functionName = "ZGHR_RFC_GET_JSL_STATE";
    ...
    public Vector getDeptDutyLastSchool(String I_ORGEH, String I_LOWERYN, String I_MOLGA) throws GeneralException {
        ...
        try{
        	...
        	// Table 결과 조회
        	resultList.addElement(getTable(F09DeptDutyLastSchoolTitleData.class,  function, "T_EXPORTA"));
        	resultList.addElement(getTable(F09DeptDutyLastSchoolNoteData.class,  function, "T_EXPORTB"));
