...
/*   Description  : Global육성POOL 각각의 상세화면 조회를 위한 RFC 파일         */
/*   Note         : 없음                                                        */
 ...
 * Global육성POOL 각각의 상세화면 정보를 가져오는 RFC를 호출하는 Class
 *
 * @author  유용원
 * @version 1.0
 */
public class F71GlobalDetailListRFC extends SAPWrap {
    ...
    /**  
     * Global육성POOL 각각의 상세화면 정보를 가져오는 RFC를 호출하는 Method
    ...
    private void setInput(JCO.Function function, String i_gubun,  String i_deptId, String i_checkYN,
				                                         String i_paramA, String i_paramB, String i_paramC, 
												                         String i_paramD  ) throws GeneralException {
        String fieldName1  = "I_GUBUN";     //인재pool 구분자      
        String fieldName2  = "I_ORGEH";     //조직ID               
        String fieldName3  = "I_LOWERYN";   //하위조직포함 체크여부
        String fieldName4  = "I_OBJID";     //조직ID               
        String fieldName5  = "I_STEXT";     //조직코드명           
        String fieldName6  = "I_TITLACD";   //사원서브그룹         
        String fieldName7  = "I_TITLBCD";   //직위명               
    ...
    private Vector getOutput(JCO.Function function) throws GeneralException {
        ...
        // Table 결과 조회
    	String entityName = "hris.F.F71GlobalDetailListData";      // 데이타.        	
