...
public class F02DeptPositionDutyRFC extends SAPWrap {
    ...
    private String functionName = "ZHRA_RFC_GET_OPJ_STATE";
     ...
     */
    public Vector getDeptPositionDuty(String i_orgeh, String i_lower) throws GeneralException {
     ...
     * @exception com.sns.jdf.GeneralException
     */
    private void setInput(JCO.Function function, String i_orgeh, String i_lower) throws GeneralException {
    ...
    private Vector getOutput(JCO.Function function) throws GeneralException {
        ...
        // Table 결과 조회
    	String entityName1 = "hris.F.Global.F02DeptPositionDutyTitleData";		// 타이틀.
    	Vector T_EXPORTA = getTable(entityName1,  function, "T_EXPORTA");
    	String entityName2 = "hris.F.Global.F02DeptPositionDutyNoteData";      // 데이타.
