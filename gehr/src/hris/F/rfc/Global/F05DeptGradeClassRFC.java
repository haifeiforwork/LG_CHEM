...
public class F05DeptGradeClassRFC extends SAPWrap {
	...
	private String functionName = "ZHRA_RFC_GET_OPRJ_STATE";
	 ...
	 */
	public Vector getDeptGradeClass(String i_orgeh, String i_lower)
	...
	private Vector getOutput(JCO.Function function) throws GeneralException {
		...
		// Table 결과 조회
		String entityName1 = "hris.F.Global.F05DeptGradeClassTitleData"; // 타이틀.
		Vector T_EXPORTA = getTable(entityName1, function, "T_EXPORTA");
		// String entityName2 = "hris.F.F05DeptGradeClassNoteData"; // 데이타.
