 ...
 * @version 1.0
 */
public class F00DeptDetail1ListRFC extends SAPWrap {

    private String functionName = "ZHRA_RFC_GET_STATE_DETAI_LIST1";
    ...
    private Vector getOutput(JCO.Function function) throws GeneralException {
        ...
        // Table 결과 조회
    	String entityName = "hris.F.Global.F00DeptDetail1ListData";      // 데이타.
