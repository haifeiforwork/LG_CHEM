...
/**
 * F01DeptPositionClassRFC 부서에 따른 소속별/직급별 인원현황 정보를 가져오는 RFC를 호출하는 Class
 *
 * @author 유용원
 * @version 1.0
 */
public class F01DeptPositionClassRFC extends SAPWrap {
	...
	private String functionName = "ZHRA_RFC_GET_OPT_STATE";
	 ...
	 */
	public Vector getDeptPositionClass(String i_orgeh, String i_lower)
	...
	private Vector getOutput(JCO.Function function) throws GeneralException {
		...
		// Table 결과 조회
		String entityName1 = "hris.F.Global.F01DeptPositionClassTitleData"; // 타이틀.
		Vector T_EXPORTA = getTable(entityName1, function, "T_EXPORTA");
		// String entityName2 = "hris.F.F01DeptPositionClassNoteData"; // 데이타.
