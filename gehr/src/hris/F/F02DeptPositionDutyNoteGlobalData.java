...
*   Program ID   : F02DeptPositionDutyNoteData
*   Description  : 소속별/직무별 인원현황 조회를 위한 DATA 파일
*   Note         : 없음
*   Creation     :
*   Update       :
*
...
/**
 * F02DeptPositionDutyNoteData
 *  소속별/직무별 인원현황 내용을 담는 데이터
 * @author
 * @version 1.0,
 */
public class F02DeptPositionDutyNoteGlobalData extends com.sns.jdf.EntityData {
    public String ZLEVEL   ;    //Level
    public String OBJID    ;    //부서코드
    public String STEXT    ;    //부서텍스트
