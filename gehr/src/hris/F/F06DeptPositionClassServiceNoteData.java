...
*   Program ID   : F06DeptPositionClassServiceNoteData
*   Description  : 소속별/직급별 평균근속 조회를 위한 DATA 파일
*   Note         : 없음
*   Creation     :
*   Update       :
*
...
/**
 * F06DeptPositionClassServiceNoteData
 *  소속별/직급별 평균근속 내용을 담는 데이터
 * @author
 * @version 1.0,
 */

public class F06DeptPositionClassServiceNoteData extends com.sns.jdf.EntityData {
    public String ZLEVEL   ;    //조직 Level
    public String OBJID    ;    //소속부서
