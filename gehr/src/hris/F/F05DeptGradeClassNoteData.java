...
/*   Program ID   : F05DeptGradeClassNoteData                                   */
/*   Description  : 직책별/직급별 인원현황 조회를 위한 DATA 파일                */
/*   Note         : 없음                                                        */
...
/**
 * F05DeptGradeClassNoteData
 *  직책별/직급별 인원현황 내용을 담는 데이터 
 *  
 * @author 유용원
 * @version 1.0,  
 */
public class F05DeptGradeClassNoteData extends com.sns.jdf.EntityData {    
