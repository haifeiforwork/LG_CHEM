...
/*   2Depth Name  : 인원현황                                                    */
/*   Program Name : 직무별/인정(최종)학력별                                     */
/*   Program ID   : F08DeptDutySchoolNoteData                                   */
/*   Description  : 직무별/인정(최종)학력별 조회를 위한 DATA 파일               */
/*   Note         : 없음                                                        */
...
/**
 * F08DeptDutySchoolNoteData
 *  직무별/인정(최종)학력별 내용을 담는 데이터
 *
 * @author 유용원
 * @version 1.0,
 */

public class F08DeptDutySchoolNoteData extends com.sns.jdf.EntityData {
    public String JIKK_TYPE;    //직군
    public String JIKK_TEXT;    //오브젝트이름
    public String JIKL_TYPE;    //직렬
    public String JIKL_TEXT;    //오브젝트이름
