...
/*   Program ID   : F04DeptDutyClassNoteData                                    */
/*   Description  : 직무별/직급별 인원현황 조회를 위한 DATA 파일                */
/*   Note         : 없음                                                        */
...
/**
 * F04DeptDutyClassNoteData
 *  직무별/직급별 인원현황 내용을 담는 데이터
 *
 * @author 유용원
 * @version 1.0,
 */

public class F04DeptDutyClassNoteData extends com.sns.jdf.EntityData {
