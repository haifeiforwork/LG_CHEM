...
/**
 * J03CUDContentsRFC.java
 * 내역을 생성하는 RFC를 호출하는 Class
 *
 * @author  김도신
 * @version 1.0, 2003/06/18
 */
public class J03CUDContentsRFC extends SAPWrap {

    private String functionName = "ZHRH_RFC_CUD_CONTENTS";

    /**
     * 내역을 생성,수정하는 RFC 호출하는 Method
     * @return java.util.Vector
     * @param  java.lang.String
     * @exception com.sns.jdf.GeneralException
     */ 
    public Vector Create(String empNo, Vector j03Object_vt, Vector j03Contents_vt) throws GeneralException {
        ...
        try{
            ...
            setInput(function, j03Contents_vt, "P_CONTENTS");
