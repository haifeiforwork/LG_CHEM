...
/**
 * J03CUDLevelingRFC.java
 * Job Leveling을 생성하는 RFC를 호출하는 Class
 *
 * @author  김도신
 * @version 1.0, 2003/06/18
 */
public class J03CUDLevelingRFC extends SAPWrap {

    private String functionName = "ZHRH_RFC_CUD_LEVELING";

    /**
     * Job Leveling을 생성,수정하는 RFC 호출하는 Method
