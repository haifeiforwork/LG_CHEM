...
/**
 * J01GetObjectiveRFC.java
 * 사번으로 Objective를 조회하는 RFC를 호출하는 Class                        
 *
 * @author 김도신
 * @version 1.0, 2003/02/13
 */
public class J01GetObjectiveRFC extends SAPWrap {
     ...
     */
    public Vector getDetail( String i_pernr, String i_begda ) throws GeneralException {
        ...
        try {
            ...
            setInput( function, i_pernr, i_begda ) ;
     ...
     * @exception com.sns.jdf.GeneralException
     */
    private void setInput(JCO.Function function, String i_pernr, String i_begda ) throws GeneralException {
