...
/*   Program ID   : G078ApprovalRetireRegistSV                                         */
/*   Description  : 퇴직연금 신청 결재할 문서                            */
/*   Note         :                                               */
...
public class G078ApprovalRetireRegistSV extends EHRBaseServlet {
        ...
        try{
            ...
            if( jobid.equals("search") ) {
                ...
                if(E03RetireRegistData_vt.size() < 1){
                    ...
                    dest = WebUtil.JspURL+"G/G078ApprovalRetireRegist.jsp";
                } // end if
                    ...
                    try {
                        ...
                        if (appLine.APPL_APPR_STAT.equals("A")) {
                            ...
                            if (APPU_TYPE.equals("02") && Integer.parseInt(APPR_SEQN) > 1) {
                                ...
                                eof = ddfe.makeDocForReject(AINF_SEQN ,user.SServer,ptMailBody.getProperty("UPMU_NAME") ,e03RetireRegistInfoData.PERNR ,approvers);
                            } // end if
                        } // end if
