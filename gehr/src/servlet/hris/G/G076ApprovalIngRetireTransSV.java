...
/*   Program ID   : G076ApprovalIngRetireTransSV                                         */
/*   Description  : 퇴직연금 제도전환 결재진행 중                             */
/*   Note         :                                               */
...
public class G076ApprovalIngRetireTransSV extends EHRBaseServlet
{
       ...
       try{
           ...
           if( jobid.equals("search") ) {
               ...
               if(E03RetireTransData_vt.size() < 1){
                   ...
                   dest = WebUtil.JspURL+"G/G076ApprovalIngRetireTrans.jsp";
               } // end if
