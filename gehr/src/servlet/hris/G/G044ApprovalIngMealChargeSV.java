...
public class G044ApprovalIngMealChargeSV extends EHRBaseServlet 
{
        ...
        try{
            ...
            if( jobid.equals("search") ) {
                ...
                if( vcMealChargeData.size() < 1 ){
                    ...
                    dest = WebUtil.JspURL+"G/G044ApprovalIngMealCharge.jsp";
                } // end if
