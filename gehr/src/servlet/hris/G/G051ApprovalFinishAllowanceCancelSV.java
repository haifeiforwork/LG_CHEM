...
/*   Program Name : 가족수당 상실 신청                                          */
/*   Program ID   : G051ApprovalFinishAllowanceCancelSV                         */
/*   Description  : 가족수당 상실 신청 결재 완료                                */
/*   Note         : 없음                                                        */
...
public class G051ApprovalFinishAllowanceCancelSV extends EHRBaseServlet 
{
        ...
        try{
            ...
            if( jobid.equals("search") ) {
                ...
                if( vcA12FamilyBuyangData.size() < 1 ){
                    ...
                    dest = WebUtil.JspURL+"G/G051ApprovalFinishAllowanceCancel.jsp";
                } // end if
