...
/*   Program Name : 건강보험 재발급  결재                                       */
/*   Program ID   : G039ApprovalIngMedicareSV                                   */
/*   Description  : 건강보험 재발급 결재진행중                                  */
/*   Note         : 없음                                                        */
...
public class G039ApprovalIngMedicareSV extends EHRBaseServlet
{
    protected void performTask(HttpServletRequest req, HttpServletResponse res) throws GeneralException
    {
        try{
            ...
            Vector vcE02MedicareData = null;
            Vector vcAppLineData;

            E02MedicareData e02MedicareData;
            ...
            if( jobid.equals("search") ) {
                ...
                E02MedicareRFC func = new E02MedicareRFC();

                vcE02MedicareData = func.getDetail( AINF_SEQN, "");
                Logger.debug.println(this ,vcE02MedicareData);

                if( vcE02MedicareData.size() < 1 ){
                    String msg = "System Error! \n\n 조회할 항목이 없습니다.";
                    req.setAttribute("msg", msg);
                    dest = WebUtil.JspURL+"common/caution.jsp";
                }else{
                    // 건강보험 재발급 신청
                    e02MedicareData = (E02MedicareData)vcE02MedicareData.get(0);

                    // 결재자 정보
                    vcAppLineData = AppUtil.getAppChangeVt(AINF_SEQN);

                    PersInfoWithNoRFC   piRfc   = new PersInfoWithNoRFC();
                    PersInfoData        pid     = (PersInfoData) piRfc.getApproval(e02MedicareData.PERNR).get(0);
                    req.setAttribute("PersInfoData" ,pid );

                    req.setAttribute("e02MedicareData", e02MedicareData);
                    req.setAttribute("vcAppLineData"  , vcAppLineData);

                    dest = WebUtil.JspURL+"G/G039ApprovalIngMedicare.jsp";
                } // end if
            } else if( jobid.equals("save") ) {

                e02MedicareData   = new E02MedicareData();
                vcE02MedicareData = new Vector();

                // 건강보험 재발급 신청
                box.copyToEntity(e02MedicareData);
                e02MedicareData.UNAME = user.empNo;
                e02MedicareData.AEDTM = DataUtil.getCurrentDate();

                vcE02MedicareData.add(e02MedicareData);
                ...
                phonenumdata = (PersonData)numfunc.getPersonInfo(e02MedicareData.PERNR);
                ...
                ptMailBody.setProperty("UPMU_NAME" ,"건강보험 재발급");   // 문서 이름
                ...
                String msg;
                String msg2 = "";
                String to_empNo = e02MedicareData.PERNR;
