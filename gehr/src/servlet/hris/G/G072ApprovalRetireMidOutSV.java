...
/*   Program ID   : G072ApprovalRetireMidOutSV                                         */
/*   Description  : 퇴직연금 중도인출 결재할 문서                              */
/*   Note         :                                               */
...
public class G072ApprovalRetireMidOutSV extends EHRBaseServlet {
        ...
        try{
            ...
            if( jobid.equals("search") ) {
                ...
                if(E03RetireMidOutData_vt.size() < 1){
                    ...
                    dest = WebUtil.JspURL+"G/G072ApprovalRetireMidOut.jsp";
                } // end if
                    ...
                    try {
                        ...
                        if (appLine.APPL_APPR_STAT.equals("A")) {
                            ...
                            if (APPU_TYPE.equals("02") && Integer.parseInt(APPR_SEQN) > 1) {
                                ...
                                eof = ddfe.makeDocForReject(AINF_SEQN ,user.SServer,ptMailBody.getProperty("UPMU_NAME") ,e03RetireMidOutInfoData.PERNR ,approvers);
                            } // end if
                        } // end if
