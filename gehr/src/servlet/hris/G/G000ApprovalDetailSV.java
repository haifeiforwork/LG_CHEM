 ...
 * 신청 결재 상세 페이지로 이동
 */
public class G000ApprovalDetailSV extends EHRBaseServlet {
    ...
    protected void performTask(HttpServletRequest req, HttpServletResponse res) throws GeneralException {
        try{
            ...
            req.setAttribute("detailPage", forwardPage);

            /* 기본 g.getRequestPageName(req) 없을 시 결재할 문서  */
            req.setAttribute("RequestPageName", g.getRequestPageName(req, g.getServlet() + "hris.G.G001ApprovalDocListSV"));

            Logger.debug("------------------ g.getRequestPageName(req, g.getServlet() + \"hris.G.G001ApprovalDocListSV\") : " + g.getRequestPageName(req, g.getServlet() + "hris.G.G001ApprovalDocListSV"));
