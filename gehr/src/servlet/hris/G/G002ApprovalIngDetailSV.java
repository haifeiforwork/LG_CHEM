 ...
 * 신청 결재 상세 페이지로 이동
 */
public class G002ApprovalIngDetailSV extends EHRBaseServlet {
    ...
    protected void performTask(HttpServletRequest req, HttpServletResponse res) throws GeneralException {
        try{
            ...
            req.setAttribute("I_APGUB", "2");   //'1' : 결재할 문서 , '2' : 결재중 문서 , '3' : 결재완료 문서
            ...
            req.setAttribute("RequestPageName", g.getRequestPageName(req, g.getServlet() + "hris.G.G002ApprovalIngDocListSV"));
