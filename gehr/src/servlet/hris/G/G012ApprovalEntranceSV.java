...
/*   Program ID   : G012ApprovalEntranceSV                                      */
/*   Description  : 입학축하금 업무 담당자 ,담당부서장 결재/반려                */
/*   Note         : 없음                                                        */
...
public class G012ApprovalEntranceSV extends EHRBaseServlet 
{
	protected void performTask(HttpServletRequest req, HttpServletResponse res) throws GeneralException
    {
        try{
            ...
            if( jobid.equals("search") ) {
                ...
                dest = WebUtil.JspURL+"G/G012ApprovalEntrance.jsp";
                    ...
                    try {
                        ...
                        if (appLine.APPL_APPR_STAT.equals("A")) {
                            ...
                            if (APPU_TYPE.equals("02") && Integer.parseInt(APPR_SEQN) > 1) {
                                ...
                                eof = ddfe.makeDocForReject(AINF_SEQN ,user.SServer,ptMailBody.getProperty("UPMU_NAME") ,e21EntranceData.PERNR ,approvers);
                            } // end if
                        } // end if 
