...
/*   Program ID   : G070ApprovalIngRetireBusinessSV                                         */
/*   Description  : 퇴직연금 사업자 변경 결재 진행 중                               */
/*   Note         :                                               */
...
public class G070ApprovalIngRetireBusinessSV extends EHRBaseServlet
{
       ...
       try{
           ...
           if( jobid.equals("search") ) {
               ...
               if(E03RetireBusinessData_vt.size() < 1){
                   ...
                   dest = WebUtil.JspURL+"G/G070ApprovalIngRetireBusiness.jsp";
               } // end if
