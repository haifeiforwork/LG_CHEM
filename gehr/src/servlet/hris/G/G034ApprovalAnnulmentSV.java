...
/*   Program Name : 개인 연금해약  신청                                         */
/*   Program ID   : G034ApprovalAnnulmentSV                                     */
/*   Description  : 개인 연금해약 담당자 결재/반려                              */
/*   Note         : 없음                                                        */
...
public class G034ApprovalAnnulmentSV extends EHRBaseServlet 
{
        ...
        try{
            ...
            if( jobid.equals("search") ) {
                ...
                if( vcE11PersonalData.size() < 1 ){
                    ...
                    dest = WebUtil.JspURL+"G/G034ApprovalAnnualment.jsp";
                } // end if
                ...
                for (int i = 0; i < nRowCount; i++) {
                    ...
                    if (tempAppLine.APPL_APPR_STAT.equals("미결") && currApprNumb.equals("")){//@V1.
                ...
                ptMailBody.setProperty("UPMU_NAME" ,"개인연금 해약");           // 문서 이름
                    ...
                    try {
                        ...
                        if (appLine.APPL_APPR_STAT.equals("A")) {
                            ...
                            if (APPU_TYPE.equals("02") && Integer.parseInt(APPR_SEQN) > 1) {
                                ...
                                eof = ddfe.makeDocForReject(AINF_SEQN ,user.SServer,ptMailBody.getProperty("UPMU_NAME") ,e11PersonalData.PERNR ,approvers);
                            } // end if
                        } // end if 
