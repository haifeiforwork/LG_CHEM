...
/*   Program ID   : G010ApprovalIngPersonalSV                                   */
/*   Description  : 개인연금 결재 취소                                          */
/*   Note         : 없음                                                        */
...
public class G010ApprovalIngPersonalSV extends EHRBaseServlet 
{
	protected void performTask(HttpServletRequest req, HttpServletResponse res) throws GeneralException
    {
        try{
            ...
            if( jobid.equals("search") ) {
                ...
                dest = WebUtil.JspURL+"G/G010ApprovalIngPersonal.jsp";
