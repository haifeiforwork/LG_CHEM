...
/*   Program Name : 초과 근무 신청 결재                                         */
/*   Program ID   : G028ApprovalIngOTSV                                         */
/*   Description  : 초과 근무 신청 결재진행중                                   */
/*   Note         :                                                             */
/*   Creation     : 2005-03-27  윤정현                                          */
/*   Update       :                                                             */
/*                                                                              */
/********************************************************************************/
...
public class G028ApprovalIngOTSV extends EHRBaseServlet
{
       ...
       try{
            ...
            if( jobid.equals("search") ) {
                ...
                if( vcD01OTData.size() < 1 ){
                    ...
                    dest = WebUtil.JspURL+"G/G028ApprovalIngOT.jsp";
                } // end if
