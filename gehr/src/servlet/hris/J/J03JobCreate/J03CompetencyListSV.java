...
/**
 * J03CompetencyListSV.java
 * Competency List를 조회한다. 
 *
 * @author 원도연
 * @version 1.0, 2003/06/17
 */
public class J03CompetencyListSV extends EHRBaseServlet {
    ...
    protected void performTask(HttpServletRequest req, HttpServletResponse res) throws GeneralException
    {
        try{
            ...
            req.setAttribute("QKID",           i_QKid);            
            req.setAttribute("rows",           i_rows);                        
            req.setAttribute("paging",         paging);
                                            
            dest = WebUtil.JspURL+"J/J03JobCreate/J03CompetencyList.jsp";
