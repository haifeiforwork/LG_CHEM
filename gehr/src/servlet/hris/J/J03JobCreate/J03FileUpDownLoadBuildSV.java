...
/**
 * J03FileUpDownLoadBuildSV.java
 * Eloffice Server에 Job Unit별 KSEA, Job Process PPT File을 UpLoad한다. 
 *
 * @author  김도신
 * @version 1.0, 2003/06/20
 */
public class J03FileUpDownLoadBuildSV extends EHRBaseServlet {
...
//              Job Process일경우 Job Objectives와 Position
                ...
                dest = WebUtil.JspURL+"J/J03JobCreate/J03FileUpDownLoadBuild.jsp";
            }
