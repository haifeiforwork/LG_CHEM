...
/**
 * B05CompetencyReqSV.java
 * Competency Requirements 상세내역 등을 조회한다. 
 *
 * @author 김도신
 * @version 1.0, 2003/02/13
 */
public class B05CompetencyReqSV extends EHRBaseServlet {
    ...
    protected void performTask(HttpServletRequest req, HttpServletResponse res) throws GeneralException
    {
        try{
            ...
            B05CompetencyReqRFC rfc            = new B05CompetencyReqRFC();

            Vector              ret            = new Vector();
            Vector              b05Result_vt   = new Vector();
            Vector              b05Result_Q_vt = new Vector();
