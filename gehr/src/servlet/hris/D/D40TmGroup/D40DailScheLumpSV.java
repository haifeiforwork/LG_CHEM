...
/*   Program ID		:  D40DailScheLumpSV.java							*/
...
public class D40DailScheLumpSV extends EHRBaseServlet {
	...
	protected void performTask( HttpServletRequest req, HttpServletResponse res ) throws GeneralException {
		...
		try{
			...
			if("EXCEL".equals(gubun)){
				...
				Vector vec = (new D40DailScheLumpFrameRFC()).getDailScheLumpExcelDown(user.empNo, I_ACTTY, I_SELTAB, OBJID );

				req.setAttribute("excelSheet1", vec.get(0));
				req.setAttribute("excelSheet2", vec.get(1));
				printJspPage(req, res, WebUtil.JspURL + "D/D40TmGroup/D40DailScheExcelDown.jsp");
...
//				req.setAttribute("resultList", resultList);
		    	printJspPage(req, res, WebUtil.JspURL + "D/D40TmGroup/D40DailScheLumpExcel.jsp");
				...
				Vector vec = (new D40DailScheLumpFrameRFC()).getDailScheLump(user.empNo, I_ACTTY, I_DATUM, I_SCHKZ, T_IMPERS, I_SELTAB, OBJID);
