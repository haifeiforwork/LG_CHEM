...
/*   Program ID   : D25WorkTimeLeaderDailySV.java
...
public class D25WorkTimeLeaderDailySV extends EHRBaseServlet {
    ...
    protected void performTask(HttpServletRequest req, HttpServletResponse res) throws GeneralException {
        ...
        if ("excel-download".equals(req.getParameter("jobid"))) {
            ...
            printJspPage(req, res, WebUtil.JspURL + "D/D25WorkTime/D25WorkTimeLeaderDailyExcel.jsp");

        } else {
            printJspPage(req, res, WebUtil.JspURL + "D/D25WorkTime/D25WorkTimeLeaderDaily.jsp");
