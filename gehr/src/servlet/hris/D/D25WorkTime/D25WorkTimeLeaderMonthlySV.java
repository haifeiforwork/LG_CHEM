...
/*   Program ID   : D25WorkTimeLeaderMonthlySV.java
/*   Description  : 월별 근무 입력 현황 목록 JSP 요청처리 class
/*   Note         : 
...
public class D25WorkTimeLeaderMonthlySV extends EHRBaseServlet {
    ...
    protected void performTask(HttpServletRequest req, HttpServletResponse res) throws GeneralException {
        ...
        if ("excel-download".equals(req.getParameter("jobid"))) {
            ...
            printJspPage(req, res, WebUtil.JspURL + "D/D25WorkTime/D25WorkTimeLeaderMonthlyExcel.jsp");

        } else {
            printJspPage(req, res, WebUtil.JspURL + "D/D25WorkTime/D25WorkTimeLeaderMonthly.jsp");
