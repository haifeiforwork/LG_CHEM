...
/**
 * D03CongraListPopLotationSV.java
 * 경조내역 리스트를 팝업에서 조회 하는 Class
 *
 * @author lsa   
 * @version 1.0, 2008/03/11 
 */
public class D03CongraListPopLotationSV extends EHRBaseServlet {
	...
	protected void performTask(HttpServletRequest req, HttpServletResponse res) throws GeneralException {
        try{
            ...
            req.setAttribute( "INX", INX );
            req.setAttribute( "D03CondolHolidaysData_dis", D03CondolHolidaysData_dis );

            dest = WebUtil.JspURL+"D/D03Vocation/D03CongraListPopLotation.jsp";
