 ...
 **/
public class D06YpayKoreaSV extends EHRBaseServlet {
    ...
    protected void performTask(HttpServletRequest req, HttpServletResponse res) throws GeneralException
    {
        ...
        try{
          ...
          //@PJ.멕시코 법인 Rollout 프로젝트 추가 관련(Area = MX("32"))  2018/02/09 rdcamel
          //@PJ.베트남 하이퐁 법인 Rollout 프로젝트 추가 관련(Area = OT("99") && companyCode(G580) ) 2018/04/02 Kang DM
            if (user.area.equals(Area.CN) || user.area.equals(Area.TW) || user.area.equals(Area.HK)|| user.area.equals(Area.TH)|| (user.area.equals(Area.OT) && user.companyCode.equals("G580"))) {	// 타이완,홍콩은 중국화면으로
               fdUrl = "hris.D.D06Ypay.D06YpayEastSV";
        	   ...
        	   fdUrl = "hris.D.D06Ypay.D06YpayWestSV";
          ...
          //[CSR ID:2995203] 보상명세서 용 뒤로가기.
            ...
            if( jobid.equals("first") ) {
                ...
                String from_year  = ableyear;
                String from_month = "01";
                String to_year    = ableyear;
...
//                    d06YpayDetailData2_vt = rfc_tax2.getYpayDetail2(user.empNo, yymmdd_tax, "ZZ", flag, seqnr,user.webUserId);
                    Vector v =rfc_tax2.getYpayDetail(user.empNo, yymmdd_tax, "ZZ", flag, seqnr,user.webUserId);  // *ksc
                    d06YpayDetailData2_vt = (Vector) Utils.indexOf(v, 0);// *ksc
...
//                    d06YpayDetailData5_vt = (Vector)d06YpayDetailData2_vt.clone();
//                    d06YpayDetailData6_vt = (Vector)d06YpayDetailData2_vt.clone();
//                    Logger.debug.println(this, "--------------------------- d06YpayDetailData2_vt : "+ d06YpayDetailData2_vt.hashCode());
//                    Logger.debug.println(this, "--------------------------- d06YpayDetailData5_vt : "+ d06YpayDetailData5_vt.hashCode());
//                    Logger.debug.println(this, "--------------------------- d06YpayDetailData6_vt : "+ d06YpayDetailData6_vt.hashCode());
...
//                    d06YpayDetailData4_vt = rfc_tax2.getYpayDetail3(user.empNo, yymmdd_tax, "ZZ", flag, seqnr,user.webUserId);
                    d06YpayDetailData4_vt = (Vector) Utils.indexOf(v, 1);// *ksc
                    // 연말 정산 2003.01.13
//                    d06YpayDetailData4 = (D06YpayDetailData4_to_year)rfc_tax2.getPerson(user.empNo, yymmdd_tax, "ZZ", flag, seqnr,user.webUserId);
                    d06YpayDetailData4 = (D06YpayDetailData4_to_year) Utils.indexOf(v, 2);// *ksc
...
//              Logger.debug.println(this, "d06YpayTaxDetailData : "+ d06YpayTaxDetailData.toString());
                ...
                dest = WebUtil.JspURL+"D/D06Ypay/D06YpayKorea.jsp";
//            }
...
//                    d06YpayDetailData2_vt = rfc_tax2.getYpayDetail2(mapPernr, yymmdd_tax, "ZZ", flag, seqnr,user.webUserId);
                    Vector v =rfc_tax2.getYpayDetail(mapPernr, yymmdd_tax, "ZZ", flag, seqnr,user.webUserId);  // 2003.01.02 과세반영으로 인한 추가.
                    d06YpayDetailData2_vt = (Vector)Utils.indexOf(v, 0);// *ksc
//                    d06YpayDetailData5_vt =
...
//            	dest = WebUtil.JspURL+"D/D06Ypay/D06YpayDetail_to_year2.jsp?gubun=Y";
            }
