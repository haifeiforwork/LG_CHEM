...
/*   Description  : 초과근무 조회/삭제 할수 있도록 하는 Class              	*/
/*   Note         :                                                             */
/*   Creation     : 2011-05-04  JMK                                             */
/*                 [CSR ID:2529608] 모바일 초과근무삭제시 오류 수정             */
...
public class D01OTMbDeleteSV extends MobileAutoLoginSV {
    ...
    protected void performTask(HttpServletRequest req, HttpServletResponse res) throws GeneralException
    {
       // Connection con = null;
        ...
        try{
            ...
            Logger.debug.println("D01OTMbDeleteSV start++++++++++++++++++++++++++++++++++++++" );
    ...
    public String apprItem( HttpServletRequest req, HttpServletResponse res){
       ...
       //통합결재연동 결과값
        ...
        try{
            ...
            Logger.debug.println(this, "초과근무신청 조회 :user.empNo====> " + user.empNo);
            Logger.debug.println(this, "초과근무신청 조회 :AINF_SEQN====> " + AINF_SEQN);
            //초과근무신청 조회
            ...
            Logger.debug.println(this, "초과근무신청 조회 mobile 삭제 : " + D01OTData_vt.toString());
