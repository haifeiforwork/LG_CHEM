...
public class D01OTAfterWorkMbReqListSV extends MobileAutoLoginSV {

	private String UPMU_TYPE ="44";   // 결재 업무타입(사후초과근무신청)
    protected void performTask(HttpServletRequest req, HttpServletResponse res) throws GeneralException
    {
     
    	try{
    		
        	Logger.debug.println("D01OTAfterWorkMbReqListSV start++++++++++++++++++++++++++++++++++++++" ); 
    ...
    public String apprItem( HttpServletRequest req, HttpServletResponse res){
        ...
        try{
        	Logger.debug.println("D01OTAfterWorkMbReqListSV apprItem Strart++++++++++++++++++++++++++++++++++++++" ); 
            ...
            aplk.I_AGUBN  =   "2";
            aplk.I_PERNR  =   PERNR;
            aplk.I_UPMU_TYPE = "44";// 사후초과근무만 LISTUP
            ...
            for(int i=0; i< vcApprovalDocList.size(); i++){
                ...
                XmlUtil.addChildElement(item, "apprCategory","초과근무 사후신청");
                ...
                Logger.debug.println("D01OTAfterWorkMbReqListSV apl)  JMK+++++++++++>"+apl.toString() ); 
            }
