 ...
 * jobid가 search 일경우는 결재정보 List 를 가져오는 PrizDetailRFC를 호출하여 PrizDetail_m.jsp로 결재정보를 넘겨준다.
 *
 * @author 최영호
 * @version 1.0, 2001/12/17
 */
public class A06PrizDetailSV_m extends EHRBaseServlet_m {
...
//          @웹취약성 추가
            ...
            if ( user_m.companyCode.equals("C100") && mapData_vt != null && mapData_vt.size() > 0 ) {  // 재입사자 처리
                ...
                func1                = new A06PrizDetailRFC();
                A06PrizDetailData_vt = func1.getPrizDetail(user_m.empNo, "", null, null);
            }
            ...
            dest = WebUtil.JspURL+"A/A06PrizDetail_m.jsp";
