...
/*   2Depth Name  : 가족사항                                                    */
/*   Program Name : 부양가족 변경(해지) 신청 수정                               */
/*   Program ID   : A12SupportCancelChangeSV                                    */
/*   Description  : 부양가족 변경(해지) 신청을 수정할 수 있도록 하는 Class      */
/*   Note         :                                                             */
...
import hris.A.A12Family.rfc.A12FamilyBuyangCancelRFC;
...
public class A12SupportCancelChangeSV extends EHRBaseServlet {
    ...
    protected void performTask(HttpServletRequest req, HttpServletResponse res) throws GeneralException
    {
        ...
        try{
            ...
            a12FamilyBuyangData_vt = rfc.getBuyangCancel( ainf_seqn );
            Logger.debug.println(this, "부양가족 변경(해지) 신청 조회 : " + a12FamilyBuyangData_vt.toString());
            ...
            if( jobid.equals("first") ) {    //제일처음 수정 화면에 들어온경우.
                ...
                Logger.debug.println(this, "부양가족 변경(해지) 신청 수정 조회 : " + a12FamilyBuyangData_vt.toString());
                ...
                dest = WebUtil.JspURL+"A/A12Family/A12SupportCancelChange.jsp";
                ...
                Logger.debug.println(this, "부양가족 변경(해지) 신청 수정 : " + a12FamilyBuyangData.toString());
                ...
                if( appDB.canUpdate((AppLineData)AppLineData_vt.get(0)) ) {
                    ...
                    if (!newAppLine.APPL_APPU_NUMB.equals(oldAppLine.APPL_PERNR)) {
                        ...
                        ptMailBody.setProperty("UPMU_NAME" ,"부양가족 변경(해지)");            // 문서 이름
