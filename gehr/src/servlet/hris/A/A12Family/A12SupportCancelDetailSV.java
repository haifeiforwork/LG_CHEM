...
/*   Program ID   : A12SupportCancelDetailSV                                    */
/*   Description  : 부양가족 변경(해지) 신청에 대한 상세내용을 조회하는 Class   */
/*   Note         :                                                             */
...
public class A12SupportCancelDetailSV extends EHRBaseServlet {
    ...
    protected void performTask(HttpServletRequest req, HttpServletResponse res) throws GeneralException
    {
        ...
        try{
            ...
            if( jobid.equals("first") ) {
                ...
                dest = WebUtil.JspURL+"A/A12Family/A12SupportCancelDetail.jsp";
