 ...
 * @version 1.0
 */
public class OrganListSV extends EHRBaseServlet {
        ...
        try{
            ...
            if("node".equals(box.get("jobid"))) {
                ...
                if("B".equals(req.getParameter("popCode"))) {
                    printJspPage(req, res, WebUtil.JspURL + "common/OrganListPopIF.jsp");
                } else {
                    printJspPage(req, res, WebUtil.JspURL + "common/OrganListLeftIF.jsp");
                }
