...
import hris.E.E37Meal.E37MealApprData;
import hris.E.E37Meal.E37MealData;
import hris.E.E37Meal.rfc.E37MealRFC;
...
public class E37MealBuildSV extends EHRBaseServlet {
    ...
    protected void performTask(HttpServletRequest req, HttpServletResponse res) throws GeneralException
    {
        ...
        try{
            ...
            if( jobid.equals("first")  ) {                 //제일처음 저장 화면에 들어온경우. 
            	...
            	ret = rfcMeal.newdetail( i_orgeh, i_yyyymm,I_APLY_FLAG  ); 
                ...
                if (!E_RETURN.equals("E") ) {
                    ...
                    if (meal_vt.size()>0){
                        E37MealData data = (E37MealData)meal_vt.get(0);     

                        //결재자리스트
                        AppLineData_vt = AppUtil.getAppVector( data.PERNR, UPMU_TYPE );
                    }else{
 ...
 //               Logger.debug.println("------ data.PERNR: "+ data.PERNR);            
   //             Logger.debug.println("------ AppLineData_vt: "+ AppLineData_vt.toString());
 //               Logger.debug.println("------E37MealBuildSV ret.TOSTRING: "+ret.toString());
                	...
                	dest = WebUtil.JspURL+"E/E37Meal/E37MealBuild.jsp";
                 } else { 
                    String msg = E_MESSAGE;
                    //String url = "location.href = '" + WebUtil.ServletURL+"hris.E.E37Meal.E37MealBuildSV?hdn_deptId="+i_orgeh+"&hdn_deptNm="+i_orgeh_nm+"&t_year="+t_year+"&t_month="+t_month+"&I_APLY_FLAG="+I_APLY_FLAG+"';";
                    String url = "location.href = '" + WebUtil.ServletURL+"hris.E.E37Meal.E37MealBuildSV?hdn_deptId=&hdn_deptNm=&t_year="+t_year+"&t_month="+t_month+"&I_APLY_FLAG="+I_APLY_FLAG+"';";
                    req.setAttribute("msg", msg);
                    req.setAttribute("url", url);
                    dest = WebUtil.JspURL+"common/msg.jsp";              
                }
                
            } else if( jobid.equals("create") ) {       //결재요청
                ...
                for( int i = 0; i < RowCount_meal; i++) {
                    ...
                    e37MealData.AINF_SEQN = AINF_SEQN;  // 결재정보 일련번호       
                    ...
                    for( int j = 0; j < row_count; j++) {
                    	...
                    	p_zhra003t.AINF_SEQN = AINF_SEQN;
                ...
                Logger.debug.println("식대------i_yyyymm : "+i_yyyymm+"- i_orgeh : "+i_orgeh+" -I_APLY_FLAG : "+I_APLY_FLAG);
                Logger.debug.println("식대------meal_vt : "+meal_vt.toString());
                Logger.debug.println("식대------mealAppr_vt : "+mealAppr_vt.toString());

            	//결재신청
            	Vector ret_vt = rfcMeal.build(   i_orgeh,i_yyyymm, I_APLY_FLAG ,meal_vt ,mealAppr_vt);
            	...
            	if(!E_RETURN.equals("E")){
                    ...
                    Logger.debug.println("식대------2 : meal_vt.size()" +meal_vt.size());      
	            	for( int i = 0; i < meal_vt.size(); i++) {
	                    E37MealData e37MealData = (E37MealData)meal_vt.get(i);   
	                    Logger.debug.println("식대------3 : e37MealData.AINF_SEQN"+e37MealData.AINF_SEQN );      
	                    ElofficInterfaceData eof = ddfe.makeDocContents(e37MealData.AINF_SEQN ,user.SServer,UPMU_NAME);	 
	                    Logger.debug.println("식대------4 : " );                     	
