...
/*   Program Name : 퇴직연금 중도인출  신청                                */
/*   Program ID   : E03RetireMidOutBuildSV                                         */
/*   Description  : 퇴직연금 중도인출  신청 서블릿                                  */
/*   Note         :                                               */
        ...
        try{
            ...
            if(retireType.equalsIgnoreCase("DB") || retireType.equalsIgnoreCase("")){
	            ...
	            if( jobid.equals("first") ) {     //제일처음 신청 화면에 들어온경우.
	                ...
	                MidOutData.BEGDA    = DateTime.getShortDateString();              // 신청자 사번(대리신청, 본인 신청)

	                
	                MidOutData_vt.addElement(MidOutData);
	                Logger.debug.println(this, "퇴직연금중도인출신청 MidOutData_vt ="+MidOutData_vt.toString());
