...
/*   1Depth Name  : 퇴직연금                                               */
/*   2Depth Name  : 퇴직연금  신청                                         */
/*   Program Name : 퇴직연금 신청 정보 조회                               */
/*   Program ID   : E03RetireRegistDetailSV                                         */
/*   Description  : 퇴직연금 신청 정보 조회 서블릿                                  */
/*   Note         :                                               */
...
//퇴직연금 신청조회삭제
public class E03RetireRegistDetailSV extends EHRBaseServlet {
    ...
    protected void performTask(HttpServletRequest req, HttpServletResponse res) throws GeneralException
    {
        ...
        try{
            ...
            E03RetireRegistInfoData    firstData    = new E03RetireRegistInfoData();
            ...
            if(E03RetireRegistData_vt.size() > 0)
            	firstData = (E03RetireRegistInfoData)E03RetireRegistData_vt.get(0);
            ...
            if( jobid.equals("first") ) {
                ...
                req.setAttribute("RegistInfoData", firstData);                //변경신청 내용	                
                ...
                dest = WebUtil.JspURL+"E/E03Retire/E03RetireRegistDetail.jsp";
...
//                  신청건 삭제시 메일 보내기.
                    ...
                    if(RequestPageName != null &&  !RequestPageName.equals("") ){
                        ...
                        url = "location.href = '" + WebUtil.ServletURL+"hris.E.E03Retire.E03RetireRegistBuildSV';";
                    } // end if
                    //  삭제 실행후 삭제전 페이지로 이동하기 위한 구분
