...
/*   1Depth Name  : 퇴직연금                                               */
/*   2Depth Name  : 연금사업자변경                                                 */
/*   Program Name : 연금사업자변경  신청 후 내용 변경                                 */
/*   Program ID   : E03RetireBusinessChangeSV                                         */
/*   Description  : 연금사업자변경  신청 후 내용 변경 서블릿                                  */
/*   Note         :                                               */
	...
	protected void performTask(HttpServletRequest req, HttpServletResponse res) throws GeneralException
    {
        ...
        try{
            ...
            if( jobid.equals("first") ) {           //제일처음 신청 화면에 들어온경우.
                ...
                req.setAttribute("BusinessInfoData", firstData);                //변경신청 내용
                ...
                businessData_vt.addElement(businessData);
                Logger.debug.println(this, "퇴직연금사업자 변경 신청 수정 businessData_vt ="+businessData_vt.toString());
