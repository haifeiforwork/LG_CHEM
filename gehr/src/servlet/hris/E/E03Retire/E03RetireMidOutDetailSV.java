...
/*   System Name  : ESS                                                         */
/*   1Depth Name  : 퇴직연금                                               */
/*   2Depth Name  : 퇴직연금 중도인출                                            */
/*   Program Name : 퇴직연금 중도인출  신청 정보 조회                               */
/*   Program ID   : E03RetireMidOutDetailSV                                         */
/*   Description  : 퇴직연금 중도인출  신청 정보 조회 서블릿                                  */
/*   Note         :                                               */
...
//퇴직연금 중도인출신청조회삭제
public class E03RetireMidOutDetailSV extends EHRBaseServlet {

    private String UPMU_TYPE ="53";
    private String UPMU_NAME = "퇴직연금 중도인출";
    ...
    protected void performTask(HttpServletRequest req, HttpServletResponse res) throws GeneralException
    {
        ...
        try{
            ...
            E03RetireMidOutInfoData    firstData    = new E03RetireMidOutInfoData();
            ...
            if(E03RetireMidOutData_vt.size() > 0)
            	firstData = (E03RetireMidOutInfoData)E03RetireMidOutData_vt.get(0);
            ...
            if( jobid.equals("first") ) {
                ...
                req.setAttribute("MidOutInfoData", firstData);                //변경신청 내용	                
                req.setAttribute("AppLineData_vt", AppLineData_vt);
                
                dest = WebUtil.JspURL+"E/E03Retire/E03RetireMidOutDetail.jsp";
...
//                  신청건 삭제시 메일 보내기.
                    ...
                    if(RequestPageName != null &&  !RequestPageName.equals("") ){
                        ...
                        url = "location.href = '" + WebUtil.ServletURL+"hris.E.E03Retire.E03RetireMidOutBuildSV';";
                    } // end if
                    //  삭제 실행후 삭제전 페이지로 이동하기 위한 구분
