...
/*   Program Name : 퇴직연금 제도전환  신청                                */
/*   Program ID   : E03RetireTransBuildSV                                         */
/*   Description  : 퇴직연금 제도전환  신청 서블릿                                  */
/*   Note         :                                               */
...
public class E03RetireTransBuildSV extends EHRBaseServlet {
    ...
    private static String UPMU_SUBTYPE_1 ="01";	//정기전환 하부유형
    private static String UPMU_SUBTYPE_2 ="02";	//수시전환 하부유형    
    ...
    protected void performTask(HttpServletRequest req, HttpServletResponse res) throws GeneralException
    {
        ...
        try{
            ...
            if(retireType.equalsIgnoreCase("DC") || retireType.equalsIgnoreCase("")){	//DC형은 처리 안함
	            ...
	            req.setAttribute("retirePeriod_1", retirePeriod_1+"");//정기전환 신청 기간 체크       
	            req.setAttribute("retirePeriod_2", retirePeriod_2+"");//수시전환 신청 기간 체크    	            
	            ...
	            if( jobid.equals("first") ) {     //제일처음 신청 화면에 들어온경우.
	                ...
	                TransData.BEGDA    = DateTime.getShortDateString();              // 신청자 사번(대리신청, 본인 신청)

	                
	                TransData_vt.addElement(TransData);
	                Logger.debug.println(this, "제도전환신청 TransData_vt ="+TransData_vt.toString());
