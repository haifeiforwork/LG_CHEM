 ...
 *
 *
 * The getReply() method can be used to examine the reply that caused
 * the exception.
 *
...
public class FtpException extends Exception {
   ...
   * The explaination is prepended to the text of the actual reply to form
   ...
   */
  public FtpReply getReply() { return d_reply; }
   ...
   */
  public int getType() { return d_reply.getType(); }
   ...
   */
  public int getCode() { return d_reply.getCode(); }
}
