...
public class J03KSEAFileUpload extends MultipartRequest{
	...
	static final String savedirectory = "/user8/hris/j-image/ksea_ppt/"; //   <==============저장하려는 directory
	static final String downdirectory = ".";

	public J03KSEAFileUpload(ServletRequest request, String rename)throws IOException{
		this(request, MAX_POST_SIZE, rename);
	}

	public J03KSEAFileUpload(ServletRequest request, int postsize, String rename) throws IOException {
