...
(function(window, $, undefined) {
    ...
    Grid.prototype = {
        ...
        pagePrevText: "<image src='/web-resource/images/ico/ico_prev_page.gif'>",
        pageNextText: "<image src='/web-resource/images/ico/ico_next_page.gif'>",
        pageFirstText: "<image src='/web-resource/images/ico/ico_first_page.gif'>",
        pageLastText: "<image src='/web-resource/images/ico/ico_last_page.gif'>",
        ...
        invalidMessage: "입력된 데이터가 적합하지 않습니다.\n",

        invalidNotify: function(args) {
            var messages = $.map(args.errors, function(error) {
                return error.field.title.replace(/<br[^>]*>/gi,"")+ " : " + error.message;
            });
        ...
        _createPagerNavButton: function(text, pageIndex, isActive) {
            return this._createPagerButton(text, this.pagerNavButtonClass,
...
(function(jsGrid, $, undefined) {
    ...
    SelectField.prototype = new NumberField({
        ...
        itemTemplate: function(value) {
        		var chgItem = this.items,
                valueField = this.valueField,
                textField = this.textField,
                resultItem;
        		if(this.chgCombo && this.mCombo){
        			mComboVal = value;
        		}
        		if(this.chgCombo && this.cCombo){
        			var funcNm = this.chgFunc;  
        			chgItem = eval(funcNm+"('"+mComboVal+"');");
	    		 }	 
            if(valueField) {
                resultItem = $.grep(chgItem, function(item, index) {
