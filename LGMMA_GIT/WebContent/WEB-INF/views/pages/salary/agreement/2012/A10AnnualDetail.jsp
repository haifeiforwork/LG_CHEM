...
<%          }             %>                                      
              ...
              <tr> 
                <td class="style01">&nbsp;</td>
                <td class="style01">산정한 후, 매월 25일에 「基本年俸 月割分」과 「基本年俸 月割分」</td>
              </tr>
              <tr> 
                <td class="style01">&nbsp;</td>
                <td class="style01">의 半을 지급하고, 설날, 추석에 「基本年俸 月割分」을 각각</td>
              </tr>
              <tr> 
                <td class="style01">&nbsp;</td>
                <td class="style01">지급한다.</td>
              </tr>
              <tr> 
                <td class="style01">&nbsp;</td>
                <td class="style01">※ 중도입사자의 매월25일, 설날, 추석에 지급되는 「基本年俸 月割</td>
              </tr>
              <tr>   
                <td class="style01">&nbsp;</td>
                <td class="style01">分」의 半과 「基本年俸 月割分」에 대해서는 별도 기준에 따름.</td>
              </tr>
              <tr> 
                <td colspan="2">&nbsp;</td>
              </tr>
              ...
              <tr>
                <td class="style01">⑧</td>
                <td class="style01">소정근로시간, 휴일, 연차유급휴가등 기타사항은 취업규칙과 </td>
              </tr>
              <tr>
                <td class="style01">&nbsp;</td>
                <td class="style01">근로기준법에 따른다.</td>
              </tr>              
            </table>
          </td>
        </tr>
