          ...
          <tr>
            <td><table width="560"  cellspacing="0" cellpadding="2" class="alignLeft">
              <tr> 
                ...
                <tr>
                  <td valign="top">③</td>
                  <td>基本年俸 지급 방법은 「月基本給」과「賞與月割分」을 매월 25일에 
                    각각 지급하며<br>「名節賞與」 는 설, 추석에 각각 지급한다. <br>
                    단, 중도입사자의 매월 25일에 지급되는「月基本給」과「賞與月割分」
                ...
                <tr>
                  <td valign="top">④</td>
                  <td>기본연봉에 포함되지 않는 職務, 資格, 기타 수당은 별도 기준에 따라 
                    지급한다.</td>
                </tr>
                <tr>
                  <td colspan="2">&nbsp;</td>
