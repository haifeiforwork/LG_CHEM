            ...
            <td><table width="560" >
                <tr>
                  <td width="60%"><table width="100%" >
                      <tr>
                        <td width="85px" align="left"><b>LG MMA(주)<br>대표이사<br>社長&nbsp;&nbsp;박종일</b></td>
                        <td align="left" valign="bottom"><img src="<%= imgURL %>sign.jpg" style="width:126px;height:61px;" border="0"></td>
                      </tr>
                    </table></td>
