...
<!--// Tab start -->
	...
	<div class="tabArea">
		<ul class="tab">
			<li><a href="#" onclick="switchTabs(this, 'tab1');" class="selected">나의 연봉 조회</a></li>
			<li><a href="#" onclick="switchTabs(this, 'tab2');" >연봉계약서</a></li>	
		</ul>
	</div>
<!--// Tab end -->
				<!--// Tab1 start -->
				<div class="tabUnder tab1">									
					<div class="listArea">
						...
						<div class="buttonArea">
							<ul class="btn_mdl">
								<li><a href="#" id="viewAgreementBtn"><span>연봉계약서 조회</span></a></li>								
							</ul>
						</div>
						<div class="clear"> </div>
				...
				<div class="tabUnder tab2 Lnodisplay">					
					<h2 class="subsubtitle withButtons" id="salYearStr"></h3>
					<div class="buttonArea">
						<ul class="btn_crud">
							<li><a class="darken" id="printAgreementBtn"><span>프린트</span></a></li>
						</ul>
					</div>
					<div class="clear"> </div>
					
					<!-- 연봉계약서iframe start -->
					<div class="payContractArea">	
						<div class="innerBox">	
							<!-- 프린트 영역 start -->
							<div id="printArea" style="height:1000px; width:700px;">					    
				    			<iframe name="salAgreement" id="salAgreement" src="" frameborder="0" scrolling="no" style="float:left; height:1000px; width:700px;"></iframe>
				    		</div>
				    		<!-- 프린트 영역 end -->
				    	</div>
					</div>
...
<div class="layerWrapper layerSizeP" id="popLayerPrint">
	...
	<div class="printScroll">
		<div id="printContentsArea" class="layerContainer">
			<div id="printBody">
				<iframe name="salAgreementPopup" id="salAgreementPopup" src="" frameborder="0" scrolling="no" style="float:left; height:1000px; width:700px;"></iframe>
			</div>
		</div>
	</div>
	<div class="buttonArea buttonPrint">
		<ul class="btn_crud">
			<li><a class="darken" href="#" id="printPopAgreementBtn"><span>프린트</span></a></li>								
		</ul>
	</div>	
	<div class="clear"> </div>	
</div>
        ...
        $(function() {
        	...
        	$("#viewAgreementBtn").click(function() {
            	...
            	if(year == "")
            		...
            		$("#salAgreementPopup").attr("src","/salary/agreement/" + year + "?BEGDA=" + begda);
			...
			$("#addListGrid").jsGrid({
				...
				controller : {
					loadData : function() {
						...
						$.ajax({
							type : "GET",
							url : "/salary/getAnnuSalList.json",
							dataType : "json"
						}).done(function(response) {
							if(response.success) {
								//연봉계약서 iframe 세팅
								$("#salAgreement").attr("src","/salary/agreement/" + response.storeData[0].ZYEAR + "?BEGDA=" + response.storeData[0].BEGDA);
				...
				fields : [ 
				           ...
				           { name : "ZYEAR", title : "년도",     align : "center", type : "text" , width: "5%"}, 
