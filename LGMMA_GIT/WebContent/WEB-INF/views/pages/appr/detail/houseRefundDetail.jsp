...
<div class="tableArea">
	<h2 class="subtitle">주택자금 상환 신청 상세내역</h2>
	<div class="table">
	<form id="detailForm" name="detailForm">
		...
		<tr>
			...
			<td class="tdDate"><input class="readOnly" type="text"  name="BEGDA" value="<%= WebUtil.printDate(DataUtil.getCurrentDate()) %>" id="BEGDA" readonly /></td>
		...
		<tr>
			...
			<td colspan="3"><input type="hidden" name="E_ZZSECU_FLAG" id="ZZSECU_FLAG" >
