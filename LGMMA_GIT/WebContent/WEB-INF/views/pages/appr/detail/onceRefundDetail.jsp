...
<div class="tableArea">
	<h2 class="subtitle">구입전환일시지원금 상환 신청 상세내역</h2>
	<div class="table">
	<form id="detailForm">
		...
		<tr>
			<th><label for="detailTotlAmnt"><strong class="colorBlue">총상환금액</strong></label></th>
			<td colspan="3">
				<input class="inputMoney w120 readOnly colorBlue" type="text" id="detailTotalAmnt" name="TOTAL_AMNT" readonly> 원
			</td>
		</tr>
		<tr>
