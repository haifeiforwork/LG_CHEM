...
-->
	...
	<div class="tableArea">
		<h2 class="subtitle">간사계좌신규 조회</h2>
		<div class="table">
			<table class="tableGeneral">
			<caption>간사계좌신규 신청 조회</caption>
			<colgroup>
				<col class="col_15p"/>
				<col class="col_35p"/>
				<col class="col_15p"/>
			...
			<tr>
				...
				<td>
					<select id="MGART" name="MGART" vname="인포멀회" style="width:110px" disabled="disabled" required> 
...
%>
				...
				<td>
					<select id="LGART" name="LGART" vname="입금유형" style="width:158px" disabled="disabled" required> 
						<option value="">-------선택-------</option>
<%
